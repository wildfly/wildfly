...
public class TransformUtilsTestCase {
    ...
    public void testTransformation() {
        ...
        Assert.assertTrue(newModel.get("export-corbaloc").equals(ModelNode.TRUE));
        Assert.assertTrue(newModel.get("support-ssl").equals(ModelNode.FALSE));
        Assert.assertTrue(newModel.get("iona").equals(ModelNode.TRUE));
    }
