...
public class JacORBMigrateTestCase extends AbstractSubsystemTest {
    ...
    public void migrateTest() throws Exception {
        ...
        String subsystemXml = readResource("migrate.xml");
        ...
        Assert.assertTrue(newSubsystem.get("giop-version").equals(new ModelNode("1.2")));
        Assert.assertTrue(newSubsystem.get("security").equals(new ModelNode("none")));
        Assert.assertTrue(newSubsystem.get("transactions").equals(new ModelNode("full")));
        Assert.assertTrue(newSubsystem.get("export-corbaloc").equals(new ModelNode("true")));
        Assert.assertTrue(newSubsystem.get("support-ssl").equals(new ModelNode("true")));
        Assert.assertTrue(newSubsystem.get("root-context").equals(new ModelNode("fooRoot")));
        Assert.assertTrue(newSubsystem.get("add-component-via-interceptor").equals(new ModelNode("false")));
    }
