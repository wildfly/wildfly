...
import org.jboss.as.mail.extension.MailSubsystemExtension;
...
public class AbstractParsingTest {
    ...
    public void initializeParser() throws Exception {
        ...
        MailSubsystemExtension extension = new MailSubsystemExtension();
    ...
    private static final class TestParser implements  XMLStreamConstants, XMLElementReader<List<ModelNode>>, XMLElementWriter<ModelMarshallingContext> {
        ...
        public void writeContent(XMLExtendedStreamWriter writer, ModelMarshallingContext context) throws XMLStreamException {
            ...
            try {
                ModelNode subsystem = context.getModelNode().get(SUBSYSTEM, MailSubsystemExtension.SUBSYSTEM_NAME);
                XMLElementWriter<SubsystemMarshallingContext> subsystemWriter = context.getSubsystemWriter(MailSubsystemExtension.SUBSYSTEM_NAME);
