...
public enum PrimitiveMarshaller implements ProtoStreamMarshallerProvider {
    ...
    BOOLEAN(Boolean.class) {
        ...
        @Override
        public OptionalInt size(ImmutableSerializationContext context, Object value) {
            return OptionalInt.of(CodedOutputStream.computeBoolSizeNoTag(((Boolean) value).booleanValue()));
        }
    },
    BYTE(Byte.class) {
        @Override
    ...
    CHARACTER(Character.class) {
        ...
        @Override
        public void writeTo(ImmutableSerializationContext context, RawProtoStreamWriter writer, Object value) throws IOException {
            writer.writeUInt32NoTag(((Character) value).charValue());
        }

        @Override
        public OptionalInt size(ImmutableSerializationContext context, Object value) {
            return OptionalInt.of(CodedOutputStream.computeUInt32SizeNoTag(((Character) value).charValue()));
        }
    },
    ;
