...
public enum NetMarshallerProvider implements ProtoStreamMarshallerProvider {
    ...
    INET_ADDRESS(new SimpleFieldSetMarshaller<>(InetAddress.class, InetAddressFieldMarshaller.INSTANCE, Functions.constantSupplier(InetAddress.getLoopbackAddress()))),
    INET_SOCKET_ADDRESS(InetSocketAddressMarshaller.INSTANCE),
    URI(URIMarshaller.INSTANCE),
    URL(URLMarshaller.INSTANCE),
    ;
