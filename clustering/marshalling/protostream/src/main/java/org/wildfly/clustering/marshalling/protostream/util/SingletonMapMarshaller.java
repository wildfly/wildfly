...
public class SingletonMapMarshaller extends FunctionalMarshaller<Map<Object, Object>, SimpleEntry<Object, Object>> {
    private static final Function<Map<Object, Object>, SimpleEntry<Object, Object>> FUNCTION = new Function<Map<Object, Object>, SimpleEntry<Object, Object>>() {
        @Override
    ...
    public SingletonMapMarshaller(BiFunction<Object, Object, Map<Object, Object>> factory) {
        super((Class<Map<Object, Object>>) factory.apply(null, null).getClass(), new MapEntryMarshaller<>(Function.identity()), FUNCTION, new Function<SimpleEntry<Object, Object>, Map<Object, Object>>() {
            @Override
