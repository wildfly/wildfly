...
public interface ScalarMarshallerProvider extends ScalarMarshaller<Object> {
    ...
    @Override
    default void writeTo(ImmutableSerializationContext context, RawProtoStreamWriter writer, Object value) throws IOException {
        this.cast(Object.class).writeTo(context, writer, value);
    }
