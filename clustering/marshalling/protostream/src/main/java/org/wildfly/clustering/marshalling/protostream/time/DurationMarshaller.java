 ...
 * @author Paul Ferraro
 */
public enum DurationMarshaller implements EmbeddableMarshaller<Duration> {
    INSTANCE;
    ...
    @Override
    public Duration readField(ImmutableSerializationContext context, RawProtoStreamReader reader, int index, Duration duration) throws IOException {
        switch (index) {
    ...
    @Override
    public void writeFields(ImmutableSerializationContext context, RawProtoStreamWriter writer, int startIndex, Duration duration) throws IOException {
    ...
    public Duration readFrom(ImmutableSerializationContext context, RawProtoStreamReader reader) throws IOException {
        ...
        while (reading) {
            ...
            switch (index) {
                ...
                case MILLIS_INDEX:
                case NANOS_INDEX:
                    duration = this.readField(context, reader, index, duration);
                    break;
                default:
