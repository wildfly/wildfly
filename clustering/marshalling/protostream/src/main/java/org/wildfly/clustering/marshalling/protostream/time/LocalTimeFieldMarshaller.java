 ...
 * @author Paul Ferraro
 */
public enum LocalTimeFieldMarshaller implements FieldMarshaller<LocalTime, LocalTime> {
    INSTANCE;
    ...
    @Override
    public void writeFields(ImmutableSerializationContext context, RawProtoStreamWriter writer, int startIndex, LocalTime time) throws IOException {
