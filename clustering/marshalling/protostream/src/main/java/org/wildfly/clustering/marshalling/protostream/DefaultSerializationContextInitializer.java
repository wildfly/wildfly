...
public enum DefaultSerializationContextInitializer implements SerializationContextInitializer {
    ...
    UTIL(new ProvidedSerializationContextInitializer<>("java.util.proto", UtilMarshallerProvider.class)),
    ATOMIC(new ProvidedSerializationContextInitializer<>("java.util.concurrent.atomic.proto", AtomicMarshallerProvider.class)),
    CONCURRENT(new ProvidedSerializationContextInitializer<>("java.util.concurrent.proto", ConcurrentMarshallerProvider.class)),
