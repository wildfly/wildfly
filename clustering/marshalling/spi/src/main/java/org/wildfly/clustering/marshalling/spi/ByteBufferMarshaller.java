        ...
        try (ByteBufferOutputStream output = new ByteBufferOutputStream(size)) {
            ...
            if (size.isPresent()) {
                ...
                if (predictedSize < actualSize) {
                    System.out.println(String.format("Buffer size prediction too small for %s (%s), predicted = %d, actual = %d", object, (object != null) ? object.getClass().getCanonicalName() : null, predictedSize, actualSize));
                ...
                System.out.println(String.format("Buffer size prediction missing for %s (%s)", object, (object != null) ? object.getClass().getCanonicalName() : null));
