...
import org.wildfly.clustering.diagnostics.extension.ClusteringDiagnosticsSubsystemLogger;
    ...
    public synchronized void add(String identifier, ClusteredModuleDeployment deployment) {
        ...
        for(final ClusteredDeploymentRepositoryListener listener : listeners) {
            try {
                ...
                ClusteringDiagnosticsSubsystemLogger.ROOT_LOGGER.deploymentAddListenerException(t);
            }
        }
    }
    ...
    public synchronized void remove(String identifier) {
        ...
        for(final ClusteredDeploymentRepositoryListener listener : listeners) {
            try {
                ...
                ClusteringDiagnosticsSubsystemLogger.ROOT_LOGGER.deploymentRemoveListenerException(t);
            }
        }
    }
