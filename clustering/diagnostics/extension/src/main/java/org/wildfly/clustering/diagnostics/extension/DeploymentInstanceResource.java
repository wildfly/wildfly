...
public class DeploymentInstanceResource implements Resource {
    ...
    public Set<ResourceEntry> getChildren(String childType) {
        if (ModelKeys.WEB.equals(childType)) {
            ...
            if (ClusteringDiagnosticsSubsystemHelper.getWebDeploymentNames(this.registry, this.channel).contains(name)) {
        ...
        if (ModelKeys.BEAN.equals(childType)) {
            Set<ResourceEntry> result = new HashSet<ResourceEntry>();
            for (String beanName : ClusteringDiagnosticsSubsystemHelper.getBeanNamesForDeployment(this.registry, this.channel, this.name)) {
    ...
    public Set<String> getChildrenNames(String childType) {
        ...
        if (ModelKeys.BEAN.equals(childType)) {
            return ClusteringDiagnosticsSubsystemHelper.getBeanNamesForDeployment(this.registry, this.channel, this.name);
        }
        return Collections.emptySet();
    }
    ...
    private boolean hasWebDeployment(PathElement element) {
        ...
        return ClusteringDiagnosticsSubsystemHelper.getWebDeploymentNames(this.registry, this.channel).contains(this.name);
    }

    private boolean hasBeanDeployment(PathElement element) {
        String beanName = element.getValue();
        return ClusteringDiagnosticsSubsystemHelper.getBeanNamesForDeployment(this.registry, this.channel, this.name).contains(beanName);
    }
