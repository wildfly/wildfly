...
public interface ClusteringDiagnosticsSubsystemMessages {
    /**
     * The messages.
     */
    ClusteringDiagnosticsSubsystemMessages MESSAGES = Messages.getBundle(ClusteringDiagnosticsSubsystemMessages.class);
