...
public class WebMetricsHandler extends CacheBasedMetricsHandler {
    ...
    protected void executeRuntimeStep(OperationContext context, ModelNode operation) throws OperationFailedException {
        ...
        // trace logging
        ClusteringDiagnosticsSubsystemLogger.ROOT_LOGGER.processingWebMetricsRequest(channelName, deploymentName, attrName);

        // lookup the cache info for this web deployment
        String cacheName = null;
        DeploymentCacheInfo info = ClusteringDiagnosticsSubsystemHelper.getWebDeploymentCacheInfo(context.getServiceRegistry(false), channelName, deploymentName);
        if (info == null) {
