...
/**
 * The namespaces supported by the clustering-diagnostics extension.
 *
...
public enum Namespace {
    ...
    CLUSTERING_DIAGNOSTICS_1_0(1, 0, new ClusteringDiagnosticsSubsystemXMLReader_1_0())
    ;

    private static final String BASE_URN = "urn:jboss:domain:clustering-diagnostics:";

    /**
     * The current namespace version.
     */
    public static final Namespace CURRENT = CLUSTERING_DIAGNOSTICS_1_0;
