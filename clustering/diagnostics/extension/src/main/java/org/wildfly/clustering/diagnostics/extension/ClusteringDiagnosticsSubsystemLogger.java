...
public interface ClusteringDiagnosticsSubsystemLogger extends BasicLogger {

    String ROOT_LOGGER_CATEGORY = ClusteringDiagnosticsSubsystemLogger.class.getPackage().getName();

    /**
     * A logger with the category of the default clustering package.
     */
    ClusteringDiagnosticsSubsystemLogger ROOT_LOGGER = Logger.getMessageLogger(ClusteringDiagnosticsSubsystemLogger.class, ROOT_LOGGER_CATEGORY);
