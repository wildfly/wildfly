 ...
 */
package org.wildfly.clustering.diagnostics.services.channel;
...
public class ChannelStateCommand implements Command<ChannelState, String> {
    ...
    public ChannelState execute(String cluster) throws Exception {
        ...
        // trace logging
        ClusteringDiagnosticsServicesLogger.ROOT_LOGGER.executingChannelStateCommand(cluster);
        ...
        // trace logging
        ClusteringDiagnosticsServicesLogger.ROOT_LOGGER.executedChannelStateCommand(cluster);
