 ...
 * @author Paul Ferraro
 */
public class InfinispanSubsystemParserTest {

    private InfinispanExtension parser = new InfinispanExtension();

    @Test
    public void parse() throws Exception {

        List<ModelNode> operations = parse("subsystem-infinispan.xml");
