...
interface InfinispanWebMessages extends ClusteringMessages {
     ...
     */
    @Message(id = 10260, value = "Unexpected exception while starting group communication service for %s")
     ...
     * @return an {@link IllegalStateException} for the error.
     */
    @Message(id = 10261, value = "Unexpected exception while starting lock manager for %s")
     ...
     * @return the message.
     */
    @Message(id = 10262, value = "Failed to configure web application for <distributable/> sessions.  %s.%s cache requires batching=\"true\".")
     ...
     */
    @Message(id = 10263, value = "Failed to store session attributes for session: %s")
     ...
     */
    @Message(id = 10264, value = "Attempt to put value of type %s into %s entry")
     ...
     * @return an {@link IllegalArgumentException} for the error.
     */
    @Message(id = 10265, value = "Unknown replication granularity: %s")
