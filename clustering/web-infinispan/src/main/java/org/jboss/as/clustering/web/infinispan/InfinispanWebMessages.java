...
interface InfinispanWebMessages extends ClusteringMessages {
     ...
     */
    @Message(value = "Unexpected exception while starting group communication service for %s")
     ...
     * @return an {@link IllegalStateException} for the error.
     */
    @Message(value = "Unexpected exception while starting lock manager for %s")
     ...
     * @return the message.
     */
    @Message(value = "Failed to configure web application for <distributable/> sessions.  %s.%s cache requires batching=\"true\".")
     ...
     */
    @Message(value = "Failed to store session attributes for session: %s")
     ...
     */
    @Message(value = "Attempt to put value of type %s into %s entry")
     ...
     * @return an {@link IllegalArgumentException} for the error.
     */
    @Message(value = "Unknown replication granularity: %s")
