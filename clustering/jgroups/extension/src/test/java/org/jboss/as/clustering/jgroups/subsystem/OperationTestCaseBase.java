...
public class OperationTestCaseBase extends AbstractSubsystemTest {
    ...
    public OperationTestCaseBase() {
        super(JGroupsSubsystemResourceDefinitionRegistrar.NAME, new JGroupsExtension());
    }
    ...
    protected static ModelNode getTransportAddOperation(String stackName, String protocol) {
        ...
        operation.get(AbstractTransportResourceDefinitionRegistrar.SocketBindingAttribute.TRANSPORT.getName()).set("some-binding");
        return operation;
    }
    ...
    protected static PathAddress getSubsystemAddress() {
        return PathAddress.pathAddress(JGroupsSubsystemResourceDefinitionRegistrar.PATH);
    }

    protected static PathAddress getProtocolStackAddress(String stackName) {
        return getSubsystemAddress().append(StackResourceDefinitionRegistrar.pathElement(stackName));
    }

    protected static PathAddress getTransportAddress(String stackName, String type) {
        return getProtocolStackAddress(stackName).append(AbstractTransportResourceDefinitionRegistrar.pathElement(type));
    }

    protected static PathAddress getProtocolAddress(String stackName, String type) {
        return getProtocolStackAddress(stackName).append(AbstractProtocolResourceDefinitionRegistrar.pathElement(type));
    }
