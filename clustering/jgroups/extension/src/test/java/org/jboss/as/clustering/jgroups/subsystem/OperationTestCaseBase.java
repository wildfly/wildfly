...
public class OperationTestCaseBase extends AbstractSubsystemTest {
    ...
    static final String SUBSYSTEM_XML_FILE = String.format("subsystem-jgroups-%d_%d.xml", JGroupsSchema.CURRENT.getVersion().major(), JGroupsSchema.CURRENT.getVersion().minor());
