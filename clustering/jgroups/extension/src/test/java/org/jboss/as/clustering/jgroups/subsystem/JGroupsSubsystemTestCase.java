...
public class JGroupsSubsystemTestCase extends AbstractSubsystemSchemaTest<JGroupsSubsystemSchema> {
    ...
    public JGroupsSubsystemTestCase(JGroupsSubsystemSchema schema) {
        super(JGroupsSubsystemResourceDefinitionRegistrar.INSTANCE.getName(), new JGroupsExtension(), schema, JGroupsSubsystemSchema.CURRENT);
        this.schema = schema;
    }
/*
    @Override
    public void testSubsystem() throws Exception {
        ...
        this.standardSubsystemTest(null, true);
    }
*/
    @Override
    ...
    public void testIndexedAdds() throws Exception {
        ...
        ModelNode originalSubsystemModel = services.readWholeModel().get(JGroupsSubsystemResourceDefinitionRegistrar.INSTANCE.getPathElement().getKeyValuePair());
        ...
        final PathAddress subsystemAddress = PathAddress.pathAddress(JGroupsSubsystemResourceDefinitionRegistrar.INSTANCE.getPathElement());
        ...
        ModelNode subsystemModel = services.readWholeModel().get(JGroupsSubsystemResourceDefinitionRegistrar.INSTANCE.getPathElement().getKeyValuePair());
        ...
        subsystemModel = services.readWholeModel().get(JGroupsSubsystemResourceDefinitionRegistrar.INSTANCE.getPathElement().getKeyValuePair());
