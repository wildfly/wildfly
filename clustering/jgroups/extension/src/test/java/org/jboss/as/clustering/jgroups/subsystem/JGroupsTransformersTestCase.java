...
public class JGroupsTransformersTestCase extends AbstractSubsystemTest {
    ...
    public void testRejections() throws Exception {
        ...
        if (JGroupsSubsystemModel.VERSION_8_0_0.requiresTransformation(this.subsystemVersion)) {
            config.addFailedAttribute(subsystemAddress.append(StackResourceDefinitionRegistrar.pathElement("credentialReference1")).append(AbstractProtocolResourceDefinitionRegistrar.pathElement("SYM_ENCRYPT")), FailedOperationTransformationConfig.REJECTED_RESOURCE);
        }
