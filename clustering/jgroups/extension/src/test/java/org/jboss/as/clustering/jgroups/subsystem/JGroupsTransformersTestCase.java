...
public class JGroupsTransformersTestCase extends AbstractSubsystemTest {
    ...
    public JGroupsTransformersTestCase(ModelTestControllerVersion version) {
        super(JGroupsSubsystemResourceDefinitionRegistrar.INSTANCE.getName(), new JGroupsExtension());
    ...
    public void testRejections() throws Exception {
        ...
        PathAddress subsystemAddress = PathAddress.pathAddress(JGroupsSubsystemResourceDefinitionRegistrar.INSTANCE.getPathElement());
