...
public class JGroupsTransformersTestCase extends AbstractSubsystemTest {
    ...
    public void testRejections() throws Exception {
        ...
        PathAddress subsystemAddress = PathAddress.pathAddress(JGroupsSubsystemResourceDescription.INSTANCE.getPathElement());

        if (JGroupsSubsystemModel.VERSION_8_0_0.requiresTransformation(this.subsystemVersion)) {
            config.addFailedAttribute(subsystemAddress.append(StackResourceDescription.pathElement("credentialReference1")).append(ProtocolResourceDescription.pathElement("SYM_ENCRYPT")), FailedOperationTransformationConfig.REJECTED_RESOURCE);
        }
