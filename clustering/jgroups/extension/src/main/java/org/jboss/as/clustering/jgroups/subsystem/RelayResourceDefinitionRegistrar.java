...
public class RelayResourceDefinitionRegistrar extends ProtocolConfigurationResourceDefinitionRegistrar<RELAY2, RelayConfiguration> {
    ...
    private final ProtocolConfigurationResourceDefinitionRegistrar.Configurator<RELAY2, RelayConfiguration> configurator;
    ...
    RelayResourceDefinitionRegistrar(ResourceOperationRuntimeHandler parentRuntimeHandler) {
        this(new Configurator<>() {
            ...
            public ResourceDescriptor.Builder apply(ResourceDescriptor.Builder builder) {
                return Configurator.super.apply(builder).provideAttributes(EnumSet.allOf(Attribute.class));
            }
    ...
    private RelayResourceDefinitionRegistrar(Configurator<RELAY2, RelayConfiguration> configurator) {
        super(configurator);
