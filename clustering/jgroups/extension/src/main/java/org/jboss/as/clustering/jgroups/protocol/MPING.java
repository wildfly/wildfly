...
/**
 * {@link org.jgroups.protocols.MPING} override that leverages generic multicast socket configuration.
 * @author Paul Ferraro
 */
...
public class MPING extends org.jgroups.protocols.MPING implements MulticastSocketProtocol {
    ...
    public void setMulticastSocketAddress(InetSocketAddress socketAddress) {
        this.setMcastAddr(socketAddress.getAddress());
        this.setMcastPort(socketAddress.getPort());
    }
}
