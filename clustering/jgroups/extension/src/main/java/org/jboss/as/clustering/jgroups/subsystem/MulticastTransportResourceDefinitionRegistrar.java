...
public class MulticastTransportResourceDefinitionRegistrar extends AbstractTransportResourceDefinitionRegistrar<UDP> {
    ...
    MulticastTransportResourceDefinitionRegistrar(TransportResourceDescription description, ResourceOperationRuntimeHandler parentRuntimeHandler) {
        super(new TransportResourceDescriptorConfigurator<>() {
            ...
            public ServiceDependency<TransportConfiguration<UDP>> resolve(OperationContext context, ModelNode model) throws OperationFailedException {
                return TransportResourceDescriptorConfigurator.super.resolve(context, model).map(new Function<>() {
                    @Override
