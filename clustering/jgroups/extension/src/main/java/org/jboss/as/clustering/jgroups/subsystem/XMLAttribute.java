...
public enum XMLAttribute {
    ...
    CLIENT_SSL_CONTEXT(SSLContextProtocolResourceDefinition.Attribute.CLIENT_SSL_CONTEXT),
    ...
    SERVER_SSL_CONTEXT(SSLContextProtocolResourceDefinition.Attribute.SERVER_SSL_CONTEXT),
