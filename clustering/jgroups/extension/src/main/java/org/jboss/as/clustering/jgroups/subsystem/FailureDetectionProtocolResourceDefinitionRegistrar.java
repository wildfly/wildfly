...
public class FailureDetectionProtocolResourceDefinitionRegistrar extends SocketProtocolResourceDefinitionRegistrar<FD_SOCK2> {
    ...
    FailureDetectionProtocolResourceDefinitionRegistrar(String name, ResourceOperationRuntimeHandler parentRuntimeHandler) {
        super(new SocketProtocolResourceRegistration<>() {
            @Override
            ...
            public ResourceDescriptor.Builder apply(ResourceDescriptor.Builder builder) {
                return SocketProtocolResourceRegistration.super.apply(builder).addResourceCapabilityReference(TRANSPORT);
            }
            ...
            public ServiceDependency<ProtocolConfiguration<FD_SOCK2>> resolve(OperationContext context, ModelNode model) throws OperationFailedException {
                ServiceDependency<ProtocolConfiguration<FD_SOCK2>> protocol = SocketProtocolResourceRegistration.super.resolve(context, model);
