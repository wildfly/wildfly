 ...
 * @version Aug 2014
 */
public enum ThreadPoolResourceDefinitionRegistrar implements ChildResourceDefinitionRegistrar, ThreadPoolResourceDescription, ResourceServiceConfigurator {

    DEFAULT("default", 0, 200, 0, Duration.ofMinutes(1)),
    ;
    ...
    ThreadPoolResourceDefinitionRegistrar(String name, int defaultMinThreads, int defaultMaxThreads, int defaultQueueLength, Duration defaultKeepAlive) {
    ...
    public ManagementResourceRegistration register(ManagementResourceRegistration parent, ManagementResourceRegistrationContext context) {
        ...
        ResourceDescriptor descriptor = ResourceDescriptor.builder(resolver)
                .addAttributes(this.getAttributes().collect(Collectors.toUnmodifiableList()))
