...
public class StackResourceDefinitionRegistrar implements ChildResourceDefinitionRegistrar, ResourceServiceConfigurator {
    ...
    private static final Collection<AttributeDefinition> ATTRIBUTES = List.of(STATISTICS_ENABLED);
    ...
    public ManagementResourceRegistration register(ManagementResourceRegistration parent, ManagementResourceRegistrationContext context) {
        ResourceDescriptionResolver resolver = JGroupsSubsystemResourceDefinitionRegistrar.RESOLVER.createChildResolver(WILDCARD_PATH);
        ...
        ResourceDescriptor descriptor = ResourceDescriptor.builder(resolver)
                ...
                .build();
        ManagementResourceRegistration registration = parent.registerSubModel(ResourceDefinition.builder(ResourceRegistration.of(WILDCARD_PATH), resolver).build());
    ...
    public ResourceServiceInstaller configure(OperationContext context, ModelNode model) throws OperationFailedException {
        ...
        ServiceDependency<RelayConfiguration> relay = resource.hasChild(RelayResourceDefinitionRegistrar.PATH) ? ServiceDependency.on(RelayConfiguration.SERVICE_DESCRIPTOR, name) : ServiceDependency.empty();

        Set<String> protocolNames = resource.getChildrenNames(ProtocolResourceDefinitionRegistrar.WILDCARD_PATH.getKey());
