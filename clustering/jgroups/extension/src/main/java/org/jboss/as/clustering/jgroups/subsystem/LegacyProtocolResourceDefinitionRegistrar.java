...
public class LegacyProtocolResourceDefinitionRegistrar extends ProtocolChildResourceDefinitionRegistrar {
    ...
    LegacyProtocolResourceDefinitionRegistrar(Protocol registration) {
        super(new Configurator() {
            ...
            public ResourceDescriptionResolver getResourceDescriptionResolver() {
                return JGroupsSubsystemResourceDefinitionRegistrar.RESOLVER.createChildResolver(registration.getPathElement(), StackResourceDefinitionRegistrar.Component.PROTOCOL.getPathElement());
            }

            @Override
            public JGroupsSubsystemModel getDeprecation() {
                return registration.getDeprecation();
            }
                            ...
                            public OperationStepHandler apply(OperationStepHandler handler) {
                                return new OperationStepHandler() {
                                    ...
                                    public void execute(OperationContext context, ModelNode operation) {
                                        ...
                                        JGroupsLogger.ROOT_LOGGER.legacyProtocol(address.getLastElement().getValue(), registration.getTargetPathElement().getValue());
                                        PathAddress targetAddress = address.getParent().append(registration.getTargetPathElement());
