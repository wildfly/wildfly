    ...
    public void accept(ModelVersion version) {
        if (JGroupsSubsystemModel.VERSION_11_0_0.requiresTransformation(version)) {
            this.builder.getAttributeBuilder()
                    .addRejectCheck(RejectAttributeChecker.DEFINED, SocketTransportResourceDefinitionRegistrar.CLIENT_SSL_CONTEXT.getName(), SocketTransportResourceDefinitionRegistrar.SERVER_SSL_CONTEXT.getName())
                    .setDiscard(DiscardAttributeChecker.UNDEFINED, SocketTransportResourceDefinitionRegistrar.CLIENT_SSL_CONTEXT.getName(), SocketTransportResourceDefinitionRegistrar.SERVER_SSL_CONTEXT.getName())
                    .end();
        }
    }
}
