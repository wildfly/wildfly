...
public class ProtocolConfigurationResourceDefinitionRegistrar<P extends Protocol, C extends ProtocolConfiguration<P>> extends ProtocolChildResourceDefinitionRegistrar {
    ...
    interface ProtocolConfigurationResourceRegistration<P extends Protocol, C extends ProtocolConfiguration<P>> extends ProtocolChildResourceRegistration, ResourceServiceConfigurator, ResourceModelResolver<ServiceDependency<C>> {
        @Override
    ...
    ProtocolConfigurationResourceDefinitionRegistrar(ProtocolConfigurationResourceRegistration<P, C> registration) {
        super(registration);
    }
