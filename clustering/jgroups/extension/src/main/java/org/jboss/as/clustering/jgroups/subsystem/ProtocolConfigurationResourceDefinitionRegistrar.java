...
public class ProtocolConfigurationResourceDefinitionRegistrar<P extends Protocol, C extends ProtocolConfiguration<P>> extends ProtocolChildResourceDefinitionRegistrar {
    ...
    interface Configurator<P extends Protocol, C extends ProtocolConfiguration<P>> extends ProtocolChildResourceDefinitionRegistrar.Configurator, ResourceServiceConfigurator, ResourceModelResolver<ServiceDependency<C>> {
        RuntimeCapability<Void> getCapability();

        @Override
        default ResourceDescriptor.Builder apply(ResourceDescriptor.Builder builder) {
            return ProtocolChildResourceDefinitionRegistrar.Configurator.super.apply(builder)
                    .addCapability(this.getCapability())
    ...
    ProtocolConfigurationResourceDefinitionRegistrar(Configurator<P, C> configurator) {
        super(configurator);
    }
