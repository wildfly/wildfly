...
import org.jboss.as.clustering.controller.persistence.xml.NamedResourceRegistrationXMLChoice;
...
public enum JGroupsSubsystemSchema implements SubsystemResourceXMLSchema<JGroupsSubsystemSchema> {
    ...
    public SubsystemResourceRegistrationXMLElement getSubsystemXMLElement() {
        ...
        if (this.since(VERSION_3_0)) {
            ...
            ResourceXMLElement.Builder stacksBuilder = this.factory.element(this.factory.resolve("stacks")).withCardinality(XMLCardinality.Single.OPTIONAL);
    ...
    private ResourceXMLChoice transportChoice() {
        ...
        NamedResourceRegistrationXMLChoice.Builder builder = this.factory.namedChoice(transportElement);
    ...
    private ResourceXMLChoice protocolChoice() {
        NamedResourceRegistrationXMLElement protocolElement = this.protocolElementBuilder(StackResourceDefinitionRegistrar.Component.PROTOCOL)
                ...
                .build();
        NamedResourceRegistrationXMLChoice.Builder builder = this.factory.namedChoice(protocolElement).withCardinality(XMLCardinality.Unbounded.OPTIONAL);
    ...
    private ResourceRegistrationXMLElement relayElement() {
        return this.factory.singletonElement(RelayResourceDefinitionRegistrar.Protocol.RELAY2)
                ...
                .addAttributes(ResourceDescriptor.stream(EnumSet.allOf(RelayResourceDefinitionRegistrar.Attribute.class)).toList())
                .withContent(this.factory.sequence().addElement(this.remoteSiteElement()).build())
                .build();
    }
