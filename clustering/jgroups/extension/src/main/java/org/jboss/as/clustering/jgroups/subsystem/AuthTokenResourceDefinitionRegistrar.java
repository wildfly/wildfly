...
public abstract class AuthTokenResourceDefinitionRegistrar<T extends AuthToken> implements ChildResourceDefinitionRegistrar, ResourceServiceConfigurator, ResourceModelResolver<ServiceDependency<Function<byte[], T>>> {
    ...
    interface Configurator extends UnaryOperator<ResourceDescriptor.Builder> {
        Token getResourceRegistration();
    ...
    AuthTokenResourceDefinitionRegistrar(Configurator configurator) {
    ...
    public ManagementResourceRegistration register(ManagementResourceRegistration parent, ManagementResourceRegistrationContext context) {
        ...
        ResourceDescriptionResolver resolver = JGroupsSubsystemResourceDefinitionRegistrar.RESOLVER.createChildResolver(this.configurator.getResourceRegistration().getPathElement(), PathElement.pathElement(path.getKey()));
        ...
        ResourceDefinition definition = ResourceDefinition.builder(this.configurator.getResourceRegistration(), resolver).build();
