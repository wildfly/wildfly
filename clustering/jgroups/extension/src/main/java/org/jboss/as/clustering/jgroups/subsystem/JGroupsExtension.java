...
public class JGroupsExtension extends SubsystemExtension<JGroupsSubsystemSchema> {
    ...
    public JGroupsExtension() {
        super(SubsystemConfiguration.of(JGroupsSubsystemResourceDescription.INSTANCE.getName(), JGroupsSubsystemModel.CURRENT, JGroupsSubsystemResourceDefinitionRegistrar::new), SubsystemResourceXMLSchema.persistence(JGroupsSubsystemSchema.CURRENT));
