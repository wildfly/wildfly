...
public class JGroupsExtension extends SubsystemExtension<JGroupsSubsystemSchema> {
    ...
    public JGroupsExtension() {
        super(SubsystemConfiguration.of(JGroupsSubsystemResourceDefinitionRegistrar.NAME, JGroupsSubsystemModel.CURRENT, JGroupsSubsystemResourceDefinitionRegistrar::new), SubsystemPersistence.of(JGroupsSubsystemSchema.CURRENT, new JGroupsSubsystemXMLWriter()));
