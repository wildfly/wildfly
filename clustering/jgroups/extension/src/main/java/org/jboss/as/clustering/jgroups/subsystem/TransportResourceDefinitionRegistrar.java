...
public class TransportResourceDefinitionRegistrar extends AbstractTransportResourceDefinitionRegistrar<TP> {
    ...
    TransportResourceDefinitionRegistrar(ResourceOperationRuntimeHandler parentRuntimeHandler) {
        super(new TransportResourceDescriptorConfigurator<>() {
            ...
            public TransportResourceDescription getResourceDescription() {
                return TransportResourceDescription.INSTANCE;
            }
    ...
    public ManagementResourceRegistration register(ManagementResourceRegistration parent, ManagementResourceRegistrationContext context) {
        ...
        for (MulticastTransportResourceDescription transport : EnumSet.allOf(MulticastTransportResourceDescription.class)) {
            new MulticastTransportResourceDefinitionRegistrar(transport, this.parentRuntimeHandler).register(parent, context);
        }
        for (SocketTransportResourceDescription transport : EnumSet.allOf(SocketTransportResourceDescription.class)) {
