    ...
    private ChannelResourceDefinitionRegistrar(ServiceValueExecutorRegistry<JChannel> channelRegistry) {
        super(new Configurator<>() {
            ...
            public Collection<AttributeDefinition> getAttributes() {
                return List.of(STACK, MODULE, CLUSTER, STATISTICS_ENABLED);
            }
            ...
            public ResourceDescriptor.Builder apply(ResourceDescriptor.Builder builder) {
                ...
                return Configurator.super.apply(builder).addCapabilities(List.of(commandDispatcherFactory, legacyCommandDispatcherFactory, group, legacyGroup));
            }
