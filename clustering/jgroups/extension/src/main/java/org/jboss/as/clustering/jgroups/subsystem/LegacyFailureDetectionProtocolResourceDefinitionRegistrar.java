...
public class LegacyFailureDetectionProtocolResourceDefinitionRegistrar extends SocketProtocolResourceDefinitionRegistrar<FD_SOCK> {
    ...
    public LegacyFailureDetectionProtocolResourceDefinitionRegistrar(String name, ResourceOperationRuntimeHandler parentRuntimeHandler) {
        super(new SocketProtocolResourceRegistration<>() {
            ...
            public ServiceDependency<ProtocolConfiguration<FD_SOCK>> resolve(OperationContext context, ModelNode model) throws OperationFailedException {
                ServiceDependency<ProtocolConfiguration<FD_SOCK>> protocol = SocketProtocolResourceRegistration.super.resolve(context, model);
