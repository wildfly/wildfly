 ...
 * @author Paul Ferraro
 */
public class LegacyFailureDetectionProtocolResourceDefinitionRegistrar extends AbstractProtocolResourceDefinitionRegistrar<FD_SOCK> {

    public LegacyFailureDetectionProtocolResourceDefinitionRegistrar(SocketProtocolResourceDescription description, ResourceOperationRuntimeHandler parentRuntimeHandler) {
        super(new ProtocolResourceDescriptorConfigurator<>() {
            ...
            public ServiceDependency<ProtocolConfiguration<FD_SOCK>> resolve(OperationContext context, ModelNode model) throws OperationFailedException {
                ServiceDependency<ProtocolConfiguration<FD_SOCK>> protocol = ProtocolResourceDescriptorConfigurator.super.resolve(context, model);
