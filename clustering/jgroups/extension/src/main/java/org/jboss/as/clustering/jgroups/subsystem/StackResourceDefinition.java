    ...
    static void buildTransformation(ModelVersion version, ResourceTransformationDescriptionBuilder parent) {
        ...
        if (JGroupsModel.VERSION_4_1_0.requiresTransformation(version)) {
            builder.getAttributeBuilder()
                    .setDiscard(new DiscardAttributeChecker.DiscardAttributeValueChecker(Attribute.STATISTICS_ENABLED.getDefinition().getDefaultValue()), AbstractProtocolResourceDefinition.Attribute.STATISTICS_ENABLED.getDefinition())
