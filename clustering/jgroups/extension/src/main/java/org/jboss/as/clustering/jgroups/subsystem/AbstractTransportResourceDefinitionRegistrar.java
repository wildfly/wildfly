...
public class AbstractTransportResourceDefinitionRegistrar<T extends TP> extends ProtocolConfigurationResourceDefinitionRegistrar<T, TransportConfiguration<T>> {
    ...
    interface Configurator<T extends TP> extends ProtocolConfigurationResourceDefinitionRegistrar.Configurator<T, TransportConfiguration<T>> {
        ...
        default ResourceDescriptor.Builder apply(ResourceDescriptor.Builder builder) {
            return ProtocolConfigurationResourceDefinitionRegistrar.Configurator.super.apply(builder)
    ...
    AbstractTransportResourceDefinitionRegistrar(Configurator<T> configurator) {
        super(configurator);
    }
