...
public class AbstractProtocolResourceDefinitionRegistrar<P extends Protocol> extends ProtocolConfigurationResourceDefinitionRegistrar<P, ProtocolConfiguration<P>> {
    ...
    interface Configurator<P extends Protocol> extends ProtocolConfigurationResourceDefinitionRegistrar.Configurator<P, ProtocolConfiguration<P>> {
    ...
    AbstractProtocolResourceDefinitionRegistrar(Configurator<P> registration) {
        super(registration);
    }
}
