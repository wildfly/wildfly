...
public class SocketProtocolResourceDefinitionRegistrar<P extends Protocol> extends AbstractProtocolResourceDefinitionRegistrar<P> {
    ...
    interface Configurator<P extends Protocol> extends AbstractProtocolResourceDefinitionRegistrar.Configurator<P> {
        @Override
        default ResourceDescriptor.Builder apply(ResourceDescriptor.Builder builder) {
            return AbstractProtocolResourceDefinitionRegistrar.Configurator.super.apply(builder)
    ...
    SocketProtocolResourceDefinitionRegistrar(Configurator<P> configurator) {
        super(configurator);
    }
}
