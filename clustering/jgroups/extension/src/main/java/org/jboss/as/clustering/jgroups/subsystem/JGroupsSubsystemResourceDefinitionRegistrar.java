 ...
 */
public enum JGroupsSubsystemResourceDefinitionRegistrar implements SubsystemResourceRegistration, SubsystemResourceDefinitionRegistrar, BiPredicate<OperationContext, Resource>, ResourceServiceConfigurator {
    INSTANCE;

    static final ParentResourceDescriptionResolver RESOLVER = new SubsystemResourceDescriptionResolver(INSTANCE.getName(), JGroupsSubsystemResourceDefinitionRegistrar.class);
    ...
    public ManagementResourceRegistration register(SubsystemRegistration parent, ManagementResourceRegistrationContext context) {
        ...
        ManagementResourceRegistration registration = parent.registerSubsystemModel(ResourceDefinition.builder(this, RESOLVER).build());
