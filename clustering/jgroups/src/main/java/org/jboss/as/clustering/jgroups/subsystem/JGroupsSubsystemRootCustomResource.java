 ...
 */
public class JGroupsSubsystemRootCustomResource implements Resource {

    private final Resource delegate;
    private volatile ServiceRegistry registry;

    public JGroupsSubsystemRootCustomResource() {
        this(Resource.Factory.create());
    }

    public JGroupsSubsystemRootCustomResource(final Resource delegate) {
    ...
    public Resource clone() {
        JGroupsSubsystemRootCustomResource clone = new JGroupsSubsystemRootCustomResource(delegate.clone());
    ...
    private boolean hasChannel(PathElement element) {
        ...
        ServiceName channelName = ChannelInstanceCustomResource.CHANNEL_PARENT.append(element.getValue());
        boolean found = false;
        try {
    ...
    private String getNameFromServiceName(ServiceName serviceName) {
        ...
        String result = serviceNameAsString.substring(ChannelInstanceCustomResource.CHANNEL_PREFIX_LENGTH + 1);
        return result ;
    }
