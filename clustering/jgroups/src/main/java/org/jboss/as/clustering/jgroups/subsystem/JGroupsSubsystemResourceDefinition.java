...
public class JGroupsSubsystemResourceDefinition extends SimpleResourceDefinition {
    ...
    static TransformationDescription buildTransformers(ModelVersion version) {
        ...
        if (JGroupsModel.VERSION_3_0_0.requiresTransformation(version)) {
            builder.getAttributeBuilder().setDiscard(DiscardAttributeChecker.ALWAYS, DEFAULT_CHANNEL);
            builder.getAttributeBuilder().addRejectCheck(RejectAttributeChecker.UNDEFINED, DEFAULT_STACK);
