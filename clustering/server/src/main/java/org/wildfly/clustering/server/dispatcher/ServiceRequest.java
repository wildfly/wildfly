...
public class ServiceRequest<T> extends UnicastRequest<T> {
    ...
    public ServiceRequest(RequestCorrelator correlator, Address target, RequestOptions options, Object context) {
    ...
    public void receiveResponse(Object value, Address sender, boolean exceptional) {
        ...
        if (exceptional) {
            ...
            MarshalledValue<T, Object> marshalledValue = (MarshalledValue<T, Object>) value;
            try {
