 ...
 * @author Paul Ferraro
 */
public class CacheSingletonServiceBuilderFactoryServiceInstaller extends SingletonServiceBuilderFactoryServiceInstaller implements ClusteredCacheServiceInstaller {
    ...
    private static final CacheServiceBuilder<SingletonServiceBuilderFactory> BUILDER = new CacheServiceBuilder<SingletonServiceBuilderFactory>() {
        ...
        public ServiceBuilder<SingletonServiceBuilderFactory> build(ServiceTarget target, ServiceName name, String container, String cache) {
            return target.addService(name, new CacheSingletonServiceBuilderFactoryService(container, cache));
        }
    };

    public CacheSingletonServiceBuilderFactoryServiceInstaller() {
        super(BUILDER);
    }
}
