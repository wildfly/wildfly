...
public class ServiceSerializationContextInitializer extends AbstractSerializationContextInitializer {
    ...
    public void registerMarshallers(SerializationContext context) {
        context.registerMarshaller(new SingleFieldMarshaller<>(AnyField.STRING.cast(String.class), Functions.constantSupplier(ServiceName.JBOSS), ServiceNameResolver.PARSER, ServiceNameResolver.RESOLVER));
