 ...
 * @author Paul Ferraro
 */
public class LocalCacheGroupServiceInstaller extends CacheGroupServiceInstaller implements LocalCacheServiceInstaller {
    ...
    private static final CacheServiceBuilder<Group> BUILDER = new CacheServiceBuilder<Group>() {
        ...
        public ServiceBuilder<Group> build(ServiceTarget target, ServiceName name, String container, String cache) {
            return LocalGroupService.build(target, name, container);
        }
    };

    public LocalCacheGroupServiceInstaller() {
        super(BUILDER);
    }
}
