 ...
 * @author Paul Ferraro
 */
public class CacheRegistryFactoryServiceInstaller extends RegistryFactoryServiceInstaller implements ClusteredCacheServiceInstaller {
    ...
    public CacheRegistryFactoryServiceInstaller() {
        super(BUILDER);
    }
}
