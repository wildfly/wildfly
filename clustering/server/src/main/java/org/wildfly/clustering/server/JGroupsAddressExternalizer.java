...
/**
 * Externalizer for an Infinispan JGroups-based address.
 * @author Paul Ferraro
 */
@MetaInfServices(Externalizer.class)
public class JGroupsAddressExternalizer implements Externalizer<JGroupsAddress> {

    @Override
    public Class<JGroupsAddress> getTargetClass() {
