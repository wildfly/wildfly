 ...
 * @author Paul Ferraro
 */
public interface CacheConfigurationAttributeGroup extends UnaryOperator<ResourceDescriptor.Builder>, ResourceModelResolver<BinaryServiceConfiguration> {
    ...
    default ResourceDescriptor.Builder apply(ResourceDescriptor.Builder builder) {
        return builder.addAttributes(this.getAttributes());
    }
}
