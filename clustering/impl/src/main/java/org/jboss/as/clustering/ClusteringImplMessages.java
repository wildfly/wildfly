...
public interface ClusteringImplMessages extends ClusteringMessages {
     ...
     */
    @Message(value = "Address %s not registered in transport layer")
     ...
     * @return an {@link IllegalStateException} for the error.
     */
    @Message(value = "Found member %s in current view that duplicates us (%s). This node cannot join partition until duplicate member has  been removed")
     ...
     */
    @Message(value = "Failure creating multiplexed Channel")
     ...
     */
    @Message("HAPartitionConfig has no %s")
     ...
     */
    @Message(value = "Initial %s transfer failed")
     ...
     */
    @Message(value = "targetNode %s is not an instance of %s -- only targetNodes provided by this HAPartition should be used")
     ...
     * @return the message.
     */
    @Message(value = "Node suspected: %s")
     ...
     */
    @Message(value = "Only partial state transfer (with a state_id) is supported")
     ...
     * @return an {@link IllegalStateException} for the error.
     */
    @Message(value = "State transfer task for %s that will return an %s is already pending")
     ...
     * @return an {@link IllegalArgumentException} for the error.
     */
    @Message(value = "Unknown state_id %s -- must start with %s")
     ...
     * @return the message.
     */
    @Message(value = "New view: %s with viewId: %d (old view: %s)")
     ...
     * @return an {@link IllegalStateException} for the error.
     */
    @Message(value = "No view received from %s")
