...
public class CollectionImmutability implements Predicate<Object> {
    ...
    private static final List<Class<?>> unmodifiableClasses;

    private final Predicate<Object> elementImmutability;

    static {
        unmodifiableClasses = Arrays.asList(
    ...
    public boolean test(Object object) {
        for (Class<?> immutableClass : unmodifiableClasses) {
            if (immutableClass.isInstance(object)) {
                ...
                for (Object e : collection) {
                    if (! this.elementImmutability.test(e)) {
                        return false;
                    }
                }
                return true;
