 ...
 */
@SuppressWarnings({ "rawtypes", "unqualified-field-access" })
public class PortableConcurrentDirectDeque<E> extends AbstractCollection<E> implements ConcurrentDirectDeque<E>, Serializable {
