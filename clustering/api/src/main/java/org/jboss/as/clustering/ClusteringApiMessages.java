...
public interface ClusteringApiMessages extends ClusteringMessages {
     ...
     * @return the message.
     */
    @Message(id = 10235, value = "Unable to acquire lock as it is held by unknown")
     ...
     * @return the message.
     */
    @Message(id = 10236, value = "Unable to acquire lock as it is held by %s")
     ...
     */
    @Message(id = 10237, value = "%s %s is not compatible with %s %s")
     ...
     */
    @Message(id = 10238, value = "Should not receive unlock calls for remote node %s")
     ...
     */
    @Message(id = 10239, value = "Failed releasing remote lock")
