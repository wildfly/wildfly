...
public interface InfinispanLogger extends ClusteringLogger {
    ...
    @Message(id = 10245, value = "Activating Infinispan subsystem.")
     ...
     */
    @LogMessage(level = INFO)
    @Message(id = 10246, value = "Started %s cache from %s container")
     ...
     */
    @LogMessage(level = INFO)
    @Message(id = 10247, value = "Stopped %s cache from %s container")
