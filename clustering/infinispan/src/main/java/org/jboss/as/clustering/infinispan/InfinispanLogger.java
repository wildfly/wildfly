...
public interface InfinispanLogger extends ClusteringLogger {
    ...
    @Message(id = 10250, value = "Activating Infinispan subsystem.")
     ...
     */
    @LogMessage(level = INFO)
    @Message(id = 10251, value = "Started %s cache from %s container")
     ...
     */
    @LogMessage(level = INFO)
    @Message(id = 10252, value = "Stopped %s cache from %s container")
