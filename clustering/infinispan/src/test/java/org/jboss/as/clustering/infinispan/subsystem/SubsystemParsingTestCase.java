...
public class SubsystemParsingTestCase extends ClusteringSubsystemTest {
    ...
    public static Collection<Object[]> data() {
        Object[][] data = new Object[][] {
            { InfinispanSchema.VERSION_1_0, 37 },
            { InfinispanSchema.VERSION_1_1, 37 },
            { InfinispanSchema.VERSION_1_2, 41 },
            { InfinispanSchema.VERSION_1_3, 41 },
            { InfinispanSchema.VERSION_1_4, 81 },
            { InfinispanSchema.VERSION_2_0, 85 },
            { InfinispanSchema.VERSION_3_0, 80 },
        };
