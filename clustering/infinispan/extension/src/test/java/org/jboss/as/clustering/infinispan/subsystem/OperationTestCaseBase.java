...
public class OperationTestCaseBase extends AbstractSubsystemTest {
    ...
    static final String SUBSYSTEM_XML_FILE = String.format("subsystem-infinispan-%d_%d.xml", InfinispanSchema.CURRENT.getVersion().major(), InfinispanSchema.CURRENT.getVersion().minor());
