...
public class OperationSequencesTestCase extends OperationTestCaseBase {
    ...
    public void testCacheContainerAddRemoveAddSequence() throws Exception {
        ...
        ModelNode addCacheOp = getCacheAddOperation("maximal2", LocalCacheResourceDescription.pathElement("fred"));
    ...
    public void testLocalCacheAddRemoveAddSequence() throws Exception {
        ...
        ModelNode addOp = getCacheAddOperation("maximal", LocalCacheResourceDescription.pathElement("fred"));
        ModelNode removeOp = getCacheRemoveOperation("maximal", LocalCacheResourceDescription.pathElement("fred"));
