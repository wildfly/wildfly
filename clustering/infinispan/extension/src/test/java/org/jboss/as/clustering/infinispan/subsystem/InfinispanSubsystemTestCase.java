...
public class InfinispanSubsystemTestCase extends AbstractSubsystemSchemaTest<InfinispanSubsystemSchema> {
    ...
    private static void purgeJGroupsModel(ModelNode model) {
        model.get(JGroupsSubsystemResourceDefinitionRegistrar.INSTANCE.getPathElement().getKey()).remove(JGroupsSubsystemResourceDefinitionRegistrar.INSTANCE.getPathElement().getValue());
    }
