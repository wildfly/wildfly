 ...
 * @author Paul Ferraro
 */
public class RuntimeResourceDefinitionRegistrar implements ChildResourceDefinitionRegistrar {

    private final ResourceRegistration registration;
    private final ManagementResourceRegistrar registrar;

    RuntimeResourceDefinitionRegistrar(ResourceRegistration registration, ManagementResourceRegistrar registrar) {
