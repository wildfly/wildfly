...
/**
 * Registers a resource definition for a clustered cache.
 * @author Paul Ferraro
 */
public class ClusteredCacheResourceDefinitionRegistrar extends CacheResourceDefinitionRegistrar<ClusteredCacheServiceInstallerProvider> {
    ...
    interface Configurator extends CacheResourceDefinitionRegistrar.Configurator<ClusteredCacheServiceInstallerProvider> {
        @Override
        default Class<ClusteredCacheServiceInstallerProvider> getServiceInstallerProviderClass() {
        ...
        default ResourceDescriptor.Builder apply(ResourceDescriptor.Builder builder) {
            return CacheResourceDefinitionRegistrar.Configurator.super.apply(builder)
    ...
    public ClusteredCacheResourceDefinitionRegistrar(Configurator configurator) {
        super(configurator);
    }
