 ...
 */
public enum ThreadPool implements ThreadPoolResourceResourceRegistration<ThreadPoolConfiguration> {
    ...
    public Collection<AttributeDefinition> getAttributes() {
        return List.of(this.minThreads, this.maxThreads, this.queueLength, this.keepAlive);
    }
