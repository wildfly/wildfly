...
/**
 * Thread pool definitions for Infinispan subsystem.
 * <p/>
 ...
 * for hardcoded Infinispan default values.
 *
 * @author Radoslav Husar
 * @version Feb 2015
 */
enum ThreadPoolResourceDefinition implements ResourceDefinition {

    TRANSPORT(ModelKeys.TRANSPORT, 25, 25, 100000, 60000),
    LISTENER(ModelKeys.LISTENER, 1, 1, 100000, 60000),
    PERSISTENCE(ModelKeys.PERSISTENCE, 1, 4, 0, 60000),
    ;
    ...
    ThreadPoolResourceDefinition(String name, int defaultMinThreads, int defaultMaxThreads, int defaultQueueLength, long defaultKeepaliveTime) {
        this.name = name;
        this.descriptionResolver = new InfinispanResourceDescriptionResolver(ModelKeys.CACHE_CONTAINER, ModelKeys.THREAD_POOL);
