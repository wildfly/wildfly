...
public class CacheContainerResourceDefinition extends ChildResourceDefinition {
    ...
    public void register(ManagementResourceRegistration parentRegistration) {
        ...
        ResourceDescriptor descriptor = new ResourceDescriptor(this.getResourceDescriptionResolver())
                ...
                .addCapabilities((context, model) -> model.hasDefined(Attribute.DEFAULT_CACHE.getName()), DEFAULT_CAPABILITIES.values())
                .addCapabilities((context, model) -> model.hasDefined(Attribute.DEFAULT_CACHE.getName()), DEFAULT_CLUSTERING_CAPABILITIES.values())
