...
public abstract class TransportResourceDefinitionRegistrar extends ConfigurationResourceDefinitionRegistrar<TransportConfiguration, TransportConfigurationBuilder> implements ResourceServiceConfigurator {
    ...
    interface Configurator extends ConfigurationResourceDefinitionRegistrar.Configurator, ResourceModelResolver<String> {
        @Override
        ...
        default ResourceDescriptor.Builder apply(ResourceDescriptor.Builder builder) {
            return ConfigurationResourceDefinitionRegistrar.Configurator.super.apply(builder).addCapabilities(List.of(COMMAND_DISPATCHER_FACTORY, GROUP));
        }
    }
