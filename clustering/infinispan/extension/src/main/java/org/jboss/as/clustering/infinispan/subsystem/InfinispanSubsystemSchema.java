...
import org.jboss.as.clustering.controller.persistence.xml.ResourceRegistrationXMLElement;
import org.jboss.as.clustering.controller.persistence.xml.ResourceXMLAll;
...
import org.jboss.as.clustering.controller.persistence.xml.SingletonResourceRegistrationXMLChoice;
...
*/
    ...
    ResourceRegistrationXMLElement cacheContainerElement() {
        ...
        contentBuilder.addChoice(this.factory.singletonChoice(TransportResourceRegistration.NONE)
    ...
    ResourceRegistrationXMLElement threadPoolElement(ScheduledThreadPoolResourceRegistration<?> pool) {
        return this.threadPoolElementBuilder(pool)
                .addAttributes(pool.getAttributes())
                .build();
    }

    ResourceRegistrationXMLElement scheduledThreadPoolElement(ScheduledThreadPoolResourceRegistration<?> pool) {
    ...
    SingletonResourceRegistrationXMLElement.Builder threadPoolElementBuilder(ScheduledThreadPoolResourceRegistration<?> pool) {
    ...
    SingletonResourceRegistrationXMLElement transportElement() {
    ...
    ResourceRegistrationXMLElement distributedCacheElement() {
        return this.segmentedCacheElementBuilder(CacheResourceRegistration.DISTRIBUTED)
                ...
                .addAttributes(ResourceDescriptor.stream(EnumSet.allOf(DistributedCacheResourceDefinitionRegistrar.Attribute.class)).toList())
                .withContent(this.sharedStateCacheElementContentBuilder().build())
                .build();
    }

    ResourceRegistrationXMLElement scatteredCacheElement() {
    ...
    NamedResourceRegistrationXMLElement.Builder segmentedCacheElementBuilder(CacheResourceRegistration description) {
    ...
    NamedResourceRegistrationXMLElement.Builder clusteredCacheElementBuilder(CacheResourceRegistration description) {
    ...
    NamedResourceRegistrationXMLElement.Builder cacheElementBuilder(CacheResourceRegistration description) {
    ...
    ResourceXMLSequence.Builder sharedStateCacheElementContentBuilder() {
    ...
    ResourceRegistrationXMLElement partitionHandlingElement() {
    ...
    ResourceRegistrationXMLElement stateTransferElement() {
    ...
    ResourceRegistrationXMLElement backupSitesElement() {
    ...
    ResourceXMLSequence.Builder cacheElementContentBuilder() {
    ...
    ResourceRegistrationXMLElement lockingElement() {
    ...
    ResourceRegistrationXMLElement transactionElement() {
    ...
    ResourceXMLChoice memoryChoice() {
    ...
    ResourceRegistrationXMLElement heapMemoryElement() {
        SingletonResourceRegistrationXMLElement.Builder builder = this.memoryElementBuilder(MemoryResourceRegistration.HEAP)
                .implyIfAbsent()
                ;
        if (this.since(VERSION_11_0)) {
    ...
    ResourceRegistrationXMLElement binaryMemoryElement() {
    ...
    ResourceRegistrationXMLElement offHeapMemoryElement() {
    ...
    SingletonResourceRegistrationXMLElement.Builder memoryElementBuilder(ResourceRegistration registration) {
    ...
    ResourceRegistrationXMLElement expirationElement() {
        return this.factory.singletonElement(ComponentResourceRegistration.EXPIRATION)
                .addAttributes(ResourceDescriptor.stream(EnumSet.allOf(ExpirationResourceDefinitionRegistrar.Attribute.class)).toList())
                .withCardinality(XMLCardinality.Single.OPTIONAL)
                .implyIfAbsent()
                .build();
    }

    ResourceXMLChoice storeChoice() {
        SingletonResourceRegistrationXMLChoice.Builder builder = this.factory.singletonChoice(StoreResourceRegistration.NONE)
    ...
    SingletonResourceRegistrationXMLElement customStoreElement() {
    ...
    SingletonResourceRegistrationXMLElement fileStoreElement() {
    ...
    SingletonResourceRegistrationXMLElement remoteStoreElement() {
    ...
    SingletonResourceRegistrationXMLElement hotrodStoreElement() {
        return this.storeBuilder(StoreResourceRegistration.HOTROD)
                .addAttributes(List.of(HotRodStoreResourceDefinitionRegistrar.REMOTE_CACHE_CONTAINER, HotRodStoreResourceDefinitionRegistrar.REMOTE_CACHE_CONFIGURATION))
                .withContent(this.storeContentBuilder().build())
                .build();
    }

    SingletonResourceRegistrationXMLElement jdbcStoreElement(String localName, List<String> tableLocalNames) {
    ...
    SingletonResourceRegistrationXMLElement tableElement(String localName) {
    ...
    SingletonResourceRegistrationXMLElement.Builder storeBuilder(ResourceRegistration registration) {
    ...
    ResourceXMLSequence.Builder storeContentBuilder() {
    ...
    ResourceXMLChoice storeWriteChoice() {
        ...
        return this.factory.singletonChoice(StoreWriteResourceRegistration.THROUGH)
                .addElement(builder.build())
                .build();
    }

    ResourceRegistrationXMLElement remoteCacheContainerElement() {
        NamedResourceRegistrationXMLElement.Builder builder = this.factory.namedElement(RemoteCacheContainerResourceDefinitionRegistrar.REGISTRATION)
                ...
                .addAttributes(ResourceDescriptor.stream(EnumSet.allOf(RemoteCacheContainerResourceDefinitionRegistrar.Attribute.class)).toList())
                .withCardinality(XMLCardinality.Unbounded.OPTIONAL)
                ;
        if (this.since(VERSION_9_0)) {
            if (this.since(VERSION_13_0)) {
    ...
    ResourceRegistrationXMLElement connectionPoolElement() {
        return this.factory.singletonElement(RemoteComponentResourceRegistration.CONNECTION_POOL)
                .withCardinality(XMLCardinality.Single.OPTIONAL)
                .implyIfAbsent()
                .addAttributes(ResourceDescriptor.stream(EnumSet.allOf(ConnectionPoolResourceDefinitionRegistrar.Attribute.class)).toList())
                .build();
    }

    ResourceRegistrationXMLElement remoteClusterElement() {
    ...
    ResourceRegistrationXMLElement securityElement() {
