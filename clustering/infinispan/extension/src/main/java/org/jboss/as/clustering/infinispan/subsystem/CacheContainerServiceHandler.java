...
public class CacheContainerServiceHandler implements ResourceServiceHandler {
    ...
    public void installServices(OperationContext context, ModelNode model) throws OperationFailedException {
        ...
        ModelNodes.optionalString(CacheContainerResourceDefinition.Attribute.JNDI_NAME.resolveModelAttribute(context, model)).ifPresent(jndiName -> bindingBuilder.alias(ContextNames.bindInfoFor(JndiNameFactory.parse(jndiName).getAbsoluteName())));
