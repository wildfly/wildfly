...
/**
 * Describes a transaction cache component resource.
 * @author Richard Achmatowicz (c) 2011 Red Hat Inc.
 */
public enum TransactionResourceDescription implements CacheComponentResourceDescription<TransactionConfiguration, TransactionConfigurationBuilder> {
    INSTANCE;

    private static final PathElement PATH = ComponentResourceDescription.pathElement("transaction");
    private static final BinaryServiceDescriptor<TransactionConfiguration> SERVICE_DESCRIPTOR = CacheComponentResourceDescription.createServiceDescriptor(PATH, TransactionConfiguration.class);
    ...
    @Override
    public BinaryServiceDescriptor<TransactionConfiguration> getServiceDescriptor() {
    ...
    public Stream<AttributeDefinition> getAttributes() {
        return Stream.of(LOCKING, MODE, STOP_TIMEOUT, COMPLETE_TIMEOUT);
    }
