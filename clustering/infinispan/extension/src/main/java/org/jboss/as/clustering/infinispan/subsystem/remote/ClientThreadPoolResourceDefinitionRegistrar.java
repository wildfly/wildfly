...
import org.jboss.as.clustering.infinispan.subsystem.ThreadPoolResourceResourceRegistration;
...
public class ClientThreadPoolResourceDefinitionRegistrar extends ConfigurationResourceDefinitionRegistrar<ExecutorFactoryConfiguration, ExecutorFactoryConfigurationBuilder> {
    ...
    ClientThreadPoolResourceDefinitionRegistrar(ThreadPoolResourceResourceRegistration<ExecutorFactoryConfiguration> pool) {
        super(new Configurator() {
            ...
            public ResourceDescriptor.Builder apply(ResourceDescriptor.Builder builder) {
                return Configurator.super.apply(builder).addAttributes(pool.getAttributes());
            }
        });
