...
/**
 * Registers a resource definition for the state transfer component of a cache.
 * @author Paul Ferraro
 */
    ...
    StateTransferResourceDefinitionRegistrar() {
        super(new Configurator() {
            ...
            public ResourceDescriptor.Builder apply(ResourceDescriptor.Builder builder) {
                return Configurator.super.apply(builder).addAttributes(List.of(TIMEOUT, CHUNK_SIZE));
            }
        });
    }
