...
public enum CacheClassLoaderServiceConfigurator implements ResourceServiceConfigurator {
    ...
    public ResourceServiceInstaller configure(OperationContext context, ModelNode model) throws OperationFailedException {
        ...
        ServiceDependency<ClassLoader> loader = config.getServiceDependency(InfinispanServiceDescriptor.CACHE_CONTAINER_CONFIGURATION).combine(CacheResourceDescription.MODULES.resolve(context, model), new BiFunction<>() {
            @Override
