    ...
    DistributedCacheResourceDefinitionRegistrar(FunctionExecutorRegistry<Cache<?, ?>> executors) {
        super(new Configurator() {
            ...
            public CacheResourceRegistration getResourceRegistration() {
                return CacheResourceRegistration.DISTRIBUTED;
            }

            @Override
            public ResourceDescriptor.Builder apply(ResourceDescriptor.Builder builder) {
                return Configurator.super.apply(builder).addAttributes(List.of(L1_LIFESPAN)).provideAttributes(EnumSet.allOf(Attribute.class));
            }
        }, executors);
    }
