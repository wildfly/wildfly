...
public enum RemoteCacheOperation implements RuntimeOperation<RemoteCacheClientStatisticsMXBean> {
    ...
    RemoteCacheOperation(String name, ModelType replyType) {
        this.definition = new SimpleOperationDefinitionBuilder(name, InfinispanSubsystemResourceDefinitionRegistrar.RESOLVER.createChildResolver(RemoteCacheRuntimeResourceDefinitionRegistrar.WILDCARD_PATH))
