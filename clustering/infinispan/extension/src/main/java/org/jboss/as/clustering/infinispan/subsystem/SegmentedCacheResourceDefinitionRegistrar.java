...
public class SegmentedCacheResourceDefinitionRegistrar extends SharedStateCacheResourceDefinitionRegistrar {
    ...
    interface Configurator extends SharedStateCacheResourceDefinitionRegistrar.Configurator {
        @Override
        default ResourceDescriptor.Builder apply(ResourceDescriptor.Builder builder) {
            return SharedStateCacheResourceDefinitionRegistrar.Configurator.super.apply(builder).addAttributes(List.of(SEGMENTS));
        }
    }

    SegmentedCacheResourceDefinitionRegistrar(Configurator configurator, FunctionExecutorRegistry<Cache<?, ?>> executors) {
        super(configurator, executors);
    }
