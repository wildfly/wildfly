...
/**
 * Registers a resource definition for a clustered cache with shared state.
 */
public class SharedStateCacheResourceDefinitionRegistrar extends ClusteredCacheResourceDefinitionRegistrar {

    interface Configurator extends ClusteredCacheResourceDefinitionRegistrar.Configurator {
        @Override
        default ResourceDescriptor.Builder apply(ResourceDescriptor.Builder builder) {
            return ClusteredCacheResourceDefinitionRegistrar.Configurator.super.apply(builder)
    ...
    SharedStateCacheResourceDefinitionRegistrar(Configurator configurator, FunctionExecutorRegistry<Cache<?, ?>> executors) {
        super(configurator);
