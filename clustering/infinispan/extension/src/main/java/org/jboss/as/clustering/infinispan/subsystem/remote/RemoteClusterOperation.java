...
public enum RemoteClusterOperation implements RuntimeOperation<Map.Entry<String, RemoteCacheManagerMXBean>> {
    ...
    RemoteClusterOperation(String name, ModelType replyType) {
        this.definition = new SimpleOperationDefinitionBuilder(name, InfinispanSubsystemResourceDefinitionRegistrar.RESOLVER.createChildResolver(RemoteClusterResourceDescription.INSTANCE.getPathElement()))
