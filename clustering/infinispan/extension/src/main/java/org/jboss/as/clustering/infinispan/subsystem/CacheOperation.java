...
public enum CacheOperation implements RuntimeOperation<CacheMgmtInterceptor> {
    ...
    CacheOperation(String name, ModelType returnType) {
        ResourceDescriptionResolver resolver = InfinispanSubsystemResourceDefinitionRegistrar.RESOLVER.createChildResolver(CacheRuntimeResourceDefinitionRegistrar.WILDCARD_PATH);
