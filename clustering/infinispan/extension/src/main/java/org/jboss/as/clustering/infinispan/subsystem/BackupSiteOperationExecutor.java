 ...
 * @author Paul Ferraro
 */
public class BackupSiteOperationExecutor implements OperationExecutor<BackupSiteOperationContext> {

    @Override
    public ModelNode execute(OperationContext context, Operation<BackupSiteOperationContext> operation) throws OperationFailedException {
