...
/**
 * Scheduled thread pool definitions for Infinispan subsystem.
 * <p/>
 ...
 * @version Mar 2015
 */
enum ScheduledThreadPoolResourceDefinition implements ResourceDefinition {

    EVICTION(ModelKeys.EVICTION, 1, 60000);
    ...
    AttributeDefinition[] getAttributes() {
        return new AttributeDefinition[]{this.maxThreads, this.keepaliveTime};
    }
