...
public class CacheRuntimeResourceDefinitionRegistrar implements ChildResourceDefinitionRegistrar {
    ...
    public ManagementResourceRegistration register(ManagementResourceRegistration parent, ManagementResourceRegistrationContext context) {
        ...
        new RuntimeResourceDefinitionRegistrar(ComponentResourceRegistration.LOCKING, new MetricOperationStepHandler<>(new LockingMetricExecutor(this.executors), LockingMetric.class)).register(registration, context);
        new RuntimeResourceDefinitionRegistrar(ComponentResourceRegistration.PARTITION_HANDLING, new ManagementResourceRegistrar() {
            @Override
        ...
        new RuntimeResourceDefinitionRegistrar(ComponentResourceRegistration.PERSISTENCE, new MetricOperationStepHandler<>(new CacheInterceptorMetricExecutor<>(this.executors, CacheLoaderInterceptor.class, BinaryCapabilityNameResolver.GRANDPARENT_PARENT), StoreMetric.class)).register(registration, context);
        new RuntimeResourceDefinitionRegistrar(ComponentResourceRegistration.TRANSACTION, new MetricOperationStepHandler<>(new CacheInterceptorMetricExecutor<>(this.executors, TxInterceptor.class, BinaryCapabilityNameResolver.GRANDPARENT_PARENT), TransactionMetric.class)).register(registration, context);
