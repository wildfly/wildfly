 ...
 * @author Paul Ferraro
 */
public class HotRodCacheConfigurationDescriptor implements CacheConfigurationDescriptor {
    ...
    public HotRodCacheConfigurationDescriptor(RuntimeCapability<Void> capability) {
