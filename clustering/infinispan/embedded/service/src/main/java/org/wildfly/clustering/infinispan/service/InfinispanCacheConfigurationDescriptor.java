 ...
 * @author Paul Ferraro
 */
public class InfinispanCacheConfigurationDescriptor implements CacheConfigurationDescriptor {
    ...
    public InfinispanCacheConfigurationDescriptor(RuntimeCapability<Void> capability) {
