...
public class CacheConfigurationServiceInstaller implements ServiceInstaller {
    ...
    public ServiceController<?> install(RequirementServiceTarget target) {
        ...
        ServiceDependency<org.infinispan.configuration.cache.Configuration> cacheConfiguration = this.builder.combine(manager, new BiFunction<>() {
            @Override
            public org.infinispan.configuration.cache.Configuration apply(ConfigurationBuilder builder, EmbeddedCacheManager manager) {
                ...
                builder.encoding().mediaType(builder.memory().storage().canStoreReferences() ? MediaType.APPLICATION_OBJECT : manager.getCacheManagerConfiguration().serialization().marshaller().mediaType());
        ...
        return ServiceInstaller.builder(cacheConfiguration)
