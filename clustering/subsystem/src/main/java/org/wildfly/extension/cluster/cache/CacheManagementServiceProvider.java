...
public class CacheManagementServiceProvider implements ChannelDependentServiceProvider {
    ...
    public Collection<ServiceController<?>> install(ServiceTarget target, String containerName, ModuleIdentifier moduleId) {
        ...
        ServiceController<CacheManagement> controller = target.addService(name, service)
                .addDependency(CommandDispatcherFactory.SERVICE_NAME.append(containerName), CommandDispatcherFactory.class, dispatcherFactory)
