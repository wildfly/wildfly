...
public enum Namespace {
    ...
    CLUSTER_1_0(1, 0, new ClusterSubsystemXMLReader_1_0())
    ;

    private static final String BASE_URN = "urn:jboss:domain:cluster:";

    /**
     * The current namespace version.
     */
    public static final Namespace CURRENT = CLUSTER_1_0;
