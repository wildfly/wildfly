...
public interface ClusteringMonitorServicesLogger extends BasicLogger {

    String ROOT_LOGGER_CATEGORY = ClusteringMonitorServicesLogger.class.getPackage().getName();

    /**
     * A logger with the category of the default clustering package.
     */
    ClusteringMonitorServicesLogger ROOT_LOGGER = Logger.getMessageLogger(ClusteringMonitorServicesLogger.class, ROOT_LOGGER_CATEGORY);
