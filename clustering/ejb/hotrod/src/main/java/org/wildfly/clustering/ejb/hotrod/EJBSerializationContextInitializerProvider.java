...
import org.wildfly.clustering.ejb.hotrod.bean.HotRodBeanSerializationContextInitializer;
...
public enum EJBSerializationContextInitializerProvider implements SerializationContextInitializerProvider {
    ...
    CACHE(new BeanSerializationContextInitializer()),
    HOTROD(new HotRodBeanSerializationContextInitializer()),
    ;
