...
public class InfinispanTimerManagementProvider implements TimerManagementProvider, UnaryOperator<ConfigurationBuilder> {
    ...
    public <I> Iterable<ServiceInstaller> getTimerManagerFactoryServiceInstallers(ServiceName name, TimerManagerFactoryConfiguration<I> configuration) {
        ...
        ServiceInstaller cacheConfigurationInstaller = new CacheConfigurationServiceInstaller(beanCacheConfiguration, CacheConfigurationServiceInstaller.fromTemplate(this.cacheConfiguration).map(this));
        ServiceInstaller cacheInstaller = new CacheServiceInstaller(beanCacheConfiguration);
