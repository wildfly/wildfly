...
/**
 * Transformer for the distributable-ejb subsystem resource.
 * @author Paul Ferraro
 */
public class DistributableEjbResourceTransformer implements Function<ModelVersion, TransformationDescription> {
    ...
    public TransformationDescription apply(ModelVersion version) {
        ...
        if (DistributableEjbSubsystemModel.VERSION_2_0_0.requiresTransformation(version)) {
            this.builder.rejectChildResource(HotRodBeanManagementResourceDefinition.WILDCARD_PATH);
        }
