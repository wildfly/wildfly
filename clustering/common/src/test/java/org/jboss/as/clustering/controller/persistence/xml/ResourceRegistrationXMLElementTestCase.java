...
public class ResourceRegistrationXMLElementTestCase implements FeatureRegistry, QNameResolver {
    ...
    public void override() throws XMLStreamException, OperationFailedException {
        ...
        ResourceRegistrationXMLElement subsystemElement = this.factory.subsystemElement(subsystem).withContent(this.factory.namedElementChoice(childElement).addElement(overrideElement).addElement(experimentalElement).withCardinality(XMLCardinality.Unbounded.OPTIONAL).build()).build();
