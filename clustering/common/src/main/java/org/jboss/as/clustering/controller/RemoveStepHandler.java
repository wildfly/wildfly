                ...
                if (attributeAccess != null) {
                    ...
                    if (attribute != null) {
                        if (attribute.hasCapabilityRequirements()) {
                            attribute.removeCapabilityRequirements(context, resource, model.get(attribute.getName()));
                        }
                    }
                }
            }
