...
/**
 * Defines a versioned XML namespace.
 * TODO Port to staxmapper
 * @author Paul Ferraro
 */
public interface Namespace<S extends Namespace<S>> {
    /**
     * Returns the major version of this namespace.
     * @return the major version of this namespace.
     */
    int major();

    /**
     * Returns the minor version of this namespace.
     * @return the minor version of this namespace.
     */
    int minor();
