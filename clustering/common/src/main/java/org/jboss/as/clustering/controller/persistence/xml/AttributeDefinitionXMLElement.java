...
public interface AttributeDefinitionXMLElement extends ResourceXMLElement {
    ...
    class DefaultBuilder implements Builder {
        ...
        public AttributeDefinitionXMLElement build() {
            ...
            // TODO Add AttributeParser.getCardinality(AttributeDefinition) method
            XMLCardinality cardinality = (attribute instanceof PropertiesAttributeDefinition) ? (attribute.isRequired() ? XMLCardinality.Unbounded.REQUIRED : XMLCardinality.Unbounded.OPTIONAL) : (attribute.isRequired() ? XMLCardinality.Single.REQUIRED : XMLCardinality.Single.OPTIONAL);
