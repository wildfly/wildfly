...
public interface ClusteringLogger extends BasicLogger {
    ...
    @Message(id = 10201, value = "Caught InterruptedException; Failing request by %s to lock %s")
     ...
     */
    @LogMessage(level = WARN)
    @Message(id = 10208, value = "%s: rolling back transaction with exception")
     ...
     */
    @LogMessage(level = ERROR)
    @Message(id = 10209, value = "%s Thread interrupted")
