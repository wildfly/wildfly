 ...
 * @author Paul Ferraro
 */
public class UnaryRequirementAliasBuilder<T> implements CapabilityServiceBuilder<T> {

    private final ServiceName name;
    private final UnaryServiceNameFactory targetFactory;
    private final String targetName;
    private final Class<T> targetClass;

    private volatile ValueDependency<T> dependency;

    public UnaryRequirementAliasBuilder(ServiceName name, UnaryServiceNameFactory targetFactory, String targetName, Class<T> targetClass) {
        this.name = name;
    ...
    public Builder<T> configure(CapabilityServiceSupport support) {
        this.dependency = new InjectedValueDependency<>(this.targetFactory.getServiceName(support, this.targetName), this.targetClass);
        return this;
    }
