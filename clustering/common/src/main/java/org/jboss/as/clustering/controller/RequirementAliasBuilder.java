...
public class RequirementAliasBuilder<T> implements CapabilityServiceBuilder<T> {
    ...
    public RequirementAliasBuilder(ServiceName name, ServiceNameFactory targetFactory, Class<T> targetClass) {
        this.name = name;
    ...
    public Builder<T> configure(CapabilityServiceSupport support) {
        this.dependency = new InjectedValueDependency<>(this.targetFactory.getServiceName(support), this.targetClass);
        return this;
    }
