...
public interface ClusteringLogger extends BasicLogger {
     ...
     */
    // TODO Relocate to org.jboss.as.controller.parsing.ParseUtils.
    default XMLStreamException minOccursNotReached(XMLExtendedStreamReader reader, Collection<QName> choices, XMLCardinality cardinality) {
     ...
     */
    // TODO Relocate to org.jboss.as.controller.parsing.ParseUtils.
    default XMLStreamException maxOccursExceeded(XMLExtendedStreamReader reader, Collection<QName> choices, XMLCardinality cardinality) {
    ...
    // TODO Relocate to org.jboss.as.controller.parsing.ParseUtils.
    default XMLStreamValidationException createValidationException(XMLStreamException e, ErrorType type, Collection<QName> choices) {
