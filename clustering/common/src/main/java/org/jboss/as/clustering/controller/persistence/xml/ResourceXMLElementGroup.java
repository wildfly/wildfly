...
public interface ResourceXMLElementGroup extends XMLElementGroup<Map.Entry<PathAddress, Map<PathAddress, ModelNode>>, ModelNode> {
    ...
    interface Builder<T extends ResourceXMLElementGroup, B extends Builder<T, B>> extends XMLElementGroup.Builder<Map.Entry<PathAddress, Map<PathAddress, ModelNode>>, ModelNode, T, B>, AttributeDefinitionXMLConfiguration.Configurator<B> {
        /**
         * Adds the specified attribute element to this content.
         * @param attribute an attribute
         * @return a reference to this builder
         */
        default B addElement(AttributeDefinition attribute) {
            return this.addElements(List.of(attribute));
        }

        B addElement(String groupName, Iterable<AttributeDefinition> attributes);

        B addElements(Iterable<AttributeDefinition> attributes);
    }

    abstract class AbstractBuilder<T extends ResourceXMLElementGroup, B extends Builder<T, B>> extends XMLElementGroup.AbstractBuilder<Map.Entry<PathAddress, Map<PathAddress, ModelNode>>, ModelNode, T, B> implements Builder<T, B> {
