...
public interface ClusteringMessages {
     ...
     */
    @Message(value = "Aborting cache operation after %d retries.")
     ...
     * @return the message.
     */
    @Message(value = "Cannot acquire lock %s from cluster")
     ...
     */
    @Message(value = "Caught raw Throwable on remote invocation")
     ...
     */
    @Message(value = "%s does not implement %s")
     ...
     * @return an {@link IllegalArgumentException} for the error.
     */
    @Message(value = "%s is not a valid cache store")
     ...
     * @return an {@link IllegalArgumentException} for the error.
     */
    @Message(value = "%s is not a valid default cache. The %s cache container does not contain a cache with that name")
     ...
     */
    @Message(value = "No %s property was specified within the executor properties: %s")
     ...
     * @return an {@link IllegalStateException} for the error.
     */
    @Message(value = "Must call %s before first call to %s")
     ...
     * @return an {@link IllegalStateException} for the error.
     */
    @Message(value = "No %s property was specified within the transport properties: %s")
     ...
     * @return the message.
     */
    @Message(value = "Failed to locate %s")
     ...
     * @return an {@link IllegalStateException} for the error.
     */
    @Message(value = "Must set %s before calling %s")
