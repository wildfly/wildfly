...
/**
 * Simple {@link AttributeConverter} that provides the operation or model context to a {@link ModelOperationConverter}.
 * @author Paul Ferraro
 */
public class SimpleAttributeConverter implements AttributeConverter {

    public interface ModelOperationConverter {
        void convert(PathAddress address, String name, ModelNode value, ModelNode model, TransformationContext context);
    }

    private final ModelOperationConverter converter;

    public SimpleAttributeConverter(ModelOperationConverter converter) {
