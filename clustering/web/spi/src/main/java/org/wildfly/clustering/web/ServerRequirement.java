 ...
 * @author Paul Ferraro
 */
public enum ServerRequirement implements DefaultableUnaryRequirement, DefaultableUnaryServiceNameFactoryProvider {
    ROUTE("org.wildfly.undertow.server.route", DefaultServerRequirement.ROUTE),
    ;
    private final String name;
    private final UnaryServiceNameFactory factory = new UnaryRequirementServiceNameFactory(this);
    private final DefaultServerRequirement defaultRequirement;

    ServerRequirement(String name, DefaultServerRequirement defaultRequirement) {
        this.name = name;
