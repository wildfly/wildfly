 ...
 * @author Paul Ferraro
 */
public abstract class SessionManagementResourceDefinitionRegistrar implements ChildResourceDefinitionRegistrar, ResourceServiceConfigurator, DistributableSessionManagementProviderFactory, UnaryOperator<ResourceDescriptor.Builder> {
    ...
    interface Configurator {
        ...
        ResourceRegistration getDefaultAffinityResourceRegistration();

        CacheConfigurationDescriptor getCacheConfigurationDescriptor();
    }

    private final ResourceRegistration registration;
    private final CacheConfigurationDescriptor cacheConfigurationDescriptor;

    SessionManagementResourceDefinitionRegistrar(ResourceRegistration registration, CacheConfigurationDescriptor cacheConfigurationDescriptor) {
        this.registration = registration;
        this.cacheConfigurationDescriptor = cacheConfigurationDescriptor;
    }

    @Override
    public ResourceDescriptor.Builder apply(ResourceDescriptor.Builder builder) {
        return this.cacheConfigurationDescriptor.apply(builder)
    ...
    public ResourceServiceInstaller configure(OperationContext context, ModelNode model) throws OperationFailedException {
        ...
        BinaryServiceConfiguration cacheConfiguration = this.cacheConfigurationDescriptor.getResolver().resolve(context, model);
        ...
        return CapabilityServiceInstaller.builder(CAPABILITY, this.createSessionManagementProvider(configuration, cacheConfiguration, locatorProvider))
