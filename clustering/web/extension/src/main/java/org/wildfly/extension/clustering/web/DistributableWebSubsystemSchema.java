...
public enum DistributableWebSubsystemSchema implements SubsystemResourceXMLSchema<DistributableWebSubsystemSchema> {
    ...
    public SubsystemResourceRegistrationXMLElement getSubsystemXMLElement() {
        ...
        ResourceXMLChoice userManagementChoice = this.factory.choice()
                .withCardinality(XMLCardinality.Unbounded.REQUIRED)
                .addElement(this.userManagementElement(UserManagementResourceRegistration.INFINISPAN, InfinispanUserManagementResourceDefinitionRegistrar.CACHE_CONFIGURATION))
                .addElement(this.userManagementElement(UserManagementResourceRegistration.HOTROD, HotRodUserManagementResourceDefinitionRegistrar.CACHE_CONFIGURATION))
                .build();
    ...
    ResourceRegistrationXMLElement infinispanSessionManagementElement() {
        ...
        return this.sessionManagementElementBuilder(SessionManagementResourceRegistration.INFINISPAN, InfinispanSessionManagementResourceDefinitionRegistrar.CACHE_CONFIGURATION)
                .withContent(contentBuilder.build())
                .build();
    }

    ResourceRegistrationXMLElement hotrodSessionManagementElement() {
        NamedResourceRegistrationXMLElement.Builder builder = this.sessionManagementElementBuilder(SessionManagementResourceRegistration.HOTROD, HotRodSessionManagementResourceDefinitionRegistrar.CACHE_CONFIGURATION);
    ...
    NamedResourceRegistrationXMLElement.Builder sessionManagementElementBuilder(SessionManagementResourceRegistration registration, CacheConfigurationDescriptor cacheConfiguration) {
        NamedResourceRegistrationXMLElement.Builder builder = this.factory.namedElement(registration)
                .addAttributes(List.of(cacheConfiguration.getContainerAttribute(), cacheConfiguration.getCacheAttribute(), SessionManagementResourceDefinitionRegistrar.GRANULARITY))
                ;
    ...
    NamedResourceRegistrationXMLElement userManagementElement(UserManagementResourceRegistration registration, CacheConfigurationDescriptor cacheConfiguration) {
        return this.factory.namedElement(registration)
                .addAttributes(List.of(cacheConfiguration.getContainerAttribute(), cacheConfiguration.getCacheAttribute()))
                .build();
    }
    ...
    ResourceRegistrationXMLElement infinispanRoutingElement() {
        return this.routingElementBuilder(RoutingProviderResourceRegistration.INFINISPAN)
                .addAttributes(List.of(InfinispanRoutingProviderResourceDefinitionRegistrar.CACHE_CONFIGURATION.getContainerAttribute(), InfinispanRoutingProviderResourceDefinitionRegistrar.CACHE_CONFIGURATION.getCacheAttribute()))
                .build();
    }
