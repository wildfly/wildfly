...
public class CoarseSessionAttributesFactory<S, C, L, V> implements SessionAttributesFactory<C, Map<String, Object>> {
    ...
    public CoarseSessionAttributesFactory(InfinispanSessionAttributesFactoryConfiguration<S, C, L, Map<String, Object>, V> configuration) {
        ...
        this.prePassivateListenerRegistration = !this.properties.isPersistent() ? new PrePassivateListener<>(this.cache, this::prePassivate, SessionAttributesKeyFilter.INSTANCE) : null;
        this.postActivateListenerRegistration = !this.properties.isPersistent() ? new PostActivateListener<>(this.cache, this::postActivate, SessionAttributesKeyFilter.INSTANCE) : null;
