...
public class FineSessionAttributesFactory<S, C, L, V> implements SessionAttributesFactory<C, AtomicReference<Map<String, UUID>>> {
    ...
    public FineSessionAttributesFactory(InfinispanSessionAttributesFactoryConfiguration<S, C, L, Object, V> configuration) {
        ...
        this.evictListenerRegistration = new PostPassivateListener<>(configuration.getCache(), this::cascadeEvict, SessionCreationMetaDataKeyFilter.INSTANCE);
        this.evictAttributesListenerRegistration = new PrePassivateListener<>(this.namesCache, this::cascadeEvictAttributes, SessionAttributeNamesKeyFilter.INSTANCE);
        this.prePassivateListenerRegistration = !this.properties.isPersistent() ? new PrePassivateListener<>(this.attributeCache, this::prePassivate, SessionAttributeKeyFilter.INSTANCE) : null;
        this.postActivateListenerRegistration = !this.properties.isPersistent() ? new PostActivateListener<>(this.attributeCache, this::postActivate, SessionAttributeKeyFilter.INSTANCE) : null;
    }
