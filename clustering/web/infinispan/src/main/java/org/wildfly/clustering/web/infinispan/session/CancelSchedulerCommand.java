 ...
 * @author Paul Ferraro
 */
public class CancelSchedulerCommand extends AbstractSchedulerCommand {
    private static final long serialVersionUID = -6060731427497057763L;

    public CancelSchedulerCommand(ImmutableSession session) {
        super(session);
    }

    @Override
    public Void execute(SchedulerContext context) throws Exception {
        context.cancel(this.getSession(null));
        return null;
    }
}
