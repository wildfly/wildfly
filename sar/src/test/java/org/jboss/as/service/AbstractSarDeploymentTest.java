 ...
 */
public abstract class AbstractSarDeploymentTest {
    ...
    protected void setupServices(final BatchBuilder batchBuilder) throws Exception {
        MockServerDeploymentRepository.addService(batchBuilder, VFS.getChild(getResource(AbstractSarDeploymentTest.class, "/test")).getPhysicalFile());
    }
