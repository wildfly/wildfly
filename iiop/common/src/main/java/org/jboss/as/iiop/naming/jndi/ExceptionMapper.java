...
public final class ExceptionMapper {
    ...
    public static NamingException mapException(Exception e, CNCtx ctx, NameComponent[] inputName) throws NamingException {
        ...
        if (e instanceof NotFound) {
            ...
            ne.setRemainingName(org.jboss.as.iiop.naming.jndi.CNNameParser.cosNameToName(rest));
    ...
    private static NamingException tryFed(NotFound e, CNCtx ctx,
        ...
        if (rest != null && rest.length > 0) {
            cpe.setRemainingName(org.jboss.as.iiop.naming.jndi.CNNameParser.cosNameToName(rest));
        }
        ...
        if (resolvedObj instanceof javax.naming.Context) {
            ...
            Name cname = org.jboss.as.iiop.naming.jndi.CNNameParser.cosNameToName(resolvedName);
