...
package org.jboss.as.iiop.csiv2;
...
public class SASClientInterceptor extends LocalObject implements ClientRequestInterceptor {
    ...
    public void receive_reply(ClientRequestInfo ri) {
        try {
            ...
            if (contextBody.discriminator() == MTContextError.value) {
                // should not happen.
                throw IIOPMessages.MESSAGES.unexpectedContextErrorInSASReply(MinorCodes.SAS_CSS_FAILURE,
    ...
    public void receive_exception(ClientRequestInfo ri) {
        try {
            ...
            throw IIOPMessages.MESSAGES.errorParsingSASReply(e, MinorCodes.SAS_CSS_FAILURE, CompletionStatus.COMPLETED_MAYBE);
        } catch (TypeMismatch e) {
            throw IIOPMessages.MESSAGES.errorParsingSASReply(e, MinorCodes.SAS_CSS_FAILURE, CompletionStatus.COMPLETED_MAYBE);        }
    }
