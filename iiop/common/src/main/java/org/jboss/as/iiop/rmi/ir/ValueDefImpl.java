...
class ValueDefImpl  extends ContainedImpl  implements ValueDefOperations, LocalContainer, LocalContainedIDLType {
    ...
    public void allDone()
        ...
        for (int i = 0; i < supported_interfaces.length; ++i) {
            ...
            if (iDef == null)
                throw IIOPMessages.MESSAGES.errorResolvingRefToImplementedInterface(id(), supported_interfaces[i]);
        ...
        for (int i = 0; i < abstract_base_valuetypes.length; ++i) {
            ...
            if (vDef == null)
                throw IIOPMessages.MESSAGES.errorResolvingRefToAbstractValuetype(id(), abstract_base_valuetypes[i]);
