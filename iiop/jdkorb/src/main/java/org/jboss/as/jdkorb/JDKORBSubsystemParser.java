...
public class JDKORBSubsystemParser implements XMLStreamConstants, XMLElementReader<List<ModelNode>>,
    ...
    private void parseAttributes(XMLExtendedStreamReader reader, ModelNode node, EnumSet<Attribute> expectedAttributes,
        ...
        for (int i = 0; i < reader.getAttributeCount(); i++) {
            ...
            ((SimpleAttributeDefinition) JDKORBSubsystemDefinitions.valueOf(attribute.getLocalName())).
    ...
    private void writeSecurityConfig(XMLExtendedStreamWriter writer, ModelNode node) throws XMLStreamException {
        ...
        if (writeSecurity) {
            writer.writeEmptyElement(JDKORBSubsystemConstants.SECURITY);
    ...
    enum Namespace {
        ...
        UNKNOWN(null),
        JDK_ORB_1_0("urn:jboss:domain:jdkorb:1.0");

        static final Namespace CURRENT = JDK_ORB_1_0;
    ...
    enum Element {
        ...
        ORB(JDKORBSubsystemConstants.ORB),
        ORB_CONNECTION(JDKORBSubsystemConstants.ORB_CONN),
        ORB_INITIALIZERS(JDKORBSubsystemConstants.ORB_INIT),

        // elements used to configure the POA.
        POA(JDKORBSubsystemConstants.POA),
        POA_REQUEST_PROC(JDKORBSubsystemConstants.POA_RP),

        // elements used to configure the naming service, ORB interoperability and ORB security.
        NAMING(JDKORBSubsystemConstants.NAMING),
        INTEROP(JDKORBSubsystemConstants.INTEROP),
        SECURITY(JDKORBSubsystemConstants.SECURITY),

        // elements used to configure generic properties.
        PROPERTIES(JDKORBSubsystemConstants.PROPERTIES),
        PROPERTY(JDKORBSubsystemConstants.PROPERTY);
    ...
    enum Attribute {
        ...
        NAME(JDKORBSubsystemConstants.NAME),
        ORB_PRINT_VERSION(JDKORBSubsystemConstants.ORB_PRINT_VERSION),
        ORB_USE_IMR(JDKORBSubsystemConstants.ORB_USE_IMR),
        ORB_USE_BOM(JDKORBSubsystemConstants.ORB_USE_BOM),
        ORB_CACHE_TYPECODES(JDKORBSubsystemConstants.ORB_CACHE_TYPECODES),
        ORB_CACHE_POA_NAMES(JDKORBSubsystemConstants.ORB_CACHE_POA_NAMES),
        ORB_GIOP_MINOR_VERSION(JDKORBSubsystemConstants.ORB_GIOP_MINOR_VERSION),
        ORB_SOCKET_BINDING(JDKORBSubsystemConstants.ORB_SOCKET_BINDING),
        ORB_SSL_SOCKET_BINDING(JDKORBSubsystemConstants.ORB_SSL_SOCKET_BINDING),

        // attributes of the connection element.
        ORB_CONN_RETRIES(JDKORBSubsystemConstants.ORB_CONN_RETRIES),
        ORB_CONN_RETRY_INTERVAL(JDKORBSubsystemConstants.ORB_CONN_RETRY_INTERVAL),
        ORB_CONN_CLIENT_TIMEOUT(JDKORBSubsystemConstants.ORB_CONN_CLIENT_TIMEOUT),
        ORB_CONN_SERVER_TIMEOUT(JDKORBSubsystemConstants.ORB_CONN_SERVER_TIMEOUT),
        ORB_CONN_MAX_SERVER_CONNECTIONS(JDKORBSubsystemConstants.ORB_CONN_MAX_SERVER_CONNECTIONS),
        ORB_CONN_MAX_MANAGED_BUF_SIZE(JDKORBSubsystemConstants.ORB_CONN_MAX_MANAGED_BUF_SIZE),
        ORB_CONN_OUTBUF_SIZE(JDKORBSubsystemConstants.ORB_CONN_OUTBUF_SIZE),
        ORB_CONN_OUTBUF_CACHE_TIMEOUT(JDKORBSubsystemConstants.ORB_CONN_OUTBUF_CACHE_TIMEOUT),

        // attributes of the initializers element.
        ORB_INIT_SECURITY(JDKORBSubsystemConstants.ORB_INIT_SECURITY),
        ORB_INIT_TRANSACTIONS(JDKORBSubsystemConstants.ORB_INIT_TRANSACTIONS),

        // attributes of the poa element.
        POA_MONITORING(JDKORBSubsystemConstants.POA_MONITORING),
        POA_QUEUE_WAIT(JDKORBSubsystemConstants.POA_QUEUE_WAIT),
        POA_QUEUE_MIN(JDKORBSubsystemConstants.POA_QUEUE_MIN),
        POA_QUEUE_MAX(JDKORBSubsystemConstants.POA_QUEUE_MAX),

        // attributes of the request-processor element.
        POA_REQUEST_PROC_POOL_SIZE(JDKORBSubsystemConstants.POA_RP_POOL_SIZE),
        POA_REQUEST_PROC_MAX_THREADS(JDKORBSubsystemConstants.POA_RP_MAX_THREADS),

        // attributes of the naming element - the ORB service will build the relevant JacORB properties from these values.
        NAMING_EXPORT_CORBALOC(JDKORBSubsystemConstants.NAMING_EXPORT_CORBALOC),
        NAMING_ROOT_CONTEXT(JDKORBSubsystemConstants.NAMING_ROOT_CONTEXT),

        // attributes of the interop element.
        INTEROP_SUN(JDKORBSubsystemConstants.INTEROP_SUN),
        INTEROP_COMET(JDKORBSubsystemConstants.INTEROP_COMET),
        INTEROP_IONA(JDKORBSubsystemConstants.INTEROP_IONA),
        INTEROP_CHUNK_RMI_VALUETYPES(JDKORBSubsystemConstants.INTEROP_CHUNK_RMI_VALUETYPES),
        INTEROP_LAX_BOOLEAN_ENCODING(JDKORBSubsystemConstants.INTEROP_LAX_BOOLEAN_ENCODING),
        INTEROP_INDIRECTION_ENCODING_DISABLE(JDKORBSubsystemConstants.INTEROP_INDIRECTION_ENCODING_DISABLE),
        INTEROP_STRICT_CHECK_ON_TC_CREATION(JDKORBSubsystemConstants.INTEROP_STRICT_CHECK_ON_TC_CREATION),

        // attributes of the security element.
        SECURITY_SUPPORT_SSL(JDKORBSubsystemConstants.SECURITY_SUPPORT_SSL),
        SECURITY_SECURITY_DOMAIN(JDKORBSubsystemConstants.SECURITY_SECURITY_DOMAIN),
        SECURITY_ADD_COMPONENT_INTERCEPTOR(JDKORBSubsystemConstants.SECURITY_ADD_COMP_VIA_INTERCEPTOR),
        SECURITY_CLIENT_SUPPORTS(JDKORBSubsystemConstants.SECURITY_CLIENT_SUPPORTS),
        SECURITY_CLIENT_REQUIRES(JDKORBSubsystemConstants.SECURITY_CLIENT_REQUIRES),
        SECURITY_SERVER_SUPPORTS(JDKORBSubsystemConstants.SECURITY_SERVER_SUPPORTS),
        SECURITY_SERVER_REQUIRES(JDKORBSubsystemConstants.SECURITY_SERVER_REQUIRES),
        // if enabled the ORB service will configure JacORB to use the JBoss SSL socket factory classes by building the
        // appropriate properties.
        SECURITY_USE_DOMAIN_SF(JDKORBSubsystemConstants.SECURITY_USE_DOMAIN_SF),
        SECURITY_USE_DOMAIN_SSF(JDKORBSubsystemConstants.SECURITY_USE_DOMAIN_SSF),

        // attributes of the generic property element.
        PROP_KEY(JDKORBSubsystemConstants.PROPERTY_KEY),
        PROP_VALUE(JDKORBSubsystemConstants.PROPERTY_VALUE);
