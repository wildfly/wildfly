 ...
 */
public class JacORBCorbaORBService implements Service<ORB>, OrbService {
     ...
     */
    public JacORBCorbaORBService(Properties props) {
        if (props != null) {
    ...
    public String sslPort() {
        return getORBProperty(JacORBSubsystemConstants.ORB_SSL_PORT);
    }

    @Override
    public String orbAddress() {
        return getORBProperty(JacORBSubsystemConstants.ORB_ADDRESS);
    }

    @Override
    public boolean interopIONA() {
        return "on".equalsIgnoreCase(getORBProperty(JacORBSubsystemConstants.INTEROP_IONA));
    }
    ...
    public Policy createSSLPolicy(boolean sslRequired) throws PolicyError {
        ...
        return orb.create_policy(SSL_POLICY_TYPE.value, sslPolicyValue);
    }
