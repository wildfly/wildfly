...
public class ThreadsSubsystemTestCase extends AbstractSubsystemBaseTest {
    ...
    public void testTransformerAS712() throws Exception {
        testTransformer_1_0(ModelTestControllerVersion.V7_1_2_FINAL, "7.1.2.Final");
    }

    @Test
    public void testTransformerAS713() throws Exception {
        testTransformer_1_0(ModelTestControllerVersion.V7_1_2_FINAL, "7.1.3.Final");
    }
     ...
     * @throws Exception
     */
    private void testTransformer_1_0(ModelTestControllerVersion controllerVersion, String mavenVersion) throws Exception {
    ...
    public void testRejectExpressionsAS712() throws Exception {
        testRejectExpressions_1_0_0(ModelTestControllerVersion.V7_1_2_FINAL, "7.1.2.Final");
    }

    @Test
    public void testRejectExpressionsAS713() throws Exception {
        testRejectExpressions_1_0_0(ModelTestControllerVersion.V7_1_3_FINAL, "7.1.3.Final");
    }

    private void testRejectExpressions_1_0_0(ModelTestControllerVersion controllerVersion, String mavenVersion) throws Exception {
