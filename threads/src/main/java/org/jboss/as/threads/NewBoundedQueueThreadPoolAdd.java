...
import org.jboss.as.threads.NewThreadsSubsystemThreadPoolOperationUtils.BoundedOperationParameters;
 ...
 */
public class NewBoundedQueueThreadPoolAdd implements RuntimeOperationHandler, ModelAddOperationHandler {

    static final OperationHandler INSTANCE = new NewBoundedQueueThreadPoolAdd();
