 ...
 */
public class NewUnboundedQueueThreadPoolRemove implements RuntimeOperationHandler, ModelRemoveOperationHandler {

    static final OperationHandler INSTANCE = new NewUnboundedQueueThreadPoolRemove();
