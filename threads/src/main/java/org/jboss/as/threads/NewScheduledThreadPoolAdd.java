...
import org.jboss.as.threads.NewThreadsSubsystemThreadPoolOperationUtils.BaseOperationParameters;
 ...
 */
public class NewScheduledThreadPoolAdd implements RuntimeOperationHandler, ModelAddOperationHandler {

    static final OperationHandler INSTANCE = new NewScheduledThreadPoolAdd();

    @Override
    public Cancellable execute(final NewOperationContext context, final ModelNode operation, final ResultHandler resultHandler) {
        BaseOperationParameters params = NewThreadsSubsystemThreadPoolOperationUtils.parseScheduledThreadPoolOperationParameters(operation);
