...
public final class ScheduledThreadPoolElement extends AbstractExecutorElement<ScheduledThreadPoolElement> {
    ...
    public ScheduledThreadPoolElement(final String name) {
        super(name);
    }
    ...
    ScheduledThreadPoolAdd getAdd() {
        final ScheduledThreadPoolAdd add = new ScheduledThreadPoolAdd(getName(), getMaxThreads());
