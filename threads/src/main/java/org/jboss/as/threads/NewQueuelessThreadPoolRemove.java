 ...
 */
public class NewQueuelessThreadPoolRemove implements RuntimeOperationHandler, ModelRemoveOperationHandler {

    static final OperationHandler INSTANCE = new NewQueuelessThreadPoolRemove();
