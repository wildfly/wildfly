 ...
 */
public class NewBoundedQueueThreadPoolRemove implements RuntimeOperationHandler, ModelRemoveOperationHandler {

    static final OperationHandler INSTANCE = new NewBoundedQueueThreadPoolRemove();
    ...
    public Cancellable execute(final NewOperationContext context, final ModelNode operation, final ResultHandler resultHandler) {
        ...
        if (model.has(ALLOW_CORE_TIMEOUT)) {
