...
public class ConcurrentServiceNames {
    ...
    public static ServiceName getDefaultContextServiceServiceName() {
        return CONTEXT_SERVICE_BASE_SERVICE_NAME.append("DefaultContextService");
    }
    ...
    public static ServiceName getDefaultManagedThreadFactoryServiceName() {
        return MANAGED_THREAD_FACTORY_BASE_SERVICE_NAME.append("DefaultManagedThreadFactory");
    }

    public static ServiceName getDefaultManagedExecutorServiceThreadFactoryServiceName() {
        return MANAGED_THREAD_FACTORY_BASE_SERVICE_NAME.append("DefaultManagedExecutorService");
    }

    public static ServiceName getDefaultManagedScheduledExecutorServiceThreadFactoryServiceName() {
        return MANAGED_THREAD_FACTORY_BASE_SERVICE_NAME.append("DefaultManagedScheduledExecutorService");
    }
    ...
    public static ServiceName getDefaultManagedExecutorServiceServiceName() {
        return MANAGED_EXECUTOR_SERVICE_BASE_SERVICE_NAME.append("DefaultManagedExecutorService");
    }
    ...
    public static ServiceName getDefaultManagedScheduledExecutorServiceServiceName() {
        return MANAGED_SCHEDULED_EXECUTOR_SERVICE_BASE_SERVICE_NAME.append("DefaultManagedScheduledExecutorService");
    }
