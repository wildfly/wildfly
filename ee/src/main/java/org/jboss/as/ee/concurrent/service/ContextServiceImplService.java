...
import org.wildfly.ee.concurrent.ContextServiceImpl;

/**
 * @author Eduardo Martins
 */
public class ContextServiceImplService implements Service<ContextServiceImpl> {

    private final ContextConfiguration contextConfiguration;
    private ContextServiceImpl contextService;

    public ContextServiceImplService(ContextConfiguration contextConfiguration) {
        this.contextConfiguration = contextConfiguration;
    }

    public void start(final StartContext context) throws StartException {
        contextService = new ContextServiceImpl(contextConfiguration);
    }
