 ...
 */
public class DefaultManagedScheduledExecutorServiceResourceDefinition extends SimpleResourceDefinition {
    ...
    static final SimpleAttributeDefinition[] ATTRIBUTES = {HUNG_TASK_THRESHOLD_AD, LONG_RUNNING_TASKS_AD, CORE_THREADS_AD, KEEPALIVE_TIME_AD, REJECT_POLICY_AD};

    public static final DefaultManagedScheduledExecutorServiceResourceDefinition INSTANCE = new DefaultManagedScheduledExecutorServiceResourceDefinition();

    private DefaultManagedScheduledExecutorServiceResourceDefinition() {
        super(EESubsystemModel.DEFAULT_MANAGED_SCHEDULED_EXECUTOR_SERVICE_PATH, EeExtension.getResourceDescriptionResolver(EESubsystemModel.DEFAULT_MANAGED_SCHEDULED_EXECUTOR_SERVICE), DefaultManagedScheduledExecutorServiceAdd.INSTANCE, ReloadRequiredRemoveStepHandler.INSTANCE);
    }
