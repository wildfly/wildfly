...
public final class NamespaceConfigurator implements ComponentConfigurator {
    ...
    public void configure(final DeploymentPhaseContext context, final ComponentDescription description, final ComponentConfiguration configuration) throws DeploymentUnitProcessingException {
        ...
        final InterceptorFactory interceptorFactory = new ImmediateInterceptorFactory(new NamespaceContextInterceptor(selector, (description.getModuleDescription().isReadOnlyNamingContexts() ? null : context.getDeploymentUnit().getServiceName())));
