 ...
 */
public class DefaultManagedExecutorServiceResourceDefinition extends SimpleResourceDefinition {
    ...
    static final SimpleAttributeDefinition[] ATTRIBUTES = {HUNG_TASK_THRESHOLD_AD, LONG_RUNNING_TASKS_AD, CORE_THREADS_AD, MAX_THREADS_AD, KEEPALIVE_TIME_AD, QUEUE_LENGTH_AD, REJECT_POLICY_AD};


    public static final DefaultManagedExecutorServiceResourceDefinition INSTANCE = new DefaultManagedExecutorServiceResourceDefinition();

    private DefaultManagedExecutorServiceResourceDefinition() {
        super(EESubsystemModel.DEFAULT_MANAGED_EXECUTOR_SERVICE_PATH, EeExtension.getResourceDescriptionResolver(EESubsystemModel.DEFAULT_MANAGED_EXECUTOR_SERVICE), DefaultManagedExecutorServiceAdd.INSTANCE, ReloadRequiredRemoveStepHandler.INSTANCE);
    }
