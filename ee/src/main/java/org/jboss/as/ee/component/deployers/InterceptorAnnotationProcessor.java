...
public class InterceptorAnnotationProcessor implements DeploymentUnitProcessor {
    ...
    public void deploy(final DeploymentPhaseContext phaseContext) throws DeploymentUnitProcessingException {
        ...
        for (final ComponentDescription description : componentConfigurations) {
            processComponentConfig(deploymentUnit, applicationClasses, module, deploymentReflectionIndex, description);
        }
    }


    private void handleAnnotations(final DeploymentUnit deploymentUnit, final EEApplicationClasses applicationClasses, final DeploymentReflectionIndex deploymentReflectionIndex, final Class<?> componentClass, final ComponentDescription description) {
    ...
    private void processComponentConfig(final DeploymentUnit deploymentUnit, final EEApplicationClasses applicationClasses, final Module module, final DeploymentReflectionIndex deploymentReflectionIndex, final ComponentDescription description) throws DeploymentUnitProcessingException {

        final Class<?> componentClass;
        try {
            componentClass = module.getClassLoader().loadClass(description.getComponentClassName());
        } catch (ClassNotFoundException e) {
            throw EeMessages.MESSAGES.couldNotLoadComponentClass(e, description.getComponentClassName());
        }
