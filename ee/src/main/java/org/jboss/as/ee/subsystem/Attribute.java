...
enum Attribute {
    ...
    // from ee concurrent
    JNDI_NAME(CommonAttributes.JNDI_NAME),
    USE_TRANSACTION_SETUP_PROVIDER(ContextServiceResourceDefinition.USE_TRANSACTION_SETUP_PROVIDER),
    CONTEXT_SERVICE(CommonAttributes.CONTEXT_SERVICE),
    PRIORITY(CommonAttributes.PRIORITY),
    THREAD_FACTORY(CommonAttributes.THREAD_FACTORY),
    HUNG_TASK_THRESHOLD(CommonAttributes.HUNG_TASK_THRESHOLD),
    LONG_RUNNING_TASKS(CommonAttributes.LONG_RUNNING_TASKS),
    ...
    REJECT_POLICY(CommonAttributes.REJECT_POLICY),
