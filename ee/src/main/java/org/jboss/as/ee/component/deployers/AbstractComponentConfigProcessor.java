...
public abstract class AbstractComponentConfigProcessor implements DeploymentUnitProcessor {
     ...
     */
    protected abstract void processComponentConfig(DeploymentUnit deploymentUnit, DeploymentPhaseContext phaseContext, CompositeIndex index, ComponentDescription componentDescription) throws DeploymentUnitProcessingException;
