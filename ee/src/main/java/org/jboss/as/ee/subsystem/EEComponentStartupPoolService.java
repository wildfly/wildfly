 ...
 */
public class EEComponentStartupPoolService implements Service<ExecutorService>{

    public static final ServiceName SERVICE_NAME = ServiceName.JBOSS.append("ee", "componentLifecycleThreadPool");

    private volatile ExecutorService executor;

     public static ServiceController<?> addService(final ServiceTarget target, final ServiceListener<Object>... listeners) {
        final EEComponentStartupPoolService service = new EEComponentStartupPoolService();
