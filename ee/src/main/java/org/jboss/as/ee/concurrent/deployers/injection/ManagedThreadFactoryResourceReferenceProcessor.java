...
public class ManagedThreadFactoryResourceReferenceProcessor implements EEResourceReferenceProcessor {
    ...
    private static final LookupInjectionSource injectionSource = new LookupInjectionSource("java:comp/" + EEConcurrentDefaultBindingProcessor.DEFAULT_MANAGED_THREAD_FACTORY_JNDI_NAME);
