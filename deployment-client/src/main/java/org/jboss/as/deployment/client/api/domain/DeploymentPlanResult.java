...
public interface DeploymentPlanResult {
    ...
    /**
     * Gets the result of a {@link DeploymentAction.Type#ADD add content action}.
     *
     * @param deploymentAction the id of the action
     *
     * @return the result
     */
    Future<DeploymentActionResult> getDeploymentAddResult(UUID deploymentAction);

    /**
     * Gets the result of a {@link DeploymentAction.Type#REMOVE remove content action}.
     *
     * @param deploymentAction the id of the action
     *
     * @return the result
     */
    Future<DeploymentActionResult> getDeploymentRemoveResult(UUID deploymentAction);
