...
class ClientTransportDefinition extends PersistentResourceDefinition {
    ...
    static final AttributeDefinition REQUIRES_SSL =
            new SimpleAttributeDefinitionBuilder(Constants.CLIENT_TRANSPORT_REQUIRES_SSL, ModelType.BOOLEAN, true)
    ...
    private ClientTransportDefinition() {
        super(IIOPExtension.PATH_CLIENT_TRANSPORT, IIOPExtension
                .getResourceDescriptionResolver(Constants.CLIENT_TRANSPORT), new AbstractAddStepHandler(
