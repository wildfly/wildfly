...
package org.jboss.as.iiop.openjdk.naming.jndi;
...
public class CNCtx implements javax.naming.Context {
    ...
    static final org.jboss.as.iiop.openjdk.naming.jndi.CNNameParser parser = new org.jboss.as.iiop.openjdk.naming.jndi.CNNameParser();
    ...
    public String getNameInNamespace() throws NamingException {
        ...
        return org.jboss.as.iiop.openjdk.naming.jndi.CNNameParser.cosNameToInsString(_name);
    }
        ...
        if (provUrl != null && !isCorbaUrl(provUrl)) {
            ...
            if (insName.length() > 0) {
                ...
                try {
                    ...
                    throw org.jboss.as.iiop.openjdk.naming.jndi.ExceptionMapper.mapException(e, this, _name);
                }
            }
        } else {
            ...
            if (inOrb == null) {
                ...
                // No ORB instance specified; create one using env and defaults
                inOrb = CorbaORBService.getCurrent();
                IIOPLogger.ROOT_LOGGER.debugGetDefaultORB(inOrb);
            }
    ...
    private String initUsingCorbanameUrl(ORB orb, String url, Hashtable env)
            throws NamingException {
        try {
            org.jboss.as.iiop.openjdk.naming.jndi.CorbanameUrl parsedUrl = new org.jboss.as.iiop.openjdk.naming.jndi.CorbanameUrl(url);
    ...
    java.lang.Object callResolve(NameComponent[] path)
        ...
        try {
            ...
            throw org.jboss.as.iiop.openjdk.naming.jndi.ExceptionMapper.mapException(e, this, path);
        }
    }
    ...
    private void callBindOrRebind(NameComponent[] pth, Name name,
        ...
        try {
            ...
            throw org.jboss.as.iiop.openjdk.naming.jndi.ExceptionMapper.mapException(e, this, pth);
        }
    }
    ...
    public NamingEnumeration listBindings(Name name)
        ...
        if (name.size() > 0) {
            try {
                ...
                if (obj instanceof CNCtx) {
                    return new org.jboss.as.iiop.openjdk.naming.jndi.CNBindingEnumeration(
                            (CNCtx) obj, true, _env);
                } else {
        ...
        return new org.jboss.as.iiop.openjdk.naming.jndi.CNBindingEnumeration(this, false, _env);
    }
    ...
    private void callDestroy(NamingContext nc)
        ...
        try {
            ...
            throw org.jboss.as.iiop.openjdk.naming.jndi.ExceptionMapper.mapException(e, this, null);
        }
    }
