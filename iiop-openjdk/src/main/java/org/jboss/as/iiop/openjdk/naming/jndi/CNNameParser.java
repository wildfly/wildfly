        ...
        for (int i = 0; i < len; ) {
            ...
            while (i < len) {
                if (str.charAt(i) == compSeparator) {
                    ...
                    if (i + 1 >= len) {
                        throw IIOPMessages.MESSAGES.unescapedCharacter(str);
                        ...
                        throw IIOPMessages.MESSAGES.invalidEscapedCharacter(str);
                    }
