...
import org.jboss.as.iiop.openjdk.rmi.ir.IRConstructionException;
...
/**
 * The iiop subsystem is using message IDs in the range 16300-16499. This file is using the subset 16400-16499 for
 * exception messages.
...
public interface IIOPMessages {
    ...
    @Message(id = 16494, value = "Cannot use the value 'client' for 'security'. Instead set 'security' to be 'off' and set both the " +
                "'org.omg.PortableInterceptor.ORBInitializerClass.org.jboss.as.iiop.openjdk.csiv2.CSIv2Initializer' " +
                "and 'org.omg.PortableInterceptor.ORBInitializerClass.org.jboss.as.iiop.openjdk.csiv2.SASClientInitializer' properties to be \"\"")
