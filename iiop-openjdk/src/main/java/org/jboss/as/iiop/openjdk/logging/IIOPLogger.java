...
package org.jboss.as.iiop.openjdk.logging;
...
/**
 * The iiop subsystem is using message IDs in the range 16300-16499. This file is using the subset 16300-16399 for
 * logger messages.
...
public interface IIOPLogger extends BasicLogger {
    ...
    @Message(id = 16300, value = "Activating IIOP Subsystem")
