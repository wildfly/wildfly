...
public class IORSASContextDefinition extends PersistentResourceDefinition {
    ...
    static final AttributeDefinition CALLER_PROPAGATION =
            new SimpleAttributeDefinitionBuilder(Constants.IOR_SAS_CONTEXT_CALLER_PROPAGATION, ModelType.STRING, true)
    ...
    private IORSASContextDefinition() {
        super(IIOPExtension.PATH_IOR_SAS, IIOPExtension.getResourceDescriptionResolver(
                Constants.IOR_SETTINGS, Constants.IOR_SAS_CONTEXT), new AbstractAddStepHandler(
