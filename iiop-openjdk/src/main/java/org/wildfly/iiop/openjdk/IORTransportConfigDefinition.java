...
class IORTransportConfigDefinition extends PersistentResourceDefinition {
    ...
    static final AttributeDefinition INTEGRITY =
            new SimpleAttributeDefinitionBuilder(Constants.IOR_TRANSPORT_INTEGRITY, ModelType.STRING, true)
    ...
    static final AttributeDefinition CONFIDENTIALITY =
            new SimpleAttributeDefinitionBuilder(Constants.IOR_TRANSPORT_CONFIDENTIALITY, ModelType.STRING, true)
                    .setFlags(AttributeAccess.Flag.RESTART_ALL_SERVICES)
                    .setDefaultValue(DEFAULT_VALUE)
                    .setValidator(VALIDATOR)
                    .setAllowExpression(true)
    ...
    static final AttributeDefinition TRUST_IN_TARGET =
            new SimpleAttributeDefinitionBuilder(Constants.IOR_TRANSPORT_TRUST_IN_TARGET, ModelType.STRING, true)
                    .setFlags(AttributeAccess.Flag.RESTART_ALL_SERVICES)
                    .setDefaultValue(DEFAULT_VALUE)
    ...
    static final AttributeDefinition TRUST_IN_CLIENT =
            new SimpleAttributeDefinitionBuilder(Constants.IOR_TRANSPORT_TRUST_IN_CLIENT, ModelType.STRING, true)
                    .setFlags(AttributeAccess.Flag.RESTART_ALL_SERVICES)
                    .setDefaultValue(DEFAULT_VALUE)
                    .setValidator(VALIDATOR)
                    .setAllowExpression(true)
    ...
    static final AttributeDefinition DETECT_REPLAY =
            new SimpleAttributeDefinitionBuilder(Constants.IOR_TRANSPORT_DETECT_REPLAY, ModelType.STRING, true)
                    .setFlags(AttributeAccess.Flag.RESTART_ALL_SERVICES)
                    .setDefaultValue(DEFAULT_VALUE)
                    .setValidator(VALIDATOR)
                    .setAllowExpression(true)
    ...
    static final AttributeDefinition DETECT_MISORDERING =
            new SimpleAttributeDefinitionBuilder(Constants.IOR_TRANSPORT_DETECT_MISORDERING, ModelType.STRING, true)
                    .setFlags(AttributeAccess.Flag.RESTART_ALL_SERVICES)
                    .setDefaultValue(DEFAULT_VALUE)
                    .setValidator(VALIDATOR)
                    .setAllowExpression(true)
    ...
    private IORTransportConfigDefinition() {
        super(IIOPExtension.PATH_IOR_TRANSPORT, IIOPExtension.getResourceDescriptionResolver(
                Constants.IOR_SETTINGS, Constants.IOR_TRANSPORT_CONFIG),
                new AbstractAddStepHandler(ATTRIBUTES), ReloadRequiredRemoveStepHandler.INSTANCE);
    }

    @Override
    public List<AccessConstraintDefinition> getAccessConstraints() {
        return Collections.singletonList((AccessConstraintDefinition) AttributeConstants.IIOP_SECURITY_DEF);
    }
