...
public class ConfigValidator {
    ...
    public static List<String> validateConfig(final OperationContext context, final ModelNode resourceModel) throws OperationFailedException {
        ...
        final boolean severSSLConfigured = IIOPRootDefinition.SERVER_SSL_CONTEXT.resolveModelAttribute(context, resourceModel).isDefined() || securityDomainConfigured;
        ...
        validateSSLConfig(supportSSL, severSSLConfigured, clientSSLConfigured, serverRequiresSSL, clientRequiresSSL);
        validateSSLSocketBinding(context, resourceModel, severSSLConfigured, clientSSLConfigured, warnings);
