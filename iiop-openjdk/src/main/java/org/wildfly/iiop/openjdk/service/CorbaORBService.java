...
public class CorbaORBService implements Service<ORB> {
    ...
    private final Consumer<CorbaORBService> serviceConsumer;
     ...
     */
    public CorbaORBService(Properties props, final Consumer<CorbaORBService> serviceConsumer, final Supplier<ExecutorService> executorServiceSupplier, final Supplier<SocketBinding> iiopSocketBindingSupplier, final Supplier<SocketBinding> iiopSSLSocketBindingSupplier) {
        if (props != null) {
