 ...
 */
public class UndertowSubsystemParser_6_0 extends PersistentResourceXMLParser {
    private final PersistentResourceXMLDescription xmlDescription;

    UndertowSubsystemParser_6_0() {
        xmlDescription = builder(UndertowRootDefinition.PATH_ELEMENT, Namespace.UNDERTOW_6_0.getUriString())
                .addAttributes(
