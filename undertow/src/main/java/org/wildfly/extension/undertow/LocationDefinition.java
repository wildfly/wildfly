...
class LocationDefinition extends PersistentResourceDefinition {
    static final RuntimeCapability<Void> LOCATION_CAPABILITY = RuntimeCapability.Builder.of(UndertowService.CAPABILITY_NAME_LOCATION, true, LocationService.class)
    ...
    static final AttributeDefinition HANDLER = new SimpleAttributeDefinitionBuilder(Constants.HANDLER, ModelType.STRING)
            ...
            .setCapabilityReference(UndertowService.CAPABILITY_NAME_HANDLER)
