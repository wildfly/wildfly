...
public class AjpListenerResourceDefinition extends ListenerResourceDefinition {
    ...
    AjpListenerResourceDefinition() {
        super(new SimpleResourceDefinition.Parameters(REGISTRATION, UndertowRootDefinition.RESOLVER).setDeprecationData(new DeprecationData(UndertowSubsystemModel.VERSION_15_0_0.getVersion(), true)), new AjpListenerAdd(), Map.of());
    }
