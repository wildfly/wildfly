...
public class UndertowExtension implements Extension {
    ...
    private static final ModelVersion CURRENT_MODEL_VERSION = ModelVersion.create(11, 1, 0);
    ...
    public void initializeParsers(ExtensionParsingContext context) {
        ...
        context.setSubsystemXmlMapping(SUBSYSTEM_NAME, Namespace.UNDERTOW_12_1.getUriString(), UndertowSubsystemParser_12_1::new);
    }
    ...
    public void initialize(ExtensionContext context) {
        ...
        subsystem.registerXMLElementWriter(UndertowSubsystemParser_12_1::new);
    }
