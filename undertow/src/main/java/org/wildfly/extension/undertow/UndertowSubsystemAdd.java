...
class UndertowSubsystemAdd extends AbstractBoottimeAddStepHandler {
    ...
    protected void performBoottime(OperationContext context, ModelNode operation, Resource resource) throws OperationFailedException {
        ...
        context.getServiceTarget().addCapability(UndertowRootDefinition.UNDERTOW_CAPABILITY, new UndertowService(defaultContainer, defaultServer, defaultVirtualHost, instanceId, stats))
                .setInitialMode(ServiceController.Mode.ACTIVE)
                //.addAliases(UndertowService.UNDERTOW)//todo remove once we have everything migrated
                .install();
