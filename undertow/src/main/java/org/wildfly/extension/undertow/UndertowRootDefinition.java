...
import static org.wildfly.extension.undertow.UndertowService.CAPABILITY_NAME_HTTP_INVOKER;
...
class UndertowRootDefinition extends PersistentResourceDefinition {
    ...
    static final RuntimeCapability<Void> UNDERTOW_CAPABILITY = RuntimeCapability.Builder.of(UndertowService.CAPABILITY_NAME_UNDERTOW, false, UndertowService.class)
                        .build();

    static final RuntimeCapability<Void> HTTP_INVOKER_RUNTIME_CAPABILITY =
            RuntimeCapability.Builder.of(CAPABILITY_NAME_HTTP_INVOKER, false, PathHandler.class)
                    .build();
    ...
    protected static final SimpleAttributeDefinition DEFAULT_SERVLET_CONTAINER =
            new SimpleAttributeDefinitionBuilder(Constants.DEFAULT_SERVLET_CONTAINER, ModelType.STRING, true)
                    ...
                    .setCapabilityReference(UNDERTOW_CAPABILITY, UndertowService.CAPABILITY_NAME_SERVLET_CONTAINER)
                    .build();
    protected static final SimpleAttributeDefinition DEFAULT_SERVER =
            new SimpleAttributeDefinitionBuilder(Constants.DEFAULT_SERVER, ModelType.STRING, true)
                    ...
                    .setCapabilityReference(UNDERTOW_CAPABILITY, UndertowService.CAPABILITY_NAME_SERVER)
                    .build();
    ...
    protected static final SimpleAttributeDefinition DEFAULT_VIRTUAL_HOST =
                new SimpleAttributeDefinitionBuilder(Constants.DEFAULT_VIRTUAL_HOST, ModelType.STRING, true)
                        ...
                        .setCapabilityReference(UNDERTOW_CAPABILITY, UndertowService.CAPABILITY_NAME_HOST, DEFAULT_SERVER)
                        .build();
