 ...
 */
public class UndertowSubsystemParser_7_0 extends PersistentResourceXMLParser {
    private final PersistentResourceXMLDescription xmlDescription;

    UndertowSubsystemParser_7_0() {
        xmlDescription = builder(UndertowRootDefinition.PATH_ELEMENT, Namespace.UNDERTOW_7_0.getUriString())
                .addAttributes(
