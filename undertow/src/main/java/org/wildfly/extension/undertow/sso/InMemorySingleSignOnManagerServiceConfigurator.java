...
/**
 * Configures a service providing a non-distributable {@link SingleSignOnManager}.
 * @author Paul Ferraro
 */
public class InMemorySingleSignOnManagerServiceConfigurator extends SimpleCapabilityServiceConfigurator<SingleSignOnManager> {
    ...
    public InMemorySingleSignOnManagerServiceConfigurator(ServiceName name) {
        super(name, new InMemorySingleSignOnManager());
    }
}
