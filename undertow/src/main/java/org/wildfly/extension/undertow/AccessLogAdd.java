...
final class AccessLogAdd extends AbstractAddStepHandler {
    ...
    protected void performRuntime(OperationContext context, ModelNode operation, ModelNode model) throws OperationFailedException {
        ...
        if (useServerLog) {
            ...
            service = new AccessLogService(sConsumer, hSupplier, wSupplier, pmSupplier, pattern, directory, relativeTo, filePrefix, fileSuffix, rotate, extended, predicate,closeRetryCount,closeRetryDelay);
        }
