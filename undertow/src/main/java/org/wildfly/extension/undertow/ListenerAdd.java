...
abstract class ListenerAdd extends AbstractAddStepHandler {
    ...
    protected void performRuntime(OperationContext context, ModelNode operation, ModelNode model) throws OperationFailedException {
        ...
        serviceBuilder.addCapabilityRequirement(REF_IO_WORKER, XnioWorker.class, service.getWorker(), workerName)
                ...
                .addCapabilityRequirement(REF_BUFFER_POOL, Pool.class, (Injector) service.getBufferPool(), bufferPoolName)
    ...
    abstract ListenerService createService(String name, String serverName, OperationContext context, ModelNode model, OptionMap listenerOptions, OptionMap socketOptions) throws OperationFailedException;
