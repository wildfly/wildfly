 ...
 */
    ...
    VERSION_15_0_PREVIEW(15, 0, Stability.PREVIEW),   // WildFly 37-present
    VERSION_15_0(15),   // WildFly 37-present
    ;

    static final Map<Stability, UndertowSubsystemSchema> CURRENT = Feature.map(EnumSet.of(VERSION_15_0, VERSION_15_0_PREVIEW, VERSION_14_0_COMMUNITY, VERSION_14_0_PREVIEW));
