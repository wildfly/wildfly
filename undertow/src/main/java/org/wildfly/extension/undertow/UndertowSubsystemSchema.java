 ...
 */
    ...
    VERSION_14_0_COMMUNITY(14, 0, Stability.COMMUNITY),  // WildFly 36 - 37
    //VERSION_15_0(15, 0),   // WildFly 37 - present
    VERSION_15_0_COMMUNITY(15, 0, Stability.COMMUNITY)   // WildFly 37 - present
    ;

    static final Map<Stability, UndertowSubsystemSchema> CURRENT = Feature.map(EnumSet.of(VERSION_14_0, VERSION_14_0_PREVIEW, VERSION_14_0_COMMUNITY, VERSION_15_0_COMMUNITY));
