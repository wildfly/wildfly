 ...
 * @author baranowb
 */
public class UndertowSubsystemParser_12_1 extends PersistentResourceXMLParser {
    private final PersistentResourceXMLDescription xmlDescription;

    UndertowSubsystemParser_12_1() {
        xmlDescription = builder(UndertowRootDefinition.INSTANCE.getPathElement(), Namespace.UNDERTOW_12_1.getUriString())
                .addAttributes(
                                        ...
                                        builder(HostDefinition.INSTANCE.getPathElement())
                                                ...
                                                builder(AccessLogDefinition.INSTANCE.getPathElement())
                                                        .addAttributes(
                                                                ...
                                                                AccessLogDefinition.CLOSE_RETRY_COUNT,
                                                                AccessLogDefinition.CLOSE_RETRY_DELAY)
                                        ).addChild(
