...
class ServletContainerDefinition extends PersistentResourceDefinition {
    static final RuntimeCapability<Void> SERVLET_CONTAINER_CAPABILITY = RuntimeCapability.Builder.of(UndertowService.CAPABILITY_NAME_SERVLET_CONTAINER, true, ServletContainerService.class)
