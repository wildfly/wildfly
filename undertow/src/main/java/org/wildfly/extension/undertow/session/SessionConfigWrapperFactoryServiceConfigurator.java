...
public class SessionConfigWrapperFactoryServiceConfigurator extends SimpleServiceNameProvider implements CapabilityServiceConfigurator, Function<CookieConfig, SessionConfigWrapper> {
    ...
    private final SupplierDependency<SessionAffinityProvider> locatorDependency;

    public SessionConfigWrapperFactoryServiceConfigurator(ServiceName name, SupplierDependency<SessionIdentifierCodec> codecDependency, SupplierDependency<SessionAffinityProvider> locatorDependency) {
        super(name);
