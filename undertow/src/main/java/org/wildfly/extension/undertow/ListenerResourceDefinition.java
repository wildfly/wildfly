...
abstract class ListenerResourceDefinition extends PersistentResourceDefinition {
    ...
    static final OptionAttributeDefinition READ_TIMEOUT = OptionAttributeDefinition.builder("read-timeout", Options.READ_TIMEOUT).setDefaultValue(new ModelNode(60000)).setAllowExpression(true).setMeasurementUnit(MeasurementUnit.MILLISECONDS).build();
    static final OptionAttributeDefinition WRITE_TIMEOUT = OptionAttributeDefinition.builder("write-timeout", Options.WRITE_TIMEOUT).setDefaultValue(new ModelNode(60000)).setAllowExpression(true).setMeasurementUnit(MeasurementUnit.MILLISECONDS).build();
