...
abstract class ListenerResourceDefinition extends PersistentResourceDefinition {
    ...
    static final OptionAttributeDefinition WEB_SOCKET_READ_TIMEOUT = OptionAttributeDefinition.builder(Constants.WEB_SOCKET_READ_TIMEOUT, Options.READ_TIMEOUT).setAllowExpression(true).setMeasurementUnit(MeasurementUnit.MILLISECONDS).setRequired(false).setStability(Stability.PREVIEW).build();
    static final OptionAttributeDefinition WEB_SOCKET_WRITE_TIMEOUT = OptionAttributeDefinition.builder(Constants.WEB_SOCKET_WRITE_TIMEOUT, Options.WRITE_TIMEOUT).setAllowExpression(true).setMeasurementUnit(MeasurementUnit.MILLISECONDS).setRequired(false).setStability(Stability.PREVIEW).build();
