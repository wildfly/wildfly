...
public class SharedSessionConfigXMLReaderTestCase {
    ...
    public void test() throws IOException, XMLStreamException {
        ...
        mapper.registerRootElement(this.schema.getName(), new SharedSessionConfigXMLReader(this.schema, PropertyReplacers.noop()));
        try (InputStream input = url.openStream()) {
            ...
            mapper.unregisterRootAttribute(this.schema.getName());
        }
    }
}
