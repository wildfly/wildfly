...
public class JndiNamingDependencyProcessor implements DeploymentUnitProcessor {
    ...
    public void deploy(final DeploymentPhaseContext phaseContext) throws DeploymentUnitProcessingException {
        ...
        final RuntimeBindReleaseService service = new RuntimeBindReleaseService(deploymentUnit.getAttachmentList(org.jboss.as.naming.deployment.Attachments.SHARED_BINDER_SERVICES_ACQUIRED));
