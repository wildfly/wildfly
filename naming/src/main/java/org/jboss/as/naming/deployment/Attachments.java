...
public final class Attachments {
    ...
    /**
     * the DU key that holds the shared binder services the deployment depends
     */
    public static final AttachmentKey<AttachmentList<SharedBinderService>> SHARED_BINDER_SERVICES = AttachmentKey.createList(SharedBinderService.class);
}
