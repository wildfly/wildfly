 ...
 */
public class J2EEManagementExtension  implements Extension {

    public static final String NAMESPACE = "urn:jboss:domain:j2eemanagement:1.0";
    public static final String SUBSYSTEM_NAME = "j2eemanagement";
    private static final J2EEManagementSubsystemParser parser = new J2EEManagementSubsystemParser();
    private static final String RESOURCE_NAME = J2EEManagementExtension.class.getPackage().getName() + ".LocalDescriptions";

    static ResourceDescriptionResolver getResourceDescriptionResolver(final String keyPrefix) {
        return new StandardResourceDescriptionResolver(keyPrefix, RESOURCE_NAME, J2EEManagementExtension.class.getClassLoader(), true, true);
    }
    ...
    public void initialize(ExtensionContext context) {
        ...
        final ManagementResourceRegistration rootResource = subsystem.registerSubsystemModel(J2EEManagementRootResource.INSTANCE);
    ...
    static class J2EEManagementSubsystemParser implements XMLStreamConstants, XMLElementReader<List<ModelNode>>, XMLElementWriter<SubsystemMarshallingContext> {
        ...
        public void writeContent(XMLExtendedStreamWriter writer, SubsystemMarshallingContext context) throws XMLStreamException {
            ...
            context.startSubsystemElement(J2EEManagementExtension.NAMESPACE, false);
