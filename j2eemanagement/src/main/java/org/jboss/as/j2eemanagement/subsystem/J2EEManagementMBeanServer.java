...
import org.jboss.as.j2eemanagement.managedobject.ManagedObjectHandlerRegistry;
 ...
 */
class J2EEManagementMBeanServer implements MBeanServerPlugin {

    final ModelController controller;

    public J2EEManagementMBeanServer(ModelController controller) {
