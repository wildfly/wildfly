...
class RegisterMBeanServerDelegateService implements Service<Void>{
    ...
    static final ServiceName SERVICE_NAME = ServiceName.JBOSS.append(ServiceName.of("j2eemanagement", "mbeanwrapper"));
    ...
    volatile J2EEManagementMBeanServer server;
    ...
    public void start(StartContext context) throws StartException {
        server = new J2EEManagementMBeanServer(injectedController.getValue());
