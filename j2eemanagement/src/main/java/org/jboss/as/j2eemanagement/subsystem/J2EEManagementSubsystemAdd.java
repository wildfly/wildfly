...
import static org.jboss.as.j2eemanagement.subsystem.Constants.APP_NAME;
import static org.jboss.as.j2eemanagement.subsystem.Constants.DISTINCT_NAME;
import static org.jboss.as.j2eemanagement.subsystem.Constants.EJB_NAME;
import static org.jboss.as.j2eemanagement.subsystem.Constants.JNDI_NAME;
import static org.jboss.as.j2eemanagement.subsystem.Constants.MODULE_NAME;
 ...
 */
class J2EEManagementSubsystemAdd extends AbstractAddStepHandler {

    static J2EEManagementSubsystemAdd INSTANCE = new J2EEManagementSubsystemAdd();


    private J2EEManagementSubsystemAdd() {
    }
    ...
    protected void performRuntime(OperationContext context, ModelNode operation, ModelNode model,
        ...
        context.addStep(new OperationStepHandler() {
            ...
            public void execute(OperationContext context, ModelNode operation) throws OperationFailedException {
                ...
                context.getServiceTarget().addService(TempMBeanService.SERVICE_NAME, tempService)
                    .addDependency(MBeanServerService.SERVICE_NAME, MBeanServer.class, tempService.mbeanServerValue)
                    .addDependency(EjbClientContextService.DEFAULT_SERVICE_NAME, EJBClientContext.class, tempService.ejbClientContextValue)
                    .setInitialMode(Mode.ACTIVE)
                    .install();
