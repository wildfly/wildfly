...
import org.jboss.as.j2eemanagement.ejb.ManagementEjbDeploymentInformation;
import org.jboss.as.j2eemanagement.ejb.ManagementHomeEjbComponentView;
import org.jboss.as.j2eemanagement.ejb.ManagementRemoteEjbComponentView;
...
public class RegisterManagementEJBService implements Service<Void>{
    ...
    static final ServiceName SERVICE_NAME = ServiceName.JBOSS.append(ServiceName.of("j2eemanagement", "ejb"));
