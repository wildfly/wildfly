...
/**
 * Test case to test the handling of LDAP related security realm configuration/
 *
 *  @author <a href="mailto:darran.lofthouse@jboss.com">Darran Lofthouse</a>
 */
public class StandaloneLdapTestCase extends AbstractCoreModelTest {

    @Test
    public void testConfiguration() throws Exception {
        KernelServices kernelServices = createKernelServicesBuilder(TestModelType.STANDALONE)
                .setXmlResource("ldap-standalone.xml")
                .validateDescription()
                .build();
