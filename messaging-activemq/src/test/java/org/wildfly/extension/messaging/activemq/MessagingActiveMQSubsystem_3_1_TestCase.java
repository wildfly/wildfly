 ...
 */
public class MessagingActiveMQSubsystem_3_1_TestCase extends AbstractSubsystemBaseTest {

    public MessagingActiveMQSubsystem_3_1_TestCase() {
        super(MessagingExtension.SUBSYSTEM_NAME, new MessagingExtension());
    }

    @Override
    protected String getSubsystemXml() throws IOException {
        return readResource("subsystem_3_1.xml");
    }

    @Override
    protected String getSubsystemXsdPath() throws IOException {
        return "schema/wildfly-messaging-activemq_3_1.xsd";
    }
    ...
    public void testHAPolicyConfiguration() throws Exception {
        standardSubsystemTest("subsystem_3_1_ha-policy.xml");
    }
    ...
    private void testTransformers(ModelTestControllerVersion controllerVersion, ModelVersion messagingVersion) throws Exception {
        ...
        KernelServicesBuilder builder = createKernelServicesBuilder(createAdditionalInitialization())
                .setSubsystemXmlResource("subsystem_3_1_transform.xml");
    ...
    private void testRejectingTransformers(ModelTestControllerVersion controllerVersion, ModelVersion messagingVersion) throws Exception {
        ...
        List<ModelNode> ops = builder.parseXmlResource("subsystem_3_1_reject_transform.xml");
