...
public class MessagingTransformerRegistration implements ExtensionTransformerRegistration {
    ...
    public void registerTransformers(SubsystemTransformerRegistration registration) {
        ...
        registerTransformers_WildFly_13_0_0(builder.createBuilder(MessagingExtension.VERSION_3_1_0, MessagingExtension.VERSION_3_0_0));
    ...
    private static void registerTransformers_WildFly_13_0_0(ResourceTransformationDescriptionBuilder subsystem) {
