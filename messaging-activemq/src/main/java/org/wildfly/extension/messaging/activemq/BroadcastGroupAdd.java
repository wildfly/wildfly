...
public class BroadcastGroupAdd extends AbstractAddStepHandler {
    ...
    protected void recordCapabilitiesAndRequirements(OperationContext context, ModelNode operation, Resource resource) throws OperationFailedException {
        ...
        context.registerCapability(BroadcastGroupDefinition.COMMAND_DISPATCHER_FACTORY_CAPABILITY.fromBaseCapability(address));
        ...
        if (CommonAttributes.JGROUPS_CHANNEL.resolveModelAttribute(context, model).isDefined() && !BroadcastGroupDefinition.JGROUPS_STACK.resolveModelAttribute(context, model).isDefined()) {
            context.registerAdditionalCapabilityRequirement(ClusteringDefaultRequirement.COMMAND_DISPATCHER_FACTORY.getName(), BroadcastGroupDefinition.COMMAND_DISPATCHER_FACTORY_CAPABILITY.getDynamicName(address), BroadcastGroupDefinition.JGROUPS_STACK.getName());
        }
    }
