 ...
 */
public class ExternalMSQueueAdd extends AbstractAddStepHandler {

    public static final ExternalMSQueueAdd INSTANCE = new ExternalMSQueueAdd();

    private ExternalMSQueueAdd() {
