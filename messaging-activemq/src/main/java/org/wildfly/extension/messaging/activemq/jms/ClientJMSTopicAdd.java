 ...
 */
public class ClientJMSTopicAdd extends AbstractAddStepHandler {

    public static final ClientJMSTopicAdd INSTANCE = new ClientJMSTopicAdd();

    private ClientJMSTopicAdd() {
        super(ClientJMSTopicDefinition.ATTRIBUTES);
    }
    ...
    protected void performRuntime(OperationContext context, ModelNode operation, ModelNode model) throws OperationFailedException {
        ...
        ClientJMSTopicService jmsTopicService = ClientJMSTopicService.installService(name, jmsTopicServiceName, serviceTarget);
