...
public class MessagingExtension implements Extension {
    ...
    protected static final ModelVersion VERSION_16_1_0 = ModelVersion.create(16, 1, 0);
    ...
    private static final ModelVersion CURRENT_MODEL_VERSION = VERSION_16_1_0;

    private static final MessagingSubsystemParser_16_0 CURRENT_PARSER = new MessagingSubsystemParser_16_1();
    ...
    public void initializeParsers(ExtensionParsingContext context) {
        ...
        context.setSubsystemXmlMapping(SUBSYSTEM_NAME, MessagingSubsystemParser_16_1.NAMESPACE, CURRENT_PARSER);
    }
}
