...
public interface ConnectionFactoryAttributes {
     ...
     */
        ...
        StringListAttributeDefinition DESERIALIZATION_ALLOWLIST = new StringListAttributeDefinition.Builder("deserialization-white-list")
                .setRequired(false)
                .setAllowExpression(true)
        ...
        StringListAttributeDefinition DESERIALIZATION_BLOCKLIST = new StringListAttributeDefinition.Builder("deserialization-black-list")
                .setRequired(false)
                .setAllowExpression(true)
                .setListValidator(Validators.noDuplicateElements(new StringLengthValidator(1, true, true)))
                .setAttributeParser(AttributeParser.STRING_LIST)
