...
public class MessagingTransformerRegistration implements ExtensionTransformerRegistration {
    ...
    public void registerTransformers(SubsystemTransformerRegistration registration) {
        ...
        registerTransformers_WF_36(builder.createBuilder(MessagingExtension.VERSION_16_1_0, MessagingExtension.VERSION_16_0_0));
        ...
        builder.buildAndRegister(registration, new ModelVersion[]{MessagingExtension.VERSION_13_0_0, MessagingExtension.VERSION_13_1_0,
            MessagingExtension.VERSION_14_0_0, MessagingExtension.VERSION_15_0_0, MessagingExtension.VERSION_16_0_0, MessagingExtension.VERSION_16_1_0});
    }
                ...
                .setValueConverter(new AttributeConverter() {
                    ...
                    public void convertOperationParameter(PathAddress pa, String s, ModelNode attributeValue, ModelNode operation, TransformationContext tc) {
                        if (!attributeValue.isDefined()) {
                            ...
                            attributeValue.set(multiplier * baseValue);
                        }
                    }

                    @Override
                    public void convertResourceAttribute(PathAddress pa, String s, ModelNode mn, TransformationContext tc) {
                    }
                }, maxAttribute);
    }
