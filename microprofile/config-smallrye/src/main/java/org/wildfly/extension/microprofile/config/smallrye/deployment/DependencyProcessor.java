...
public class DependencyProcessor implements DeploymentUnitProcessor {
    ...
    public static final ModuleIdentifier SMALLRYE_CONFIG = ModuleIdentifier.create("io.smallrye.config");
    ...
    private void addDependencies(DeploymentUnit deploymentUnit) {
        ...
        moduleSpecification.addSystemDependency(new ModuleDependency(moduleLoader, SMALLRYE_CONFIG, false, false, true, false));
    }
