...
public class MicroProfileHealthReporter {
    ...
    private final boolean defaultProceduresDisabledGlobally;
    ...
    private final AtomicReference<String> defaultProceduresDisabledPerDeployment = new AtomicReference<>();

    public void disableAllDefaultProcedures(final String deploymentName) {
        // TODO - check for the value to be != null here and log a warning that it won't be changed anymore
        //  since if a deployment disables default procedures, that will affect all the default procedures,
        //  including those relating to the global server context
        this.defaultProceduresDisabledPerDeployment.compareAndSet(null, deploymentName);
    }

    private boolean defaultProceduresShouldBeAdded() {
        return !defaultProceduresDisabledGlobally && defaultProceduresDisabledPerDeployment.get() == null;
    }
    ...
    public MicroProfileHealthReporter(String emptyLivenessChecksStatus, String emptyReadinessChecksStatus,
                                      String emptyStartupChecksStatus, boolean defaultProceduresDisabledGlobally,
        ...
        this.defaultProceduresDisabledGlobally = defaultProceduresDisabledGlobally;
