...
public class MicroProfileHealthReporterService implements Service<MicroProfileHealthReporter> {
    ...
    public void start(StartContext context) {
        ...
        healthReporter = new MicroProfileHealthReporter(emptyLivenessChecksStatus, emptyReadinessChecksStatus, emptyStartupChecksStatus, defaultServerProceduresDisabled);
