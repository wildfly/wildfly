...
public class MicroProfileOpenAPIExtension extends SubsystemExtension<MicroProfileOpenAPISubsystemSchema> {
    ...
    public MicroProfileOpenAPIExtension() {
        super(SubsystemConfiguration.of(MicroProfileOpenAPISubsystemRegistrar.REGISTRATION.getName(), MicroProfileOpenAPISubsystemModel.CURRENT, MicroProfileOpenAPISubsystemRegistrar::new), SubsystemPersistence.of(MicroProfileOpenAPISubsystemSchema.CURRENT));
    }
}
