...
public interface MicroProfileOpenAPILogger extends BasicLogger {
     ...
     */
    MicroProfileOpenAPILogger LOGGER = Logger.getMessageLogger(MicroProfileOpenAPILogger.class,
                                                               "org.wildfly.extension.microprofile.openapi.smallrye");

    /**
     * Logs an informational message indicating the naming subsystem is being
     * activated.
     */
