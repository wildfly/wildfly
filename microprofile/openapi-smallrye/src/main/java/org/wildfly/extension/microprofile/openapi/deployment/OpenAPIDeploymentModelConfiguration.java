...
import org.wildfly.extension.microprofile.openapi.host.OpenAPIModelConfiguration;

/**
 * Configuration of an OpenAPI model for a deployment.
 * @author Paul Ferraro
 */
public interface OpenAPIDeploymentModelConfiguration extends OpenAPIModelConfiguration {
