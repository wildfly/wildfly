 ...
 * Copyright (c) 2022, JBoss Inc., and individual contributors as indicated
...
/**
 * WFLY-16626. Temporary abstract superclass for SessionContextImpl to simplify having
 * different SessionContextImpl classes in the EE 8 javax.* code vs the EE 10 jakarta.* code.
 * Once the source code in this class's maven module moves to EE 10 / jakarta.* this class can
 * be removed and its logic moved down into SessionContextImpl.
 */
abstract class AbstractSessionContextImpl extends EJBContextImpl implements SessionContext {

    private static final long serialVersionUID = 1L;
    private final boolean stateful;

    AbstractSessionContextImpl(SessionBeanComponentInstance instance) {
        super(instance);
