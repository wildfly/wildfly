...
import org.jboss.as.ejb3.deployment.processors.EjbNameLookupProcessor;
...
class Ejb3SubsystemAdd implements ModelAddOperationHandler, BootOperationHandler {
    ...
    public OperationResult execute(final OperationContext context, final ModelNode operation, final ResultHandler resultHandler) {
        ...
        if (context instanceof BootOperationContext) {
            ...
            updateContext.addDeploymentProcessor(Phase.POST_MODULE, Phase.POST_MODULE_EJB_LOOKUP, new EjbNameLookupProcessor() );
