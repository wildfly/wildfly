...
public class EJB3SubsystemRootResourceDefinition extends SimpleResourceDefinition {
    ...
    public static final RuntimeCapability<Void> SECURITY_DOMAINS_CAPABILITY =
    ...
    private static void registerTransformers1_2_1_and_1_3_0(SubsystemRegistration subsystemRegistration, ModelVersion version) {
        ...
        builder.getAttributeBuilder().setDiscard(DiscardAttributeChecker.UNDEFINED, SECURITY_DOMAINS);
        builder.getAttributeBuilder().addRejectCheck(RejectAttributeChecker.DEFINED, SECURITY_DOMAINS);
