...
public final class DiscoveryRegistrationProcessor implements DeploymentUnitProcessor {
    ...
    public void deploy(final DeploymentPhaseContext phaseContext) throws DeploymentUnitProcessingException {
        ...
        final Supplier<DiscoveryProvider> localDiscoveryProviderSupplier = (useLocalReceiver && !appClient) ? builder.requires(LocalEJBDiscoveryProviderService.SERVICE_NAME) : null;
