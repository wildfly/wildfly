...
public class DelegatingAssociationImpl implements Association, Consumer<Association> {
    ...
    public DelegatingAssociationImpl() {
        if (EjbLogger.DEPLOYMENT_LOGGER.isTraceEnabled())
            EjbLogger.DEPLOYMENT_LOGGER.trace("Calling DelegatingAssociationImpl.init<>");
        ...
        if (EjbLogger.DEPLOYMENT_LOGGER.isTraceEnabled())
            EjbLogger.DEPLOYMENT_LOGGER.tracef("Called DelegatingAssociationImpl.init<>, delegate = %s", this.delegate.getClass().getSimpleName());
    }
    ...
    public synchronized void accept(Association association) {
        if (EjbLogger.DEPLOYMENT_LOGGER.isTraceEnabled())
            EjbLogger.DEPLOYMENT_LOGGER.tracef("DelegatingAssociationImpl: Accepting Association, class type = %s",  (association != null ? association.getClass().getName() : "null"));
    ...
    public <T> CancelHandle receiveInvocationRequest(InvocationRequest invocationRequest) {
        if (EjbLogger.DEPLOYMENT_LOGGER.isTraceEnabled())
            EjbLogger.DEPLOYMENT_LOGGER.trace("DelegatingAssociationImpl: Calling receiveInvocationRequest");
    ...
    public CancelHandle receiveSessionOpenRequest(SessionOpenRequest sessionOpenRequest) {
        if (EjbLogger.DEPLOYMENT_LOGGER.isTraceEnabled())
            EjbLogger.DEPLOYMENT_LOGGER.trace("DelegatingAssociationImpl: Calling receiveSessionOpenRequest");
    ...
    public synchronized ListenerHandle registerClusterTopologyListener(ClusterTopologyListener clusterTopologyListener) {
        if (EjbLogger.DEPLOYMENT_LOGGER.isTraceEnabled())
            EjbLogger.DEPLOYMENT_LOGGER.trace("DelegatingAssociationImpl: Calling registerClusterTopologyListener");
    ...
    public synchronized ListenerHandle registerModuleAvailabilityListener(ModuleAvailabilityListener moduleAvailabilityListener) {
        if (EjbLogger.DEPLOYMENT_LOGGER.isTraceEnabled())
            EjbLogger.DEPLOYMENT_LOGGER.trace("DelegatingAssociationImpl: Calling registerModuleAvailabilityListener");
    ...
    private void refreshClusterTopologyListeners(Association newAssociation) {
        if (EjbLogger.DEPLOYMENT_LOGGER.isTraceEnabled())
            EjbLogger.DEPLOYMENT_LOGGER.trace("DelegatingAssociationImpl: Refreshing cluster topology listeners");
        ...
        if (EjbLogger.DEPLOYMENT_LOGGER.isTraceEnabled())
            EjbLogger.DEPLOYMENT_LOGGER.trace("DelegatingAssociationImpl: Refreshed cluster topology listeners");
    }
    ...
    private void refreshModuleAvailabilityListeners(Association newAssociation) {
        if (EjbLogger.DEPLOYMENT_LOGGER.isTraceEnabled())
            EjbLogger.DEPLOYMENT_LOGGER.trace("DelegatingAssociationImpl: Refreshing module availability listeners");
        ...
        if (EjbLogger.DEPLOYMENT_LOGGER.isTraceEnabled())
            EjbLogger.DEPLOYMENT_LOGGER.trace("DelegatingAssociationImpl: Refreshed module availability listeners");
    }
