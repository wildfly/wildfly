...
/**
 * Parser for ejb3:10.1 namespace.
 * TODO Parameterize a single parser class by schema version.  Inheritence is a poor model for versioning.
 */
public class EJB3Subsystem101Parser extends EJB3Subsystem100Parser {

    @Override
    protected EJB3SubsystemNamespace getExpectedNamespace() {
        return EJB3SubsystemNamespace.EJB3_10_1;
    }
        ...
        for (int i = 0; i < count; i++) {
            ...
            switch (attribute) {
                ...
                case DATASOURCE_NAME:
                    DatabaseDataStoreResourceDefinition.DATASOURCE_NAME.parseAndSetParameter(value, databaseDataStore, reader);
                    break;
