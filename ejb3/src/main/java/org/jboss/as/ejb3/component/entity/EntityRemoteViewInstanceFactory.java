 ...
 * @author John Bailey
 */
public class EntityRemoteViewInstanceFactory implements ViewInstanceFactory {
    private final String applicationName;
    private final String moduleName;
    private final String distinctName;
    private final String beanName;

    public EntityRemoteViewInstanceFactory(final String applicationName, final String moduleName, final String distinctName, final String beanName) {
    ...
    public ManagedReference createViewInstance(ComponentView componentView, Map<Object, Object> contextData) {
        final Object primaryKey = contextData.get(EntityBeanComponent.PRIMARY_KEY_CONTEXT_KEY);
