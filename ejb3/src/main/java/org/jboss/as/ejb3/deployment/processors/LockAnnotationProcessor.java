...
/**
 * Processes the {@link javax.ejb.Lock} annotation on a Singleton bean and its methods and updates the {@link SingletonComponentDescription}
 * accordingly.
 * <p/>
 ...
 *
 * @author Jaikiran Pai
 *         TODO: This should be applicable even for Stateful beans
 */
public class LockAnnotationProcessor extends AbstractAnnotationEJBProcessor<SingletonComponentDescription> {
    ...
    private void processLockAnnotations(ClassInfo beanClass, CompositeIndex compositeIndex, SingletonComponentDescription componentDescription) throws DeploymentUnitProcessingException {
