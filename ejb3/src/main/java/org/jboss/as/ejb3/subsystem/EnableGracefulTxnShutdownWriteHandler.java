...
public class EnableGracefulTxnShutdownWriteHandler extends AbstractWriteAttributeHandler<Void> {
    ...
    public static final EnableGracefulTxnShutdownWriteHandler INSTANCE = new EnableGracefulTxnShutdownWriteHandler(EJB3SubsystemRootResourceDefinition.ENABLE_GRACEFUL_TXN_SHUTDOWN);
