...
public class ModelTestUtils {
    ...
    public static void checkFailedTransformedBootOperations(ModelTestKernelServices<?> mainServices,
        ...
        org.jboss.as.model.test.ModelTestUtils.checkOutcome(mainServices.executeOperation(mainComposite));
        ...
        if (config.isTransformComposite()) {
            ...
            org.jboss.as.model.test.ModelTestUtils.checkOutcome(legacyServices.executeOperation(legacyComposite));
        }
