...
public class ManagementException extends RuntimeException {
    ...
    /**
     * Constructs a {@code ManagementOperationException} with the specified detail message and cause.
     *
     * @param message the detail message
    ...
    /**
     * Constructs a {@code ManagementOperationException} with the specified cause. The detail message is set to:
