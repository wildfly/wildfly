...
import org.jboss.as.arquillian.generic.service.GenericArquillianService;
 ...
 */
public class GenericJMXProtocolPackager extends JMXProtocolPackager {
    protected GenericJMXProtocolPackager(AbstractJMXProtocolAS7.ServiceArchiveHolder archiveHolder) {
        super(archiveHolder);
    }
    ...
    protected JavaArchive generateArquillianServiceArchive(Collection<Archive<?>> auxArchives) {
        ...
        archive.addPackage(GenericArquillianService.class.getPackage());
        return archive;
    }
}
