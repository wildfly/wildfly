 ...
 */
public class GenericArquillianConfig extends ArquillianConfig<GenericArquillianConfig> {
    protected GenericArquillianConfig(ArquillianService arqService, DeploymentUnit depUnit, Set<String> testClasses) {
