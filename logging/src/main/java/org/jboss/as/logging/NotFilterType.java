 ...
 */
public final class NotFilterType extends FilterType {
    private final FilterType target;

    public NotFilterType(final FilterType target) {
        this.target = target;
    }

    public Filter createFilterInstance() {
        return new InvertFilter(target.createFilterInstance());
    }
