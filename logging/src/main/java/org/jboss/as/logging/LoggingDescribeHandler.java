...
public class LoggingDescribeHandler implements OperationStepHandler, DescriptionProvider{
    ...
    private void copyCommonHandlerAttributes(final ModelNode from, final ModelNode to) {
    ...
    private void copyCommonFlushingHandlerAttributes(final ModelNode from, final ModelNode to) {
        copyCommonHandlerAttributes(from, to);
        copy(AUTOFLUSH, from, to);
    }

    private void copy(final AttributeDefinition definition, final ModelNode from, final ModelNode to) {
