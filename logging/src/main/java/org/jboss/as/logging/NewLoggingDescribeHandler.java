...
public class NewLoggingDescribeHandler implements ModelQueryOperationHandler, DescriptionProvider{
    ...
    public Cancellable execute(NewOperationContext context, ModelNode operation, ResultHandler resultHandler) {
        ...
        result.add(NewLoggingExtension.NewLoggingSubsystemAdd.createOperation(rootAddress.toModelNode()));
        if (model.hasDefined(ROOT_LOGGER)) {
            ModelNode add = Util.getEmptyOperation(NewRootLoggerAdd.OPERATION_NAME, rootAddress.toModelNode());
    ...
    private ModelNode defineAsynchHandler(final String name, final ModelNode handler, final PathAddress rootAddress) {
        ModelNode add = Util.getEmptyOperation(NewAsyncHandlerAdd.OPERATION_NAME, rootAddress.append(PathElement.pathElement(HANDLER, name)).toModelNode());
    ...
    private ModelNode defineConsoleHandler(final String name, final ModelNode handler, final PathAddress rootAddress) {
        ModelNode add = Util.getEmptyOperation(NewConsoleHandlerAdd.OPERATION_NAME, rootAddress.append(PathElement.pathElement(HANDLER, name)).toModelNode());
    ...
    private ModelNode defineFileHandler(final String name, final ModelNode handler, final PathAddress rootAddress) {
        ModelNode add = Util.getEmptyOperation(NewFileHandlerAdd.OPERATION_NAME, rootAddress.append(PathElement.pathElement(HANDLER, name)).toModelNode());
    ...
    private ModelNode definePeriodicRotatingFileHandler(final String name, final ModelNode handler, final PathAddress rootAddress) {
        ModelNode add = Util.getEmptyOperation(NewPeriodicFileHandlerAdd.OPERATION_NAME, rootAddress.append(PathElement.pathElement(HANDLER, name)).toModelNode());
    ...
    private ModelNode defineSizeRotatingFileHandler(final String name, final ModelNode handler, final PathAddress rootAddress) {
        ModelNode add = Util.getEmptyOperation(NewSizePeriodicFileHandlerAdd.OPERATION_NAME, rootAddress.append(PathElement.pathElement(HANDLER, name)).toModelNode());
