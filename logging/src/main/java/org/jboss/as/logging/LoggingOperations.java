...
final class LoggingOperations {
    ...
    private abstract static class LoggingOperationStepHandler implements OperationStepHandler {
        ...
        public final void execute(final OperationContext context, final ModelNode operation) throws OperationFailedException {
            ...
            final LogContextConfiguration logContextConfiguration = Logging.getLogContextConfiguration();
     ...
     */
    abstract static class LoggingWriteAttributeHandler extends AbstractWriteAttributeHandler<LogContextConfiguration> {
        ...
        @Override
        protected final boolean applyUpdateToRuntime(final OperationContext context, final ModelNode operation, final String attributeName, final ModelNode resolvedValue, final ModelNode currentValue, final HandbackHolder<LogContextConfiguration> handbackHolder) throws OperationFailedException {
            final PathAddress address = PathAddress.pathAddress(operation.require(OP_ADDR));
            final String name = address.getLastElement().getValue();
            final LogContextConfiguration logContextConfiguration = Logging.getLogContextConfiguration();
            handbackHolder.setHandback(logContextConfiguration);
        ...
        @Override
        protected final void revertUpdateToRuntime(final OperationContext context, final ModelNode operation, final String attributeName, final ModelNode valueToRestore, final ModelNode valueToRevert, final LogContextConfiguration logContextConfiguration) throws OperationFailedException {
