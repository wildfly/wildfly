...
interface CommonAttributes {
    ...
    SimpleAttributeDefinition FILE = new SimpleAttributeDefinitionBuilder("file", ModelType.OBJECT).build();
    ...
    SimpleAttributeDefinition SUFFIX = new SimpleAttributeDefinitionBuilder("suffix", ModelType.STRING, false).build();
    ...
    /**
     * Common handler attribute definitions
     */
    AttributeDefinition[] COMMON_HANDLER_ATTRIBUTES = {
            ENCODING,
            FORMATTER,
            LEVEL
    };
