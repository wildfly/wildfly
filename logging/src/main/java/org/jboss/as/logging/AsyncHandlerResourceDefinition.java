...
class AsyncHandlerResourceDefinition extends AbstractHandlerDefinition {
    ...
    /**
     * Register the transformers for the async handler.
     *
    ...
    static void registerTransformers(final TransformersSubRegistration registration, final TransformersSubRegistration loggingProfileReg) {
        ...
        registerTransformers(registration, loggingProfileReg, ASYNC_HANDLER_PATH, attributes, ADD_HANDLER_OPERATION_NAME, REMOVE_HANDLER_OPERATION_NAME);
    }
}
