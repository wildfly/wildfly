...
/**
 * Updates a {@link JvmElement}'s {@link JvmElement#isDebugEnabled()} debug enabled.
 *
 * @author Kabir Khan
 */
public class JvmDebugEnabledUpdate extends AbstractModelUpdate<JvmElement, Void> {
    ...
    public JvmDebugEnabledUpdate(final boolean debugEnabled) {
        this.debugEnabled = debugEnabled;
    }

    @Override
    public JvmDebugEnabledUpdate getCompensatingUpdate(JvmElement original) {
        return new JvmDebugEnabledUpdate(original.isDebugEnabled());
    }
    ...
    protected void applyUpdate(JvmElement element) throws UpdateFailedException {
        element.setDebugEnabled(debugEnabled);
    }
