...
/**
 * Updates a {@link JvmElement}'s {@link JvmElement#getDebugOptions()} debug options.
 *
 * @author Kabir Khan
 */
public class JvmDebugOptionsUpdate extends AbstractModelUpdate<JvmElement, Void> {
    ...
    public JvmDebugOptionsUpdate(final String debugOptions) {
        this.debugOptions = debugOptions;
    }

    @Override
    public JvmDebugOptionsUpdate getCompensatingUpdate(JvmElement original) {
        return new JvmDebugOptionsUpdate(original.getDebugOptions());
    }
    ...
    protected void applyUpdate(JvmElement element) throws UpdateFailedException {
        element.setDebugOptions(debugOptions);
    }
