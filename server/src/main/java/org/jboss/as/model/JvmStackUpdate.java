...
/**
 * Updates a {@link JvmElement}'s {@link JvmElement#getStack() stack size}.
 *
 * @author Kabir Khan
 */
public class JvmStackUpdate extends AbstractModelUpdate<JvmElement, Void> {

    private static final long serialVersionUID = -3406895728835596414L;

    private final String stack;

    public JvmStackUpdate(final String stack) {
        this.stack = stack;
    }

    @Override
    public JvmStackUpdate getCompensatingUpdate(JvmElement original) {
        return new JvmStackUpdate(original.getHeapSize());
    }
