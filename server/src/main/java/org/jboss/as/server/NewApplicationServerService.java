 ...
 */
final class NewApplicationServerService implements Service<Void> {
    ...
    NewApplicationServerService(final List<ServiceActivator> extraServices, final NewBootstrap.Configuration configuration) {
