 ...
 * MA  02110-1301, USA.
 */
package org.jboss.as.server.controller;
...
/**
 * Records core operations with the server controller model registry.
 *
 * @author Brian Stansberry (c) 2011 Red Hat Inc.
 */
public class CoreOperationsRegistrar {
    ...
    public static void registerCoreOperations(ModelNodeRegistration root) {
