...
public interface NewBootstrap {
     ...
     */
    AsyncFuture<NewServerController> start(Configuration configuration, List<ServiceActivator> extraServices);
    ...
    /**
     * The factory for creating new instances of {@link org.jboss.as.server.NewBootstrap}.
     */
    final class Factory {
         ...
         */
        public static NewBootstrap newInstance() {
            return new NewBootstrapImpl();
        }
    }
}
