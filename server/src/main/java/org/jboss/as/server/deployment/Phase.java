...
public enum Phase {
    ...
    public static final int PARSE_OSGI_BUNDLE_INFO                      = 0x0700;
    public static final int PARSE_OSGI_PROPERTIES                       = 0x0800;
    ...
    public static final int PARSE_SERVICE_LOADER_DEPLOYMENT             = 0x0E00;
    ...
    public static final int PARSE_MANAGED_BEAN_ANNOTATION               = 0x1500;
    public static final int PARSE_BEAN_LIEFCYCLE_ANNOTATION             = 0x1600;
    public static final int PARSE_BEAN_INTERCEPTOR_ANNOTATION           = 0x1700;
    public static final int PARSE_BEAN_RESOURCE_INJECTION_ANNOTATION    = 0x1800;
    public static final int PARSE_MANAGED_BEAN_RESOURCE_TARGET          = 0x1900;
    public static final int PARSE_WELD_DEPLOYMENT                       = 0x1A00;
    public static final int PARSE_WEBSERVICES_XML                       = 0x1B00;
