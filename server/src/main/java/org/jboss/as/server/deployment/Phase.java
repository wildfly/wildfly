...
public enum Phase {
    ...
    public static final int INSTALL_BUNDLE_UNINSTALL                    = 0x2050;
    public static final int INSTALL_WAB_SERVLETCONTEXT_SERVICE          = 0x2060;
    public static final int INSTALL_PERSISTENCE_SERVICES                = 0x2070;
