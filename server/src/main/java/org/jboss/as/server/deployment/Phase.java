...
public enum Phase {
    ...
    public static final int INSTALL_WS_LAZY_BINDING_SOURCE_HANDLER      = 0x0F00;
    public static final int INSTALL_EE_COMPONENT                        = 0x1000;
    public static final int INSTALL_SERVLET_INIT_DEPLOYMENT             = 0x1100;
    public static final int INSTALL_JAXRS_SCANNING                      = 0x1200;
