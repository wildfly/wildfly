...
public enum Phase {
    ...
    public static final int POST_MODULE_EXTERNAL_TAGLIB                 = 0x3400;
    // INSTALL
    ...
    public static final int INSTALL_MOD_CLUSTER_SERVICE_DEPENDENCY      = 0x1C02; // Adds a service dependency so needs to happen anytime before INSTALL_WAR_DEPLOYMENT
