...
public enum Phase {
    ...
    public static final int PARSE_JAXWS_HANDLER_CHAIN_ANNOTATION        = 0x1700;
    public static final int PARSE_JAXWS_ENDPOINT_CREATE_COMPONENT_DESCRIPTIONS = 0x1701;
    public static final int PARSE_JAXWS_HANDLER_CREATE_COMPONENT_DESCRIPTIONS = 0x1702;
    public static final int PARSE_WS_EJB_INTEGRATION                    = 0x1703;
