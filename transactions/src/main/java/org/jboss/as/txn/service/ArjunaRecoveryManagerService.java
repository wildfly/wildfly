...
public class ArjunaRecoveryManagerService implements Service {
    ...
    private SuspendableActivityRegistration activityRegistration;
    ...
    public void start(final StartContext context) throws StartException {
        ...
        activityRegistration = suspendableActivityRegistrarSupplier.get().register(recoverySuspendController, SuspendPriority.LAST);
