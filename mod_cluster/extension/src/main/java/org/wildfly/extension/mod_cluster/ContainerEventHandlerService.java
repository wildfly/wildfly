...
public class ContainerEventHandlerService implements Service<ModClusterService> {
    ...
    static final ServiceName LEGACY_SERVICE_NAME = ServiceName.JBOSS.append("mod-cluster");
    ...
    public void start(StartContext context) {
        ...
        this.eventHandler = new org.jboss.modcluster.ModClusterService(config, load);
    }
