...
public class UndertowEventHandlerAdapterServiceConfigurator extends UndertowEventHandlerAdapterServiceNameProvider implements CapabilityServiceConfigurator, UndertowEventHandlerAdapterConfiguration {
    ...
    private volatile SupplierDependency<SuspendableActivityRegistrar> suspendableActivityRegistrar;
    ...
    public ServiceConfigurator configure(CapabilityServiceSupport support) {
        ...
        this.suspendableActivityRegistrar = new ServiceSupplierDependency<>(support.getCapabilityServiceName(SuspendableActivityRegistrar.SERVICE_DESCRIPTOR));
        return this;
    }
    ...
    public ServiceBuilder<?> build(ServiceTarget target) {
        ...
        new CompositeDependency(this.service, this.listener, this.suspendableActivityRegistrar).register(builder);
    ...
    @Override
    public SuspendableActivityRegistrar getSuspendableActivityRegistrar() {
        return this.suspendableActivityRegistrar.get();
    }
