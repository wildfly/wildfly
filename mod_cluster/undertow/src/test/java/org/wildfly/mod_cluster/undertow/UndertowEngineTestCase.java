...
public class UndertowEngineTestCase {
    ...
    private final Server server = new TestServer(this.serverName, this.hostName, this.host, this.listener);
    ...
    private final Engine engine = new UndertowEngine(this.service, this.server, this.connector, this.route);
