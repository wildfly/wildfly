...
class KnownVersions {
    ...
    static {
        ...
        addSubsystemVersion(map, "jgroups", "2.0.0", CORE_MODEL_8_0_0);
        ...
        addSubsystemVersion(map, "messaging", "2.0.0", CORE_MODEL_8_0_0);
        ...
        addSubsystemVersion(map, "web", "2.0.0", CORE_MODEL_8_0_0);
