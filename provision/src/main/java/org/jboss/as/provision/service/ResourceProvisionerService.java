...
public final class ResourceProvisionerService extends AbstractService<XResourceProvisioner> {
    ...
    public static final ServiceName SERVICE_NAME = ProvisionConstants.SERVICE_BASE_NAME.append("XResourceProvisioner");
    ...
    public static ServiceController<?> addService(final ServiceTarget target) {
        ...
        builder.addDependency(AbstractResolverService.SERVICE_NAME, XResolver.class, service.injectedResolver);
        builder.addDependency(DependencyType.OPTIONAL, ServiceName.parse("jbosgi.framework.CREATE"), BundleContext.class, service.injectedBundleContext);
    ...
    public void start(StartContext startContext) throws StartException {
        ...
        final String targetType = injectedBundleContext.getValue() != null ? XResource.TYPE_BUNDLE : XResource.TYPE_MODULE;
        provisioner = new AbstractResourceProvisioner(resolver, repository, targetType) {
            @Override
            ...
            public <T> List<T> installResources(List<XResource> resources, Class<T> type) throws ProvisionException {
                ...
                for (XResource res : resources) {
                    ...
                    try {
                        String runtimeName = serverDeployer.deploy(location, input);
