...
public interface ProvisionConstants {
    ...
    /** Service base name for all Provision subsystem services. */
    ServiceName SERVICE_BASE_NAME = ServiceName.JBOSS.append("provision", "as");
