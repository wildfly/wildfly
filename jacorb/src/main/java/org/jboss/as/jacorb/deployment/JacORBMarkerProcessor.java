 ...
 */
public class JacORBMarkerProcessor implements DeploymentUnitProcessor{
    @Override
    public void deploy(DeploymentPhaseContext phaseContext) throws DeploymentUnitProcessingException {
        final DeploymentUnit deploymentUnit = phaseContext.getDeploymentUnit();
        //for now we mark all subsystems as using IIOP if the jacorb subsystem is installed
        JacORBDeploymentMarker.mark(deploymentUnit);
    }
