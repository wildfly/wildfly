...
public interface JacORBLogger extends BasicLogger {
    ...
    @Message(id = 78, value = "Error configuring domain socket factory: security domain is null")
    org.jacorb.config.ConfigurationException errorConfiguringDomainSF();

    @Message(id = 79, value = "Error configuring domain socket factory: failed to lookup JSSE security domain")
    ...
    @Message(id = 94, value = "Field %s of interface %s is a constant, but it is not primitive or String")
    RMIIIOPViolationException badRMIIIOPConstantType(String field, String intface, @Param String section);

    @Message(id = 95, value = "Exception type %s must be a checked exception class")
    RMIIIOPViolationException badRMIIIOPExceptionType(String type, @Param String section);

    @Message(id = 96, value = "All interface methods must throw javax.rmi.RemoteException but method %s of interface %s does not")
    ...
    @Message(id = 103, value = "Value type %s cannot implement java.rmi.Remote")
    RMIIIOPViolationException valueTypeCantImplementRemote(String type, @Param String section);

    @Message(id = 104, value = "Value type %s cannot be a proxy or inner class")
    ...
    @Message(id = 115, value = "Wrong interface repository")
    IRConstructionException wrongInterfaceRepository();

    @Message(id = 116, value = "Duplicate repository name")
    ...
    @Message(id = 118, value = "Bad class %s for a constant")
    IRConstructionException badClassForConstant(String className);

    @Message(id = 119, value = "TypeCode for class %s is unknown")
    IRConstructionException unknownTypeCodeForClass(String className);

    @Message(id = 120, value = "TypeCode for class %s already established")
    IRConstructionException duplicateTypeCodeForClass(String className);

    @Message(id = 121, value = "Name collision while creating package")
    IRConstructionException collisionWhileCreatingPackage();

    @Message(id = 122, value = "Class %s is not an array class")
    ...
    @Message(id = 124, value = "Bad kind for super valuetype of %s")
    IRConstructionException badKindForSuperValueType(String id);

    @Message(id = 125, value = "ValueDef %s unable to resolve reference to implemented interface %s")
    IRConstructionException errorResolvingRefToImplementedInterface(String id, String intface);

    @Message(id = 126, value = "ValueDef %s unable to resolve reference to abstract base valuetype %s")
