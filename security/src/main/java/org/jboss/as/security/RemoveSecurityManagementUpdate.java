...
/**
 * Update to remove the security management service
 *
 * @author <a href="mailto:mmoyses@redhat.com">Marcus Moyses</a>
 */
public final class RemoveSecurityManagementUpdate extends AbstractSecuritySubsystemUpdate<Void> {
    ...
    public AbstractSubsystemUpdate<SecuritySubsystemElement, ?> getCompensatingUpdate(SecuritySubsystemElement original) {
        SecurityManagementElement element = original.getSecurityManagement();
        if (element != null)
    ...
    protected void applyUpdate(SecuritySubsystemElement element) throws UpdateFailedException {
        element.setSecurityManagement(null);
    }
