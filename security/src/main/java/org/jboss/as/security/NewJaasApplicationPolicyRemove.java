 ...
 */
class NewJaasApplicationPolicyRemove implements ModelAddOperationHandler, RuntimeOperationHandler, DescriptionProvider {

    static final String OPERATION_NAME = REMOVE;

    static final NewJaasApplicationPolicyRemove INSTANCE = new NewJaasApplicationPolicyRemove();

    /** Private to ensure a singleton. */
    private NewJaasApplicationPolicyRemove() {
    }
