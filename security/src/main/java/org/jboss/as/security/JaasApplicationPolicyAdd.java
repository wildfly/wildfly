 ...
 */
class JaasApplicationPolicyAdd implements ModelAddOperationHandler, RuntimeOperationHandler, DescriptionProvider {
    ...
    static final JaasApplicationPolicyAdd INSTANCE = new JaasApplicationPolicyAdd();

    /** Private to ensure a singleton. */
    private JaasApplicationPolicyAdd() {
    }
