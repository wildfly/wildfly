= Use of wildfly-ee-feature-pack-galleon--legacy
:icons: font
...
Note that `wildfly-legacy-ee` is a conceptual name used in this document for a feature pack that will have different actual names over time, depending on what EE version it provides. For example, it initially was called `wildfly-ee-10`.
