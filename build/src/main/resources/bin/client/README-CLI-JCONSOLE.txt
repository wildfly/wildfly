The jboss-cli-client jar can be used to remotely manage a JBoss EAP instance with CLI or jconsole.  Copy jboss-cli-client.jar to your client machine.  You do not need to install JBoss EAP.
