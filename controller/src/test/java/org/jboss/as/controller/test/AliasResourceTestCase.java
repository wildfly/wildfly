...
public class AliasResourceTestCase extends AbstractControllerTestBase {
    ...
    protected void initModel(Resource rootResource, ManagementResourceRegistration registration) {
        ...
        registration.registerAlias(getAliasedModelElement(),
                new TestAliasEntry(PathAddress.pathAddress(getCoreModelElement())));

        coreResourceRegistration.registerSubModel(new ChildResourceDefinition());
        coreResourceRegistration.registerAlias(getAliasedChildModelElement(),
                new TestAliasEntry(
                        PathAddress.pathAddress(PathAddress.pathAddress(getCoreModelElement(), getChildModelElement()))));
    }
    ...
    public static class TestAliasEntry extends AliasEntry {
        ...
        public TestAliasEntry(final PathAddress target) {
            super(target);
        }
