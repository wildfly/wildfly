...
public class DelegatingNotificationHandler implements NotificationHandler, NotificationFilter{
    ...
    public void setDelegatingHandler(NotificationHandler delegatingHandler) {
        this.delegatingHandler = delegatingHandler;
    }

    public void setDelegatingFilter(NotificationFilter delegatingFilter) {
        this.delegatingFilter = delegatingFilter;
    }

    @Override
    public boolean isNotificationEnabled(Notification notification) {
        return delegatingFilter.isNotificationEnabled(notification);
    }

    @Override
    public void handleNotification(Notification notification) {
        delegatingHandler.handleNotification(notification);
    }
}
