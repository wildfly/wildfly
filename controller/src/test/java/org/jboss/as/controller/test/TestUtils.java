...
public class TestUtils {
    ...
    public static AttributeDefinition createAttribute(String name, ModelType type, boolean allowNull) {
        return SimpleAttributeDefinitionBuilder.create(name, type, allowNull).build();
    }
