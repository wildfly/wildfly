...
class ResourceBuilderRoot implements ResourceBuilder {
    ...
    public ResourceBuilder addChild(final PathElement pathElement) {
        return addChild(pathElement, resourceResolver.getChildResolver(pathElement.getKey()));
    }

    @Override
    public ResourceBuilder addChild(final PathElement pathElement, final OperationStepHandler addHandler, final OperationStepHandler removeHandler) {
        return addChild(pathElement, resourceResolver.getChildResolver(pathElement.getKey()), addHandler, removeHandler);
    }

    public ResourceBuilder addChild(final PathElement pathElement, StandardResourceDescriptionResolver resolver) {
        return addChild(pathElement, resolver, null, null);
    }

    @Override
    public ResourceBuilder addChild(final PathElement pathElement, StandardResourceDescriptionResolver resolver, final OperationStepHandler addHandler, final OperationStepHandler removeHandler) {
    ...
    @Override
    public ResourceBuilder addChild(final ResourceBuilder child) {
