...
//    String noHandler(String stepOpName, PathAddress address);
    ...
    @Message(id = 13479, value = "Unsupported Principal type '%X' received.")
    IOException unsupportedPrincipalType(byte type);

    @Message(id = 13480, value = "Unsupported Principal parameter '%X' received parsing principal type '%X'.")
