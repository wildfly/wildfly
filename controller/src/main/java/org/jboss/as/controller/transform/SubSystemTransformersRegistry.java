...
public interface SubSystemTransformersRegistry {
     ...
     */
    void discardOperation(PathAddress address, String operationName);
     ...
     */
    void registerOperationTransformer(PathAddress address, String operationName, OperationTransformer transformer);
