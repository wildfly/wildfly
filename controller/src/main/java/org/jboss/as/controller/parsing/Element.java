...
public enum Element {
    ...
    DATABASE("database"),
    DATABASE_DATASOURCE("database-datasource"),
    ...
    SIMPLE_SELECT_USERS("simple-select-users"),
    SIMPLE_SELECT_ROLES("simple-select-roles"),
    SQL_SELECT_USERS("sql-select-users"),
    SQL_SELECT_ROLES("sql-select-roles"),
    SOCKET("socket"),
