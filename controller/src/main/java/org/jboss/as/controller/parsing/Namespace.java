...
public enum Namespace {
    ...
    DOMAIN_2_2("urn:jboss:domain:2.2");

    /**
     * The current namespace version.
     */
    public static final Namespace CURRENT = DOMAIN_2_2;

    public static final Namespace[] ALL_NAMESPACES = new Namespace[] {DOMAIN_1_0, DOMAIN_1_1, DOMAIN_1_2, DOMAIN_1_3, DOMAIN_1_4, DOMAIN_1_5, DOMAIN_2_0, DOMAIN_2_1, DOMAIN_2_2};
