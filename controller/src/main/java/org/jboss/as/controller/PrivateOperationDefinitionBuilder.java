...
/**
 * Creates an operation builder with an empty description and the private flag set.
 *
 * @author <a href="kabir.khan@jboss.com">Kabir Khan</a>
 */
public class PrivateOperationDefinitionBuilder extends SimpleOperationDefinitionBuilder {

    private static DescriptionProvider PROVIDER = new DescriptionProvider() {
        @Override
    ...
    public PrivateOperationDefinitionBuilder(String name) {
        super(name, null);
        setPrivateEntry();
    }
