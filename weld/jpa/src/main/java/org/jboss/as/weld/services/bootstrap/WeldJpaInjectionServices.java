...
public class WeldJpaInjectionServices implements JpaInjectionServices {
    ...
    public ResourceReferenceFactory<EntityManager> registerPersistenceContextInjectionPoint(final InjectionPoint injectionPoint) {
        ...
        return new EntityManagerResourceReferenceFactory(scopedPuName, persistenceUnitService.getEntityManagerFactory(), context, ContextTransactionSynchronizationRegistry.getInstance(), ContextTransactionManager.getInstance(), persistenceUnitService.getEntityManagerCache());
    }
