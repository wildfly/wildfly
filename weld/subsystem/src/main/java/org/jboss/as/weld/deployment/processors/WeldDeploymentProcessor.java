...
public class WeldDeploymentProcessor implements DeploymentUnitProcessor {
    ...
    static List<SetupAction> getSetupActions(DeploymentUnit deploymentUnit) {
        ...
        ConcurrentContextSetupAction eeConcurrency = deploymentUnit.getAttachment(org.jboss.as.ee.component.Attachments.CONCURRENT_CONTEXT_SETUP_ACTION);
        if (eeConcurrency != null) {
            setupActions.add(eeConcurrency);
        }
        return setupActions;
    }
}
