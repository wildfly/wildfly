...
final class FrameworkProxy implements Framework {
    ...
    public void init() throws BundleException {
        ...
        try {
            ServiceName serviceName = ServiceName.parse("jbosgi.framework.INIT");
            ServiceController<BundleContext> controller = (ServiceController<BundleContext>) server.getService(serviceName);
            bundleContext = controller.getValue();
        } catch (Throwable th) {
            th.printStackTrace();
    ...
    public void start(int options) throws BundleException {
        // [TODO] move the framework from init to active
    }
