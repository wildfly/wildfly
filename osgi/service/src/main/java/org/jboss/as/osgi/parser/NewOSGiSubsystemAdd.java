...
import org.jboss.as.osgi.deployment.OSGiDeploymentInstallProcessor;
 ...
 */
class NewOSGiSubsystemAdd implements ModelAddOperationHandler, RuntimeOperationHandler {

    private static final Logger log = Logger.getLogger("org.jboss.as.osgi");

    private static final Activation DEFAULT_ACTIVATION = Activation.LAZY;

    static final NewOSGiSubsystemAdd INSTANCE = new NewOSGiSubsystemAdd();

    private NewOSGiSubsystemAdd() {
