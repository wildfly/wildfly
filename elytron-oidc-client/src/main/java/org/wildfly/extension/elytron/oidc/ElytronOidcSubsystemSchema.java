    ...
    public PersistentResourceXMLDescription getXMLDescription() {
        ...
        return factory.builder(ElytronOidcClientSubsystemRegistrar.PATH)
                .addChild(factory.builder(RealmDefinition.PATH)
                        ...
                        .addAttribute(ProviderAttributeDefinitions.AUTHENTICATION_REQUEST_FORMAT, SIMPLE_ATTRIBUTE_PARSER, SIMPLE_ATTRIBUTE_MARSHALLER)
                        ...
                        .addAttribute(ProviderAttributeDefinitions.REQUEST_OBJECT_CONTENT_ENCRYPTION_ALGORITHM, SIMPLE_ATTRIBUTE_PARSER, SIMPLE_ATTRIBUTE_MARSHALLER)
                        .addAttribute(ProviderAttributeDefinitions.REQUEST_OBJECT_ENCRYPTION_ALGORITHM, SIMPLE_ATTRIBUTE_PARSER, SIMPLE_ATTRIBUTE_MARSHALLER)
                        .addAttribute(ProviderAttributeDefinitions.REQUEST_OBJECT_SIGNING_ALGORITHM, SIMPLE_ATTRIBUTE_PARSER, SIMPLE_ATTRIBUTE_MARSHALLER)
                        .addAttribute(ProviderAttributeDefinitions.REQUEST_OBJECT_SIGNING_KEY_ALIAS, SIMPLE_ATTRIBUTE_PARSER, SIMPLE_ATTRIBUTE_MARSHALLER)
                        .addAttribute(ProviderAttributeDefinitions.REQUEST_OBJECT_SIGNING_KEY_PASSWORD, SIMPLE_ATTRIBUTE_PARSER, SIMPLE_ATTRIBUTE_MARSHALLER)
                        .addAttribute(ProviderAttributeDefinitions.REQUEST_OBJECT_SIGNING_KEYSTORE_FILE, SIMPLE_ATTRIBUTE_PARSER, SIMPLE_ATTRIBUTE_MARSHALLER)
                        .addAttribute(ProviderAttributeDefinitions.REQUEST_OBJECT_SIGNING_KEYSTORE_PASSWORD, SIMPLE_ATTRIBUTE_PARSER, SIMPLE_ATTRIBUTE_MARSHALLER)
                        .addAttribute(ProviderAttributeDefinitions.REQUEST_OBJECT_SIGNING_KEYSTORE_TYPE, SIMPLE_ATTRIBUTE_PARSER, SIMPLE_ATTRIBUTE_MARSHALLER)
