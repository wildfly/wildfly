...
import static org.wildfly.extension.elytron.oidc.ElytronOidcDescriptionConstants.CLIENT_KEYSTORE;
...
public class ElytronOidcSubsystemTransformers implements ExtensionTransformerRegistration {
    ...
    private static void from3(ChainedTransformationDescriptionBuilder chainedBuilder) {
        ...
        builder.addChildResource(PathElement.pathElement(SECURE_SERVER))
                ...
                .setDiscard(DiscardAttributeChecker.UNDEFINED, REQUEST_OBJECT_SIGNING_KEYSTORE_FILE)
                .addRejectCheck(RejectAttributeChecker.DEFINED, REQUEST_OBJECT_SIGNING_KEYSTORE_PASSWORD)
                .setDiscard(DiscardAttributeChecker.UNDEFINED, REQUEST_OBJECT_SIGNING_KEYSTORE_PASSWORD)
                .addRejectCheck(RejectAttributeChecker.DEFINED, REQUEST_OBJECT_SIGNING_KEY_PASSWORD)
                .setDiscard(DiscardAttributeChecker.UNDEFINED, REQUEST_OBJECT_SIGNING_KEY_PASSWORD)
                .addRejectCheck(RejectAttributeChecker.DEFINED, REQUEST_OBJECT_SIGNING_KEYSTORE_TYPE)
                .setDiscard(DiscardAttributeChecker.UNDEFINED, REQUEST_OBJECT_SIGNING_KEYSTORE_TYPE)
                .addRejectCheck(RejectAttributeChecker.DEFINED, REQUEST_OBJECT_SIGNING_KEY_ALIAS)
                .setDiscard(DiscardAttributeChecker.UNDEFINED, REQUEST_OBJECT_SIGNING_KEY_ALIAS)
                .addRejectCheck(RejectAttributeChecker.DEFINED, CLIENT_KEYSTORE)
                .setDiscard(DiscardAttributeChecker.UNDEFINED, CLIENT_KEYSTORE)
