...
public class ConcurroDefaultContextSetupProviderImpl implements ContextSetupProvider {
    ...
    @Override
    public org.glassfish.concurro.spi.ContextHandle saveContext(ContextService contextService) {
        return saveContext(contextService, null);
    }

    @Override
    public org.glassfish.concurro.spi.ContextHandle saveContext(ContextService contextService, Map<String, String> contextObjectProperties) {
    ...
    @Override
    public org.glassfish.concurro.spi.ContextHandle setup(org.glassfish.concurro.spi.ContextHandle contextHandle) throws IllegalStateException {
        return ((SetupContextHandleWrapper) contextHandle).setup();
    }

    @Override
    public void reset(org.glassfish.concurro.spi.ContextHandle contextHandle) {
