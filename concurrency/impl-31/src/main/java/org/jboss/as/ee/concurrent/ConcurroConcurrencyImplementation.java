...
public class ConcurroConcurrencyImplementation extends AbstractConcurrencyImplementation {
    ...
    public void addDeploymentProcessors(DeploymentProcessorTarget processorTarget) {
        ...
        // TODO add new Phase priority for the following processors
        processorTarget.addDeploymentProcessor(EeExtension.SUBSYSTEM_NAME, Phase.POST_MODULE, Phase.POST_MODULE_RESOURCE_DEF_XML_DATA_SOURCE, new ConcurrencyManagedCDIBeansBindingProcessor());
        processorTarget.addDeploymentProcessor(EeExtension.SUBSYSTEM_NAME, Phase.POST_MODULE, Phase.POST_MODULE_RESOURCE_DEF_XML_DATA_SOURCE+1, new ConcurrencyManagedCDIBeansDescriptorProcessor());
    }
