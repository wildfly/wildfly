...
public interface WebMessages {
    ...
    @Message(id = 18062, value = "'%s'attribute with value '%s' cannot be replicated")
    IllegalArgumentException failToReplicateAttribute(String attributeName, Object value);
