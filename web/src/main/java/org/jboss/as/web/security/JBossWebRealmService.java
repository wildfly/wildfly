...
public class JBossWebRealmService implements Service<Realm> {
    ...
    public JBossWebRealmService(DeploymentUnit deploymentUnit, boolean disableJBossAuthorization) {
    ...
    public void start(StartContext context) throws StartException {
        ...
        jbossWebRealm.setDisableJBossAuthorization(disableJBossAuthorization);
