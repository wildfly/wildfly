 ...
 */
class NewWebConnectorMetrics implements ModelQueryOperationHandler, RuntimeOperationHandler {

    static NewWebConnectorMetrics INSTANCE = new NewWebConnectorMetrics();
