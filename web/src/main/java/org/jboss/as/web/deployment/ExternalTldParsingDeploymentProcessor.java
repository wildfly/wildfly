...
public class ExternalTldParsingDeploymentProcessor implements DeploymentUnitProcessor {
    ...
    public void deploy(DeploymentPhaseContext phaseContext) throws DeploymentUnitProcessingException {
        ...
        Set<String> sharedTldUris = new HashSet<String>();
    ...
    private TldMetaData parseTLD(Resource tld)
        ...
        try {
            ...
            throw new DeploymentUnitProcessingException(WebMessages.MESSAGES.failToParseXMLDescriptor(tld.getName(), e.getLocation().getLineNumber(),
                    e.getLocation().getColumnNumber()), e);
        } catch (IOException e) {
            throw new DeploymentUnitProcessingException(WebMessages.MESSAGES.failToParseXMLDescriptor(tld.getName()), e);
        } finally {
            try {
                if (is != null) {
                    is.close();
