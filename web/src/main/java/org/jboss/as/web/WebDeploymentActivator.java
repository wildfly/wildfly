...
class WebDeploymentActivator {
    ...
    static void activate(final String defaultHost, final BatchBuilder batchBuilder) {
        ...
        addDeploymentProcessor(batchBuilder, new WarStructureDeploymentProcessor(), WarStructureDeploymentProcessor.PRIORITY);
