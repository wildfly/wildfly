...
public class PersistenceUnitReferenceMetaDataParser extends MetaDataElementParser {
    ...
    public static PersistenceUnitReferenceMetaData parse(XMLStreamReader reader) throws XMLStreamException {
