...
public class ClusteredSessionUnitTestCase {
    ...
    public void testNewSessionIsOutdated() throws Exception {
        ...
        DistributableSessionManager<?> mgr = new DistributableSessionManager<>(new MockDistributedCacheManagerFactory(), SessionTestUtil.createWebMetaData(10), new ContextClassResolver());
