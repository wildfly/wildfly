...
public interface DomainManagementMessages {
    ...
    /**
     * StartException to indicate a failure when closing result set and the database connection
     *
     * @param e - exception
     * @return an {@link StartException} for the failure.
     */
    @Message(id = 15272, value = "Failed to lookup datasource %s")
    StartException datasourceLookupException(@Cause Throwable e, String name);
