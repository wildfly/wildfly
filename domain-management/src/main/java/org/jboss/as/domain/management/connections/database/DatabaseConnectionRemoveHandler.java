...
/**
 * Handler for removing database management connections.
 *
 * @author <a href="mailto:flemming.harms@gmail.com">Flemming Harms</a>
 */
public class DatabaseConnectionRemoveHandler extends AbstractRemoveStepHandler {

    public static final DatabaseConnectionRemoveHandler INSTANCE = new DatabaseConnectionRemoveHandler();

    private DatabaseConnectionRemoveHandler() {
    }
    ...
    protected void recoverServices(OperationContext context, ModelNode operation, ModelNode model) throws OperationFailedException {
        ...
        if (controller != null) {
            ...
            DatabaseConnectionAddHandler.INSTANCE.performRuntime(context, operation, model, null, null);
        }
    }
}
