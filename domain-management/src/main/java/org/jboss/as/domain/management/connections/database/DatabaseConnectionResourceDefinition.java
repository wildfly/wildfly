...
public class DatabaseConnectionResourceDefinition extends SimpleResourceDefinition {
    ...
    public static final SimpleAttributeDefinition DATA_SOURCE = new SimpleAttributeDefinitionBuilder(ModelDescriptionConstants.DATA_SOURCE, ModelType.STRING, true)
            ...
            .setXmlName("ref").build();

    public static final SimpleAttributeDefinition DATABASE_URL = new SimpleAttributeDefinitionBuilder(ModelDescriptionConstants.CONNECTION_URL, ModelType.STRING, true)
        .setValidator(new StringLengthValidator(1, Integer.MAX_VALUE, true, false))
        .setFlags(AttributeAccess.Flag.RESTART_RESOURCE_SERVICES).build();

    public static final SimpleAttributeDefinition DATABASE_DRIVE = new SimpleAttributeDefinitionBuilder(ModelDescriptionConstants.DRIVER_CLASS, ModelType.STRING, true)
        .setValidator(new StringLengthValidator(1, Integer.MAX_VALUE, true, false))
        .setFlags(AttributeAccess.Flag.RESTART_RESOURCE_SERVICES).build();
