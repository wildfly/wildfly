...
/**
 * An internal registry of currently available {@link LdapConnectionManagerService} instances.
 *
...
class LdapConnectionManagerRegistry {
    ...
    synchronized void addLdapConnectionManagerService(final String name, final LdapConnectionManagerService service) {
        Map<String, LdapConnectionManagerService> connectionManagerServices = this.connectionManagerServices;

        connectionManagerServices = new HashMap<>(connectionManagerServices);
    ...
    synchronized void removeLdapConnectionManagerService(final String name) {
        Map<String, LdapConnectionManagerService> connectionManagerServices = this.connectionManagerServices;
    ...
    Collection<LdapConnectionManagerService> availableServices() {
        return connectionManagerServices.values();
    }
