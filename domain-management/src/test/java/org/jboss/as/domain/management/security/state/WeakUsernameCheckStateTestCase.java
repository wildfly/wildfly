...
/**
 * Test the username weakness
 *
 * @author <a href="mailto:flemming.harms@gmail.com">Flemming Harms</a>
 */
public class WeakUsernameCheckStateTestCase extends PropertyTestHelper {

    @Test
    public void testState() throws IOException, StartException {

        WeakUsernameCheckState weakUsernameCheckState = new WeakUsernameCheckState(consoleMock, values);

        AssertConsoleBuilder consoleBuilder = new AssertConsoleBuilder();
        consoleMock.setResponses(consoleBuilder);

        State promptPasswordState = weakUsernameCheckState.execute();
    ...
    public void testUsernameNotAlphaNumeric() {
        ...
        State errorState = weakUsernameCheckState.execute();
    ...
    public void testBadUsername() {
        ...
        for (String userName : BAD_USER_NAMES) {
            ...
            State confirmationChoice = weakUsernameCheckState.execute();
