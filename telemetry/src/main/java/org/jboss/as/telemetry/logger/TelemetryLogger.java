...
import src.main.java.org.jboss.as.jdr.logger.Throwable;
...
public interface TelemetryLogger extends BasicLogger {
     ...
     */
    TelemetryLogger ROOT_LOGGER = Logger.getMessageLogger(TelemetryLogger.class, "org.jboss.as.telemetry.extension");
    ...
    String couldNotGenerateJdr(@Cause Throwable cause);
    ...
    String threadInterrupted(@Cause Throwable cause);
    
    /**
     * Frequency was updated to given value
     * 
     * @param var new frequency value
     */
    @LogMessage(level = INFO)
    @Message(id = 3, value="Frequency of Telemetry Subsystem updated to %l")
    String frequencyUpdated(long var);
    ...
    String couldNotCreateEditPropertiesFile(@Cause Throwable cause);
    ...
    String couldNotClosePropertiesFile(@Cause Throwable cause);
    ...
    String couldNotLoadPropertiesFile(@Cause Throwable cause);
    ...
    String couldNotRegisterSystem(@Cause Throwable cause);
    ...
    String couldNotUploadJdr(@Cause Throwable cause);
    ...
    String couldNotFindJdr(@Cause Throwable cause);    
    ...
    String couldNotStartThread(@Cause Throwable cause);
    ...
    String couldNotFindSystem(@Cause Throwable cause);
}