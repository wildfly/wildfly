...
public class CommandContextFactoryImpl extends CommandContextFactory {
    ...
    public CommandContext newCommandContext(String controllerHost,
        ...
        final CommandContext ctx = new CommandContextImpl(controllerHost, controllerPort, username, password, false, initConsole, connectionTimeout);
        addShutdownHook(ctx);
        return ctx;
    }
    ...
    public CommandContext newCommandContext(String controllerHost, int controllerPort,
            ...
            throws CliInitializationException {
        final CommandContext ctx = new CommandContextImpl(controllerHost, controllerPort, username, password, disableLocalAuth, initConsole, connectionTimeout);
        addShutdownHook(ctx);
        return ctx;
    }
