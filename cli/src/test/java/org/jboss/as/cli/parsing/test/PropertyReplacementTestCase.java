...
public class PropertyReplacementTestCase {
    ...
    public static void setup() {
        SecurityActions.setSystemProperty(NODE_TYPE_PROP_NAME, NODE_TYPE_PROP_VALUE);
        SecurityActions.setSystemProperty(NODE_NAME_PROP_NAME, NODE_NAME_PROP_VALUE);
        SecurityActions.setSystemProperty(OP_PROP_NAME, OP_PROP_VALUE);
        SecurityActions.setSystemProperty(OP_PROP_PROP_NAME, OP_PROP_PROP_VALUE);
    }

    @AfterClass
    public static void cleanup() {
        SecurityActions.clearSystemProperty(NODE_TYPE_PROP_NAME);
        SecurityActions.clearSystemProperty(NODE_NAME_PROP_NAME);
        SecurityActions.clearSystemProperty(OP_PROP_NAME);
        SecurityActions.clearSystemProperty(OP_PROP_PROP_NAME);
    }
