...
public abstract class ServerGroupJvmEnvironmentVariablesTestBase extends DomainModelElementTestBase {
    ...
    public void testBasicProperties() throws Exception {
        String fullcontent = getFullContent("<environment-variables><variable name=\"prop1\" value=\"value1\"/><variable name=\"prop2\" value=\"value2\"/></environment-variables>");
    ...
    public void testNullProperties() throws Exception {
        String fullcontent = getFullContent("<environment-variables><variable name=\"prop1\"/><variable name=\"prop2\"/></environment-variables>");
        PropertiesElement testee = getTestProperties(fullcontent);
        Map<String, String> props = testee.getProperties();
        assertEquals(2, props.size());
    ...
    public void testMissingName() throws Exception {
        String fullcontent = getFullContent("<environment-variables><variable value=\"value1\"/></environment-variables>");
    ...
    public void testBogusAttribute() throws Exception {
        String fullcontent = getFullContent("<environment-variables><variable name=\"prop1\" value=\"value1\" bogus=\"bad\"/></environment-variables>");
    ...
    public void testBogusChild() throws Exception {
        String fullcontent = getFullContent("<environment-variables><variable name=\"prop1\" value=\"value1\"/><variable name=\"prop1\" value=\"value1\"/></environment-variables>");
    ...
    public void testNoChildren() throws Exception {
        String fullcontent = getFullContent("<environment-variables/>");
