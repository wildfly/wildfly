 ...
 * @author Kabir Khan
 */
public class JvmSystemPropertiesTestCommon extends Assert {

    final ContentAndPropertiesGetter getter;

    /**
     * @param name
     */
    public JvmSystemPropertiesTestCommon(ContentAndPropertiesGetter getter) {
        this.getter = getter;
    }


    public void testBasicProperties() throws Exception {
        String fullcontent = getter.getFullContent("<system-properties><property name=\"prop1\" value=\"value1\"/><property name=\"prop2\" value=\"value2\"/></system-properties>");
    ...
    public void testNullProperties() throws Exception {
        String fullcontent = getter.getFullContent("<system-properties><property name=\"prop1\"/><property name=\"prop2\"/></system-properties>");
        PropertiesElement testee = getter.getTestProperties(fullcontent);
        Map<String, String> props = testee.getProperties();
        assertEquals(2, props.size());
    ...
    public void testMissingName() throws Exception {
        String fullcontent = getter.getFullContent("<system-properties><property value=\"value1\"/></system-properties>");

        try {
            ModelParsingSupport.parseDomainModel(getter.getXMLMapper(), fullcontent);
    ...
    public void testBogusAttribute() throws Exception {
        String fullcontent = getter.getFullContent("<system-properties><property name=\"prop1\" value=\"value1\" bogus=\"bad\"/></system-properties>");
    ...
    public void testBogusChild() throws Exception {
        String fullcontent = getter.getFullContent("<system-properties><property name=\"prop1\" value=\"value1\"/><property name=\"prop1\" value=\"value1\"/></system-properties>");
    ...
    public void testNoChildren() throws Exception {
        String fullcontent = getter.getFullContent("<system-properties/>");
    ...
    abstract static class ContentAndPropertiesGetter {
