 ...
 */
public abstract class DomainSystemPropertiesElementTestBase extends DomainModelElementTestBase {

    /**
     * @param name
     */
    public DomainSystemPropertiesElementTestBase(String name) {
        super(name);
    }
    ...
    private PropertiesElement getTestProperties(String fullcontent) throws XMLStreamException, FactoryConfigurationError,
        ...
        PropertiesElement testee = root.getSystemProperties();
