...
/**
 * Base class for unit tests of {@link PropertiesElement} directly under <domain/>.
 *
 * @author Brian Stansberry
 */
public abstract class ServerGroupSystemPropertiesElementTestBase extends DomainModelElementTestBase {

    /**
     * @param name
     */
    public ServerGroupSystemPropertiesElementTestBase(String name) {
        super(name);
    }
    ...
    public void testBogusChild() throws Exception {
        String fullcontent = getFullContent("<system-properties><property name=\"prop1\" value=\"value1\"/><variable name=\"prop1\" value=\"value1\"/></system-properties>");
    ...
    private PropertiesElement getTestProperties(String fullcontent) throws XMLStreamException, FactoryConfigurationError,
        ...
        assertNotNull(sge);
        PropertiesElement testee = sge.getSystemProperties();
