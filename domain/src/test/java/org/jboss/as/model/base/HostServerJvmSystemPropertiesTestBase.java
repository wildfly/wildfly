 ...
 */
public abstract class HostServerJvmSystemPropertiesTestBase extends DomainModelElementTestBase {
     ...
     * @param name
     */
    public HostServerJvmSystemPropertiesTestBase(String name) {
        super(name);
    }
