...
public final class ServerModelManagementSocketThreadsUpdate extends AbstractServerModelUpdate<Void> {
     ...
     */
    public ServerModelManagementSocketThreadsUpdate(final int maxThreads) {
    ...
    /** {@inheritDoc} */
    @Override
    public ServerModelManagementSocketThreadsUpdate getCompensatingUpdate(final ServerModel original) {
