...
/**
 * Update to remove a {@link JvmElement} from a {@link ServerGroupElement}.
 *
 * @author Brian Stansberry
 */
public class ServerGroupJvmRemove extends AbstractModelUpdate<ServerGroupElement, Void> {

    private static final long serialVersionUID = -5766717739615737224L;

    public ServerGroupJvmRemove() {
    }

    @Override
    public ServerGroupJvmAdd getCompensatingUpdate(ServerGroupElement original) {
        JvmElement jvm = original.getJvm();
        return jvm == null ? null : new ServerGroupJvmAdd(jvm.getName());
    }
