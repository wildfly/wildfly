...
public final class ServerNamespaceUpdate extends AbstractServerModelUpdate<Void> {
     ...
     */
    public ServerNamespaceUpdate(final List<NamespacePrefix> prefixes) {
    ...
    /** {@inheritDoc} */
    public ServerNamespaceUpdate getCompensatingUpdate(final ServerModel original) {
        return new ServerNamespaceUpdate(original.getPrefixes());
    }
}
