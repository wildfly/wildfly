...
public class ProfileElement extends AbstractModelElement<ProfileElement> {
    ...
    private final NavigableMap<String, AbstractSubsystemElement<? extends AbstractSubsystemElement>> subsystems = new TreeMap<String, AbstractSubsystemElement<? extends AbstractSubsystemElement>>();
    ...
    protected void appendDifference(Collection<AbstractModelUpdate<ProfileElement>> target, ProfileElement other) {
        ...
        calculateDifference(
                ...
                subsystems,
                other.subsystems,
                new DifferenceHandler<String, AbstractSubsystemElement<? extends AbstractSubsystemElement>, ProfileElement>() {
                    public void handleAdd(final Collection<AbstractModelUpdate<ProfileElement>> target,
                            final String name,
