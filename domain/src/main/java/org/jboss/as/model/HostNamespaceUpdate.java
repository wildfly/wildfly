...
/**
 * An update which changes the namespace prefixes on a host element.
 *
 * @author <a href="mailto:david.lloyd@redhat.com">David M. Lloyd</a>
 */
public final class HostNamespaceUpdate extends AbstractHostModelUpdate<Void> {
     ...
     */
    public HostNamespaceUpdate(final List<NamespacePrefix> prefixes) {
