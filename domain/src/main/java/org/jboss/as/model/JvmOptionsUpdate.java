...
/**
 * Updates a {@link JvmElement}'s {@link JvmElement#getJvmOptions() jvm options}.
 *
 * @author Kabir Khan
 */
public class JvmOptionsUpdate extends AbstractModelUpdate<JvmElement, Void> {
    ...
    public JvmOptionsUpdate(final AbstractJvmOptionsUpdate optionUpdate) {
        this.optionUpdate = optionUpdate;
    }

    @Override
    public AbstractModelUpdate<JvmElement, ?> getCompensatingUpdate(JvmElement original) {
        AbstractJvmOptionsUpdate update = optionUpdate.getCompensatingUpdate(original.getJvmOptions());
        if (update == null) {
            return null;
        }
        return new JvmOptionsUpdate(update);
    }
    ...
    protected void applyUpdate(JvmElement element) throws UpdateFailedException {
        optionUpdate.applyUpdate(element.getJvmOptions());
    }
