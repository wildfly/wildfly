...
/**
 * Indicates that if a network interface satisfies none of a set of nested 
 * criteria, it may be used.
 * 
 * @author Brian Stansberry
 */
public class NotCriteriaElement extends AbstractInterfaceCriteriaElement<NotCriteriaElement> {
    ...
    /**
     * Creates a new NotCriteriaElement by parsing an xml stream
     * 
     * @param reader stream reader used to read the xml
     * @throws XMLStreamException if an error occurs
     */
    public NotCriteriaElement(XMLExtendedStreamReader reader) throws XMLStreamException {
        super(reader, Element.NOT);
    }
    ...
    @Override
    protected void appendDifference(Collection<AbstractModelUpdate<NotCriteriaElement>> target, NotCriteriaElement other) {
        // FIXME implement appendDifference
        throw new UnsupportedOperationException("implement me");
    }

    @Override
    protected Class<NotCriteriaElement> getElementClass() {
        return NotCriteriaElement.class;
    }
