...
public final class Phase {
    ...
    public static final int WAR_DEPLOYMENT_INITIALIZING_PROCESSOR   = STRUCTURE + 0x200;
    ...
    public static final int MODULE_CONFIG_PROCESSOR                 = MODULARIZE + 0x100;
    public static final int WAR_MODULE_CONFIG_PROCESSOR             = MODULARIZE + 0x200;
