...
public class CoreModelTestDelegate {
    ...
    protected KernelServicesBuilder createKernelServicesBuilder(Type type) {
    ...
    private class KernelServicesBuilderImpl implements KernelServicesBuilder, ModelTestBootOperationsBuilder.BootOperationParser {
        ...
        public KernelServicesBuilderImpl(Type type) {
            this.type = type;
            this.processType = type == Type.HOST || type == Type.DOMAIN ? ProcessType.HOST_CONTROLLER : ProcessType.STANDALONE_SERVER;
