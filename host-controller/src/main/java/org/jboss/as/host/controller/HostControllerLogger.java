...
public interface HostControllerLogger extends BasicLogger {
     ...
     */
    @LogMessage(level = Level.WARN)
    @Message(id=16533, value = "Could not connect to master. Trying another domain controller discovery option. Error was: %s")
     ...
     */
    @LogMessage(level = Level.WARN)
    @Message(id=16534, value = "Could not connect to master. No domain controller discovery options left. Error was: %s")
     ...
     */
    @LogMessage(level = Level.ERROR)
    @Message(id=16535, value = "Could not write domain controller data to S3 file. Error was: %s")
     ...
     */
    @LogMessage(level = Level.ERROR)
    @Message(id=16536, value = "Could not remove S3 file. Error was: %s")
