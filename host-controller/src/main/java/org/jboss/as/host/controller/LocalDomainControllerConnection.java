...
public class LocalDomainControllerConnection implements DomainControllerConnection, Service<DomainControllerConnection> {
     ...
     */
    public LocalDomainControllerConnection(final HostController hostController, final DomainController domainController, final FileRepository fileRepository) {
        this.domainController = domainController;
        client = new LocalDomainControllerClient(hostController);
