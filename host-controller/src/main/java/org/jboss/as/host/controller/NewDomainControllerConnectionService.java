 ...
 */
public class NewDomainControllerConnectionService implements Service<DomainControllerConnection> {
    ...
    public NewDomainControllerConnectionService(final NewHostController hostController, final FileRepository localRepository, final long connectTimeout) {
