 ...
 * @author John Bailey
 */
public class ServerToHostControllerOperationHandler extends AbstractMessageHandler implements ManagementOperationHandler {
    ...
    public ServerToHostControllerOperationHandler(HostController hostController) {
    ...
    private class ServerRegisterCommand extends ManagementResponse {
        ...
        protected void readRequest(final InputStream input) throws IOException {
            ...
            final HostController hostController = ServerToHostControllerOperationHandler.this.hostController;
