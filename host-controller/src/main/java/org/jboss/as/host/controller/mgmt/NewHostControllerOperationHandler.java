 ...
 * @author John Bailey
 */
public class NewHostControllerOperationHandler extends AbstractMessageHandler implements ManagementOperationHandler {
    ...
    public NewHostControllerOperationHandler(NewHostController hostController) {
