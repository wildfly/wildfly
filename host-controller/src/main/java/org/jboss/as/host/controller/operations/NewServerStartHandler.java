 ...
 */
public class NewServerStartHandler implements OperationStepHandler, DescriptionProvider {
     ...
     */
    public NewServerStartHandler(final NewServerInventory serverInventory) {
