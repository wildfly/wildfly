 ...
 * @author Kabir Khan
   */
public class NewServerInventory implements ManagedServerLifecycleCallback {
    ...
    private volatile NewDomainController domainController;
    private volatile CountDownLatch processInventoryLatch;
    private volatile Map<String, ProcessInfo> processInfos;

    NewServerInventory(final HostControllerEnvironment environment, final InetSocketAddress managementAddress, final ProcessControllerClient processControllerClient) {
    ...
    void setDomainController(final NewDomainController domainController) {
