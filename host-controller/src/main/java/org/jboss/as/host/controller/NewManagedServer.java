 ...
 */
class NewManagedServer implements ModelController {
    ...
    static {
        ...
        final ClassLoader cl = NewManagedServer.class.getClassLoader();
    ...
    public NewManagedServer(final String serverName, final ProcessControllerClient processControllerClient,
