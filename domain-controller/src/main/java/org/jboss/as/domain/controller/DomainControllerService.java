...
public final class DomainControllerService implements Service<DomainController> {
    ...
    final boolean backupDomainFiles;
    private DomainControllerSlave controller;

    public DomainControllerService(final ExtensibleConfigurationPersister configurationPersister, final String localHostName, final FileRepository localRepository, final boolean backupDomainFiles) {
