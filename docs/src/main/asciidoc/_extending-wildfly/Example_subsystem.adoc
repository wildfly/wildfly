...
Or you can use API that helps you do that for you. `SimpleOperationDefinitionBuilder` 
...
We then need a register all the operation for the `type` part of the model
itself, so we modify TypeDefinitnion to extend SimpleResourceDefinition
