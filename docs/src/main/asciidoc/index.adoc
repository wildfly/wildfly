...
* The link:Quickstarts{outfilesuffix}[WildFly Quickstarts] describes how to use the WildFly examples, which introduce a particular technology or feature of the application server.
