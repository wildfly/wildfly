...
|<<jaas-security-realm,jaas-realm>> |A security realm definition that uses JAAS configuration file to initialize LoginContext that is used to verify credentials.
|=======================================================================
