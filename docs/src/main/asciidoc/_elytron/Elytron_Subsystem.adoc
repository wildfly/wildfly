...
|properties-role-mapper |A role mapper definition for a role mapper that
performs matching and maps matching roles with provided property file.
|=======================================================================
...
/subsystem=elytron:read-resource(recursive=true)
{
    ...
    "result" => {
        ...
        "properties-role-mapper" => undefined,
