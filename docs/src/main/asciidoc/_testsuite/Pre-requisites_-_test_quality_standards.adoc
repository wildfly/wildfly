...
When testing behavior mandated by specifications but not immediately obvious, include comments explaining the requirement (e.g., "Verifies Jakarta Persistence X.Y.Z - Description of requirement").
