...
== Jira account
Create an account for Red Hat's Jira [https://redhat.atlassian.net/] Choose "Sign up"

NOTE: After creating your account, you must log in at https://redhat.atlassian.net/jira/for-you with your personal account to properly authenticate with Red Hat Jira before you can create issues.
