...
[NOTE]
====
WildFly Preview often (but not always) provides implementations of different versions of the specifications listed above than standard WildFly does. See xref:WildFly_and_WildFly_Preview.adoc#wildfly-preview-ee[EE Support in WildFly Preview] for current details.
====
