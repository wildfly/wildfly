...
[cols=",,,,",options="header"]
|=======================================================================
|Jakarta EE Platform Technology |Jakarta EE Full Profile |Jakarta EE Web
...
* standalone-full.xml
** Jakarta full profile certified configuration
including all the required technologies

* standalone-full-ha.xml
** Jakarta full profile certified configuration with
high availability
