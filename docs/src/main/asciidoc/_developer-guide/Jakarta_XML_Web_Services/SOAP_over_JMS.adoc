...
A Jakarta XML Web Services client can interact with the JMS endpoint the usual way:
...
Finally, the Jakarta XML Web Services client can ineract with both JMS and HTTP endpoints
as usual:
