...
https://docs.jboss.org/author/display/AS71/EJB%20invocations%20from%20a%20remote%20client%20using%20JNDI.html[from
...
public void invokeOnBean() {
        try {
            ...
            // Lookup the Greeter bean using the ejb: namespace syntax which is explained here https://docs.jboss.org/author/display/AS71/EJB%20invocations%20from%20a%20remote%20client%20using%20JNDI.html
