...
https://docs.jboss.org/author/display/WFLY8/Remote%20EJB%20invocations%20via%20JNDI%20-%20EJB%20client%20API%20or%20remote-naming%20project.html
...
project at https://docs.jboss.org/author/display/EJBCLIENT/Home.html.
In this document, we'll just concentrate on the traditional JNDI based
invocation on EJBs. So let's get started:
