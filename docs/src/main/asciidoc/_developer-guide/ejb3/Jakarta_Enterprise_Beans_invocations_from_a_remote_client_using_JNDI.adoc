...
In this document, we'll concentrate on the traditional JNDI based invocation on EJBs. So let's get started:
...
* The EE platform allows you to override the application name, to a name of
...
* The EE platform allows you to override the module name, by setting it in the
