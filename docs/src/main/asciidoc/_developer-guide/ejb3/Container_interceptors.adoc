...
interceptors differed from the typical (portable) spec provided EE
...
5.  User application specific EE interceptor(s) (if any)
...
As you can see from the JIRA https://redhat.atlassian.net/browse/AS7-5897,
