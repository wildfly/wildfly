...
|hibernate.id.new_generator_mappings can no longer be set to false by applications as per Hibernate 6 change to only support hibernate.id.new_generator_mappings=true.
