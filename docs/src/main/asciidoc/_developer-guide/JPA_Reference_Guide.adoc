...
|Hibernate51CompatibilityTransformer.excludeClasses| set to comma separated list of class names to exclude, you may also add a partial matching class name (or package) by including '\*' at end of name.
  For example, -DHibernate51CompatibilityTransformer.excludeClasses=org.acme.mypackage*,com.acme.mypackage*,com.other.specific.package.MyClassName|null
| 
----
----
