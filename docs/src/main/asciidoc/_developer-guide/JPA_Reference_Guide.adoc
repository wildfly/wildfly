...
*wildfly.jpa.hibernate.search.module=org.hibernate.search.orm:5.11.0.Alpha1*
to use the experimental version 5.11.0.Alpha1 instead of the provided
...
== Using latest Hibernate ORM within WildFly
https://docs.jboss.org/hibernate/orm/5.3/topical/html_single/wildfly/Wildfly.html[Read about Hibernate ORM feature packs here].
