...
The default settings for interfaces in this file are:
...
We also need to add the native management interface in the management-interfaces section.
The default section for management-interfaces is
...
We need to add the native-interface.
