...
For advanced configuration options, please visit https://github.com/jgroups-extras/jgroups-aws/tree/4.0.0.Final#readme[protocol's documentation on GitHub].
