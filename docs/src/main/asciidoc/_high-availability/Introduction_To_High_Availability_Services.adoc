...
* *fail-over:* allows a client interacting with an EE application to
...
failures. For example, consider an EE application which makes use of
...
Hibernate), we organize the discussion around those EE features. We
