...
Currently, the default configuration does not include the Jakarta Messagin subsystem.
To enable Jakarta Messagin in the standalone server you need to add these
