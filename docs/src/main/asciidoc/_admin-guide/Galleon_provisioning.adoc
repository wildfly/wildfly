...
* _web-clustering_: Expands on _web-server_ (layer defined in the WildFly servlet feature-pack) to include embedded Infinispan-based distributed web session caching.
