...
an `<extension module="org.wildfly.extension.microprofile.opentracing"/>`
element to the xml or by using the following CLI operation:

[source]
----
[standalone@localhost:9990 /] /extension=org.wildfly.extension.microprofile.opentracing:add
{"outcome" => "success"}

[standalone@localhost:9990 /] /subsystem=microprofile-opentracing:add
{
    "outcome" => "success",
    "response-headers" => {
