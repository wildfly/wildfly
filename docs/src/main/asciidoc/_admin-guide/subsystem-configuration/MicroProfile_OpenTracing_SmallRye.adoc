...
WildFly's MicroProfile OpenTracing subsystem implements MicroProfile 1.3, which includes support for tracing JAX-RS and Jakarta Contexts and Dependency Injection.
...
JAX-RS application with no Jakarta Contexts and Dependency Injection support will *not* be traced.
