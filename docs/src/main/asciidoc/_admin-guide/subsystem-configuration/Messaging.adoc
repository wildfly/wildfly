...
Since Jakarta Messaging 2.0, a default Jakarta Messaging connection factory is accessible to EE
...
Jakarta Messaging servers, as long as they are JMS 1.1 compliant.
