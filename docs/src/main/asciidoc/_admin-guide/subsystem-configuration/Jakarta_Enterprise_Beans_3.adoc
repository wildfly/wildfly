...
in the distributable-ejb subsystem. If the attribute is non-defined, the default bean management provider
defined in the distributable-ejb subsystem is used (infinispan-bean-manager).
