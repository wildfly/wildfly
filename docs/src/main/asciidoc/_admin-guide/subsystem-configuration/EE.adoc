...
include::EE_Application_Deployment_Configuration.adoc[leveloffset=+1]

include::EE_Concurrency_Utilities_Configuration.adoc[leveloffset=+1]

include::EE_Default_Bindings_Configuration.adoc[leveloffset=+1]
