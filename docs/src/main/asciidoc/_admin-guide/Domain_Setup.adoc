...
----
<domain-controller>
   <remote protocol="remote" host="192.168.0.101" port="9999" authentication-context="slaveHostAContext"/>
</domain-controller>
----
...
----
<domain-controller>
   <remote protocol="http-remoting" host="192.168.0.101" port="9990" username="slave" authentication-context="slaveHostAContext"/>
</domain-controller>
----
...
----
<domain-controller>
    <remote authentication-context="slaveHostAContext" ignore-unused-configuration="false">
        <discovery-options>
...
----
<domain-controller>
    <remote authentication-context="slaveHostAContext" ignore-unused-configuration="true">
