...
public final class ProcessManagerSlaveFactory {
    ...
    public ProcessManagerSlave getProcessManagerSlave(ServerManagerBootstrapConfig bootstrapConfig, Host host, MessageHandler handler) {
        ...
        return new ProcessManagerSlave(System.in, System.out, handler);
    }
