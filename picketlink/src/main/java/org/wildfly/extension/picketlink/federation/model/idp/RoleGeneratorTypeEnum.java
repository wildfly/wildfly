...
import org.picketlink.identity.federation.bindings.jboss.roles.JBossWebRoleGenerator;
...
public enum RoleGeneratorTypeEnum {
    ...
    TOMCAT_ROLE_GENERATOR("TomcatRoleGenerator", TomcatRoleGenerator.class.getName()),
    JBOSS_WEB_ROLE_GENERATOR("JBossWebRoleGenerator", JBossWebRoleGenerator.class.getName()),
    DEFAULT_ROLE_GENERATOR("DefaultRoleGenerator", DefaultRoleGenerator.class.getName()),
