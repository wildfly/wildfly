...
import org.wildfly.extension.picketlink.federation.model.parser.FederationSubsystemReader_1_1;
...
public enum Namespace {
    ...
    PICKETLINK_FEDERATION_1_1(1, 1, 0, new FederationSubsystemReader_1_1(), FederationSubsystemWriter.INSTANCE);

    public static final Namespace CURRENT = PICKETLINK_FEDERATION_1_1;
