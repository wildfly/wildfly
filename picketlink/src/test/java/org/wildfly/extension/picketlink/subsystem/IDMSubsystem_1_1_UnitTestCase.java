 ...
 * @author Pedro Igor
 */
public class IDMSubsystem_1_1_UnitTestCase extends AbstractSubsystemBaseTest {

    public IDMSubsystem_1_1_UnitTestCase() {
        super(IDMExtension.SUBSYSTEM_NAME, new IDMExtension());
    }

    @Override
    protected String getSubsystemXml() throws IOException {
        return readResource("identity-management-subsystem-1.1.xml");
    }
    ...
    public void testExpressions() throws Exception {
        standardSubsystemTest("identity-management-subsystem-expressions-1.1.xml");
    }
