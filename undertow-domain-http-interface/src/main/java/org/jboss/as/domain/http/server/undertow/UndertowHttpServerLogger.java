...
public interface UndertowHttpServerLogger extends BasicLogger {
    UndertowHttpServerLogger ROOT_LOGGER = Logger.getMessageLogger(UndertowHttpServerLogger.class, "org.jboss.as.domain.http.api.undertow");
