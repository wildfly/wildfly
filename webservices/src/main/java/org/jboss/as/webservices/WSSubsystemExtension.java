 ...
 *
 */
public class WSSubsystemExtension implements Extension {
    private static final Logger log = Logger.getLogger("org.jboss.as.webservices");

    /** {@inheritDoc} */
    public void initialize(final ExtensionContext context) {
        log.info("Initializing WebServices Extension");
        context.registerSubsystem(Namespace.CURRENT.getUriString(), WSSubsystemParser.getInstance());
    }
