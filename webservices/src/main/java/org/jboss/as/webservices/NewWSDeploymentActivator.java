 ...
 * @since 12-Jan-2011
 */
class NewWSDeploymentActivator {

    static void activate(final NewBootOperationContext updateContext) {
        ...
        addDeploymentProcessors(NewWSDeploymentActivator.class.getClassLoader(), updateContext, priority);
    }

    private static void addDeploymentProcessors(final ClassLoader cl, final NewBootOperationContext updateContext, int priority) {
        try {
