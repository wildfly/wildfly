 ...
 */
final class EndpointConfigFeatureAdd extends AbstractAddStepHandler {

    static final EndpointConfigFeatureAdd INSTANCE = new EndpointConfigFeatureAdd();

    private EndpointConfigFeatureAdd() {}
        ...
        if (configService != null) {
            ...
            for (final EndpointConfig endpointConfig : config.getEndpointConfigs()) {
                if (configName.equals(endpointConfig.getConfigName())) {
                    endpointConfig.setFeature(new Feature(featureName), true);
