...
public class EndpointConfigService implements Service<ConfigRoot> {
    ...
    private EndpointConfigService(final ConfigRoot config) {
        this.configRoot = config;
    }

    @Override
    public ConfigRoot getValue() {
        return configRoot;
    }

    @Override
    public void start(final StartContext context) throws StartException {
        /*log.tracef("Starting %s", EndpointConfigService.class.getName());
        try {
            serverConfig.create();
