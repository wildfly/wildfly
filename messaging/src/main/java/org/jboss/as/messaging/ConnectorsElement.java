...
public class ConnectorsElement extends AbstractModelElement<ConnectorsElement> implements ServiceActivator {
   ...
   public ConnectorsElement(final Location location) {
      super(location);
   }
   ...
   @Override
   protected void appendDifference(Collection<AbstractModelUpdate<ConnectorsElement>> target, ConnectorsElement other) {
