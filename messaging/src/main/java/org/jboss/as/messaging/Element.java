...
enum Element {
   ...
   DEAD_LETTER_ADDRESS_NODE_NAME(CommonAttributes.DEAD_LETTER_ADDRESS_NODE_NAME),
   EXPIRY_ADDRESS_NODE_NAME(CommonAttributes.EXPIRY_ADDRESS_NODE_NAME),
   REDELIVERY_DELAY_NODE_NAME(CommonAttributes.REDELIVERY_DELAY_NODE_NAME),
   ...
   ADDRESS_FULL_MESSAGE_POLICY_NODE_NAME(CommonAttributes.ADDRESS_FULL_MESSAGE_POLICY_NODE_NAME),
   PAGE_SIZE_BYTES_NODE_NAME(CommonAttributes.PAGE_SIZE_BYTES_NODE_NAME),
   MESSAGE_COUNTER_HISTORY_DAY_LIMIT_NODE_NAME(CommonAttributes.MESSAGE_COUNTER_HISTORY_DAY_LIMIT_NODE_NAME),
   LVQ_NODE_NAME(CommonAttributes.LVQ_NODE_NAME),
   REDISTRIBUTION_DELAY_NODE_NAME(CommonAttributes.REDISTRIBUTION_DELAY_NODE_NAME),
