 ...
 * @author John Bailey
 */
public class SecuritySettingElement extends AbstractModelElement<SecuritySettingElement> {
    private static final long serialVersionUID = 5377595947698534688L;
    private final String match;
    private final Set<Role> roles;

    public SecuritySettingElement(final String match, final Set<Role> roles) {
        this.match = match;
        this.roles = roles;
    }

    protected Class<SecuritySettingElement> getElementClass() {
        return SecuritySettingElement.class;
    }
