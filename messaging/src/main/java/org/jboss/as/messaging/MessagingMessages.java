...
public interface MessagingMessages {
     ...
     * @return the message.
     */
    @Message(value = "Alternative attribute of (%s) is already defined.")
     ...
     */
    @Message(value = "All attribute definitions must have the same xml name -- found %s but already had %s")
     ...
     * @return an {@link IllegalArgumentException} for the error.
     */
    @Message(value = "All attribute definitions must have unique names -- already found %s")
     ...
     * @return an {@link IllegalArgumentException} for the error.
     */
    @Message(value = "Cannot bind a null or empty string as jndi name")
     ...
     * @return the message.
     */
    @Message(value = "Operation cannot include both parameter %s and parameter %s")
     ...
     */
    @Message(value = "%s cannot be marshalled as an attribute; use marshallAsElement")
     ...
     * @return an {@link IllegalArgumentException} for the error.
     */
    @Message(value = "Cannot unbind a null or empty string as jndi name")
     ...
     * @return the message.
     */
    @Message(value = "A child resource of type %1$s already exists; the messaging subsystem only allows a single resource of type %1$s")
     ...
     */
    @Message(value = "connector %s not defined")
     ...
     * @return the message.
     */
    @Message(value = "failed to create %s")
     ...
     */
    @Message(value = "Failed to find SocketBinding for broadcast binding: %s")
     ...
     * @return a {@link StartException} for the error.
     */
    @Message(value = "Failed to find SocketBinding for connector: %s")
     ...
     * @return a {@link StartException} for the error.
     */
    @Message(value = "Failed to find SocketBinding for discovery binding: %s")
     ...
     */
    @Message(value = "Failed to shutdown %s server")
     ...
     * @return a {@link StartException} for the error.
     */
    @Message(value = "Failed to start service")
     ...
     */
    @Message(value = "Ignoring unhandled element: %s, at: %s")
     ...
     * @return the message.
     */
    @Message(value = "Illegal element %s: cannot be used when %s is used")
     ...
     * @return the message.
     */
    @Message(value = "Illegal value %s for element %s")
     ...
     * @return the message.
     */
    @Message(value = "Illegal value %s for element %s as it could not be converted to required type %s")
     ...
     * @return an {@link UnsupportedOperationException} for the error.
     */
    @Message(value = "Resource is immutable")
     ...
     * @return an {@link IllegalStateException} for the error.
     */
    @Message(value = "Attribute %s has unexpected type %s")
     ...
     * @return the message.
     */
    @Message(value = "Operation must include parameter %s or parameter %s")
     ...
     * @return the message.
     */
    @Message(value = "%s is an invalid value for parameter %s. Values must be one of: %s")
     ...
     * @return an {@link IllegalStateException} for the error.
     */
    @Message(value = "Service %s is not in state %s, it is in state %s")
     ...
     * @return the message.
     */
    @Message(value = "JNDI name %s is already registered")
     ...
     * @return an {@link IllegalStateException} for the error.
     */
    @Message(value = "Multiple %s children found; only one is allowed")
     ...
     * @return the message.
     */
    @Message(value = "Either %s or %s is required")
    String required(Object obj1, Object obj2);

    /**
     * A message indicating that at least {@code min} entries should be provided.
     *
     * @param min              the minimum entry value.
     * @param entryDescription the entry description.
     *
     * @return the message.
     */
    @Message(value = "at least %d %s entry should be provided")
    String mustProvideMinimumEntry(int min, String entryDescription);
     ...
     * @return the message.
     */
    @Message(value = "Parameter not defined: %s")
     ...
     * @return the message.
     */
    @Message(value = "No such attribute (%s)")
     ...
     * @return an {@link IllegalStateException} for the error.
     */
    @Message(value = "Read support for attribute %s was not properly implemented")
     ...
     * @return an {@link UnsupportedOperationException} for the error.
     */
    @Message(value = "Implement support for element %s")
     ...
     * @return an {@link IllegalStateException} for the error.
     */
    @Message(value = "Support for operation %s was not properly implemented")
     ...
     * @return an {@link UnsupportedOperationException} for the error.
     */
    @Message(value = "Runtime handling for %s is not implemented")
