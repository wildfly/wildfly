...
import org.hornetq.core.security.HornetQPrinciple;
    ...
    public synchronized void start(StartContext context) throws StartException {
        try {
            ...
            try {
                ...
                jmsServer.start();
                hornetQServer.getValue().getRemotingService().allowInvmSecurityOverride(new HornetQPrinciple(HornetQDefaultCredentials.getUsername(), HornetQDefaultCredentials.getPassword()));
            } finally {
