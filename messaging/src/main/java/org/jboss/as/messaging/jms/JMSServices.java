...
import static org.jboss.as.messaging.jms.CommonAttributes.TRANSACTION_BATH_SIZE;
...
public class JMSServices {
    ...
    static String[] CF_ATTRIBUTES = new String[] { AUTO_GROUP, ENTRIES, BLOCK_ON_ACK, BLOCK_ON_DURABLE_SEND, BLOCK_ON_NON_DURABLE_SEND, CACHE_LARGE_MESSAGE_CLIENT,
        CALL_TIMEOUT, CLIENT_FAILURE_CHECK_PERIOD, CLIENT_ID, CONFIRMATION_WINDOW_SIZE, CONNECTION_TTL, CONSUMER_MAX_RATE, CONSUMER_WINDOW_SIZE, DISCOVERY_GROUP_NAME,
        ...
        PRODUCER_WINDOW_SIZE, RECONNECT_ATTEMPTS, RETRY_INTERVAL, RETRY_INTERVAL_MULTIPLIER, SCHEDULED_THREAD_POOL_MAX_SIZE, THREAD_POOL_MAX_SIZE, TRANSACTION_BATH_SIZE,
        USE_GLOBAL_POOLS,  };
