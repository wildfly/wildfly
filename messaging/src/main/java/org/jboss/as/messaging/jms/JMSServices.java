...
public class JMSServices {
    ...
    public static NodeAttribute[] CONNECTION_FACTORY_ATTRS = new NodeAttribute[] {
        ...
        new NodeAttribute(SCHEDULED_THREAD_POOL_MAX_SIZE.getName(), ModelType.INT, false),
        new NodeAttribute(THREAD_POOL_MAX_SIZE.getName(), ModelType.INT, false),
    ...
    static PooledCFAttribute[] POOLED_CONNECTION_FACTORY_METHOD_ATTRS = new PooledCFAttribute[] {
        ...
        new PooledCFAttribute(SCHEDULED_THREAD_POOL_MAX_SIZE.getName(), Integer.class.getName(), SCHEDULED_THREAD_POOL_MAX_SIZE_METHOD),
        new PooledCFAttribute(THREAD_POOL_MAX_SIZE.getName(), Integer.class.getName(), THREAD_POOL_MAX_SIZE_METHOD),
