...
public class MessagingExtension implements Extension {
    ...
    private static void registerTransformers_1_1_0(final SubsystemRegistration subsystem) {
        ...
        clusterConnection.registerOperationTransformer(ADD, new OperationTransformers.MultipleOperationalTransformer(
                rejectClusterConnectionExpressions,
                new OperationTransformers.RemoveAttributesOperationTransformer(CALL_FAILOVER_TIMEOUT)));
        clusterConnection.registerOperationTransformer(WRITE_ATTRIBUTE_OPERATION, new OperationTransformers.MultipleOperationalTransformer(
        ...
        connectionFactory.registerOperationTransformer(ADD, new OperationTransformers.MultipleOperationalTransformer(
                rejectConnectionFactoryExpressions,
                new OperationTransformers.RemoveAttributesOperationTransformer(CALL_FAILOVER_TIMEOUT)));
        connectionFactory.registerOperationTransformer(WRITE_ATTRIBUTE_OPERATION, new OperationTransformers.MultipleOperationalTransformer(
