...
public interface MessagingLogger extends BasicLogger {
    ...
    @Message(value = "Bound messaging object to jndi name %s")
    ...
    @Message(id = 11601, value = "exception while stopping jms server")
     ...
     */
    @LogMessage(level = WARN)
    @Message(id = 11602, value = "failed to destroy %s: %s")
     ...
     */
    @LogMessage(level = ERROR)
    @Message(value = "%s caught exception attempting to revert operation %s at address %s")
     ...
     */
    @LogMessage(level = INFO)
    @Message(value = "Unbound messaging object to jndi name %s")
