 ...
 *
 */
public class NewQueueAdd implements ModelAddOperationHandler, RuntimeOperationHandler, DescriptionProvider {
    ...
    public static NewQueueAdd INSTANCE = new NewQueueAdd();
    ...
    public Cancellable execute(NewOperationContext context, ModelNode operation, ResultHandler resultHandler) {
        ...
        if (failure == null) {
            ...
            if (context instanceof NewRuntimeOperationContext) {
                ...
                updateContext.getServiceTarget().addService(MessagingSubsystemElement.CORE_QUEUE_BASE.append(name), service)
