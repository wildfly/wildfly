 ...
 *
 */
public class SharedTaskDecoratorScheduledExecutorServiceTestCase extends SharedTaskDecoratorExecutorServiceTestCase {
    ...
    protected void createThreadPoolExecutor() {
        taskDecoratorExecutorService = TestExecutors.newTaskDecoratorScheduledExecutorService();
    }

    protected ComponentManagedExecutorService createServerManagedExecutorService() {
        return TestExecutors.newManagedScheduledExecutorService((TaskDecoratorScheduledExecutorService) taskDecoratorExecutorService);
    }
