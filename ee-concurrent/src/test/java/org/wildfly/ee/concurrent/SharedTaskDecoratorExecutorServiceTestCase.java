 ...
 *
 */
public class SharedTaskDecoratorExecutorServiceTestCase {
    ...
    protected TaskDecoratorExecutorService taskDecoratorExecutorService;
    ...
    protected void createThreadPoolExecutor() {
        taskDecoratorExecutorService = TestExecutors.newTaskDecoratorExecutorService();
    }

    protected ComponentManagedExecutorService createServerManagedExecutorService() {
        return TestExecutors.newManagedExecutorService(taskDecoratorExecutorService);
    }
    ...
    public void testSubmitThreadPoolExecutorSharing() throws Exception {
        ...
        Assert.assertFalse(taskDecoratorExecutorService.isShutdown());
    ...
    protected void shutdownThreadPoolExecutor() throws Exception {
        if (taskDecoratorExecutorService != null) {
            taskDecoratorExecutorService.shutdown();
            if (!taskDecoratorExecutorService.awaitTermination(10, TimeUnit.SECONDS)) {
                fail();
            }
        }
    }
