...
public abstract class JaxrsAttribute {
    ...
    private static final AttributeParser ELEMENT_PARSER = new AttributeParser() {
        @Override
    ...
    private static final AttributeParser MAP_PARSER = new AttributeParser() {
        @Override
        ...
        public void parseElement(final AttributeDefinition attribute, final XMLExtendedStreamReader reader, final ModelNode operation) throws XMLStreamException {
            ...
            handleMap(reader, operation, (PropertiesAttributeDefinition) attribute);
        }
    };
    ...
    public static final SimpleAttributeDefinition JAXRS_2_0_REQUEST_MATCHING = new SimpleAttributeDefinitionBuilder(JaxrsConstants.JAXRS_2_0_REQUEST_MATCHING, ModelType.BOOLEAN)
            ...
            .setAttributeParser(ELEMENT_PARSER)
    ...
    private static void handleMap(final XMLExtendedStreamReader reader,
                                  final ModelNode subsystem,
                                  final PropertiesAttributeDefinition attribute) throws XMLStreamException {
