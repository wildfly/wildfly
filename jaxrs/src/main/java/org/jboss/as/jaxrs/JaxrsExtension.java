...
import org.wildfly.extension.jaxrs.JaxrsSubsystemParser_1_0;
import org.wildfly.extension.jaxrs.JaxrsSubsystemParser_2_0;
import org.wildfly.extension.jaxrs.Namespace;
...
public class JaxrsExtension implements Extension {
    ...
    public static final String NAMESPACE = "urn:jboss:domain:jaxrs:2.0";
    ...
    public static final PathElement SUBSYSTEM_PATH = PathElement.pathElement(
            ModelDescriptionConstants.SUBSYSTEM, SUBSYSTEM_NAME);
    ...
    public static ResourceDescriptionResolver getResolver(final String... keyPrefix) {
        ...
        return new StandardResourceDescriptionResolver(prefix.toString(), RESOURCE_NAME,
                JaxrsExtension.class.getClassLoader(), true, false);
    }
    ...
    public void initialize(final ExtensionContext context) {
        ...
        final ManagementResourceRegistration registration = subsystem.registerSubsystemModel(
                JaxrsSubsystemDefinition.INSTANCE);
        registration.registerOperationHandler(GenericSubsystemDescribeHandler.DEFINITION,
                GenericSubsystemDescribeHandler.INSTANCE);
        ManagementResourceRegistration jaxrsResReg = subsystem.registerDeploymentModel(
                JaxrsDeploymentDefinition.INSTANCE);
    ...
    public void initializeParsers(final ExtensionParsingContext context) {
        context.setSubsystemXmlMapping(SUBSYSTEM_NAME, Namespace.JAXRS_1_0.getUriString(),
                JaxrsSubsystemParser_1_0::new);
        context.setSubsystemXmlMapping(SUBSYSTEM_NAME, Namespace.JAXRS_2_0.getUriString(),
                JaxrsSubsystemParser_2_0::new);
    }
}
