...
public class JaxrsConstants {
    ...
    public static final String RESTEASY_PATCH_FILTER_DISABLED = "resteasy-patchfilter-disabled";
    public static final String RESTEASY_PATCH_FILTER_LEGACY = "resteasy-patchfilter-legacy";
    ...
    public static final String RESTEASY_PROXY_IMPLEMENT_ALL_INTERFACES = "resteasy-proxy-implement-all-interfaces";
    ...
    static {
        ...
        nameToAttributeMap.put(RESTEASY_PROXY_IMPLEMENT_ALL_INTERFACES, JaxrsAttribute.RESTEASY_PROXY_IMPLEMENT_ALL_INTERFACES);
