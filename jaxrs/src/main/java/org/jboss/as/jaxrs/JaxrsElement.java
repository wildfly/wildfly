...
enum JaxrsElement {
    ...
    RESTEASY_MATCH_CACHE_ENABLED(JaxrsConstants.RESTEASY_MATCH_CACHE_ENABLED),
    RESTEASY_MATCH_CACHE_SIZE(JaxrsConstants.RESTEASY_MATCH_CACHE_SIZE),
    ...
    RESTEASY_ORIGINAL_WEBAPPLICATIONEXCEPTION_BEHAVIOR(JaxrsConstants.RESTEASY_ORIGINAL_WEBAPPLICATIONEXCEPTION_BEHAVIOR),
    RESTEASY_PATCH_FILTER_DISABLED(JaxrsConstants.RESTEASY_PATCH_FILTER_DISABLED),
    RESTEASY_PATCH_FILTER_LEGACY(JaxrsConstants.RESTEASY_PATCH_FILTER_LEGACY),
    ...
    RESTEASY_PROXY_IMPLEMENT_ALL_INTERFACES(JaxrsConstants.RESTEASY_PROXY_IMPLEMENT_ALL_INTERFACES),
