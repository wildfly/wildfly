...
/**
 * Jaxrs subsystem has no attributes or child elements.  It is more efficient
 * to implement PersistentResourceXMLParser's interfaces directly than to
 * extend this class from PersistentResourceXMLParser.
 */
public class JaxrsSubsystemParser_1_0 implements XMLStreamConstants,
