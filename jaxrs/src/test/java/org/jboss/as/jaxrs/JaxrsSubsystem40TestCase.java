...
public class JaxrsSubsystem40TestCase extends AbstractSubsystemBaseTest {
    ...
    public void testRejectingTransformersEAP80() throws Exception {
        ...
        testRejectingTransformers27(transformationConfig, ModelTestControllerVersion.EAP_8_0_0);
    }
    ...
    private void testRejectingTransformers27(FailedOperationTransformationConfig transformationConfig, ModelTestControllerVersion controllerVersion) throws Exception {
        ModelVersion subsystemModelVersion = controllerVersion.getSubsystemModelVersion(JaxrsExtension.SUBSYSTEM_NAME);
