...
public class MicrometerTransformerTestCase extends AbstractSubsystemTest {
    private final AdditionalInitialization additionalInitialization = AdditionalInitialization
        .withCapabilities(MicrometerSubsystemSchema.VERSION_2_0,
            "org.wildfly.management.executor",
            "org.wildfly.management.process-state-notifier");
