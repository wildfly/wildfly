...
public enum MicrometerSubsystemSchema implements PersistentSubsystemSchema<MicrometerSubsystemSchema> {
    ...
    VERSION_2_0(2, 0, Stability.DEFAULT), // WildFly 35
    VERSION_2_0_COMMUNITY(2, 0, Stability.COMMUNITY) // WildFly 35
    ;

    public static final Set<MicrometerSubsystemSchema> CURRENT = EnumSet.of(VERSION_2_0, VERSION_2_0_COMMUNITY);
    ...
    public PersistentResourceXMLDescription getXMLDescription() {
        ...
        if (this.since(VERSION_2_0_COMMUNITY)) {
            builder.addChild(factory.builder(RESOURCE_REGISTRATION)
