...
//            .end();
        ...
        builder.setCustomResourceTransformer(new ResourceTransformer() {
            ...
            public void transformResource(ResourceTransformationContext context, PathAddress address, Resource resource) {
                ...
                // TODO I am not sure what happens here, if there were other children which should be included
                // Normally there seems to be a call to context.processChildren() or for each child individually
            }
        });
