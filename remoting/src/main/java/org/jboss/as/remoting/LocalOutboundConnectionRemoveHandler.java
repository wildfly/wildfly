 ...
 * @author Jaikiran Pai
 */
class LocalOutboundConnectionRemoveHandler extends AbstractRemoveStepHandler {

    static final LocalOutboundConnectionRemoveHandler INSTANCE = new LocalOutboundConnectionRemoveHandler();

    private LocalOutboundConnectionRemoveHandler() {
