...
public class DatasourcesTransformerTestCase extends AbstractSubsystemBaseTest {

    public DatasourcesTransformerTestCase() {
    ...
    public void testRejectionsEAP74() throws Exception {
        testTransformerEAP74Rejection("datasources-validation-custom-modules-timeout-reject.xml");
    }
