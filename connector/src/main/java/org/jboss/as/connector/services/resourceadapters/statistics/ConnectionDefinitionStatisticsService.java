...
public class ConnectionDefinitionStatisticsService implements Service<ManagementResourceRegistration> {
    ...
    public void start(StartContext context) throws StartException {
        ...
        synchronized (this) {
            ...
            PathElement peCD = PathElement.pathElement(Constants.STATISTICS_NAME, "local");
                ...
                for (ConnectionManager cm : deploymentMD.getConnectionManagers()) {
                    if (cm.getPool() != null && cm.getJndiName() != null && cm.getJndiName().equals(jndiName)) {
                        ...
                        if (poolStats.getNames().size() != 0) {
                            ...
                            if (poolStats.getNames().size() != 0 && overrideRegistration.getSubModel(PathAddress.pathAddress(peCD)) == null) {
                                overrideRegistration.registerSubModel(new StatisticsResourceDefinition(peCD, CommonAttributes.RESOURCE_NAME, poolStats));
                            }
