    ...
    public void stop(StopContext context) {
        if (value != null) {
            ...
            if (mdr != null && mdr.getValue() != null) {
                try {
                    mdr.getValue().unregisterResourceAdapter(
                            value.getDeployment().getURL().toExternalForm() + value.getDeployment().getDeploymentName());
                } catch (Throwable t) {
                    log.warn("Exception during unregistering deployment", t);
                }
            }

            if (mdr != null && mdr.getValue() != null && value.getDeployment().getCfs() != null
            ...
            if (value.getDeployment() != null && value.getDeployment().getCfs() != null
                    && value.getDeployment().getCfJndiNames() != null) {
                try {
                    (new ExplicitJndiStrategy()).unbindConnectionFactories(value.getDeployment().getDeploymentName(), value
