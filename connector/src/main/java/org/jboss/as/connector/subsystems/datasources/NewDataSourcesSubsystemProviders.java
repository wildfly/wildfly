 ...
 *         Maestri</a>
 */
class NewDataSourcesSubsystemProviders {
    ...
    static final String[] DATASOURCE_ATTRIBUTE = new String[] { CONNECTION_URL, DRIVER_CLASS, JNDINAME, MODULE,
            ...
            BLOCKING_TIMEOUT_WAIT_MILLIS, IDLETIMEOUTMINUTES, QUERYTIMEOUT, USETRYLOCK, SETTXQUERTTIMEOUT,
    ...
    static final String[] XA_DATASOURCE_ATTRIBUTE = new String[] { XADATASOURCECLASS, JNDINAME, MODULE, NEW_CONNECTION_SQL,
            ...
            SETTXQUERTTIMEOUT, TRANSACTION_ISOLOATION, CHECKVALIDCONNECTIONSQL, EXCEPTIONSORTERCLASSNAME,
    ...
    static final String RESOURCE_NAME = NewDataSourcesSubsystemProviders.class.getPackage().getName() + ".LocalDescriptions";
