...
/**
  * Operation handler for is-shutdown-delay operation
  *
  * @author Stefano Maestri
 */
public class IsShutdownHandler implements OperationStepHandler {
    static final IsShutdownHandler INSTANCE = new IsShutdownHandler();


    public IsShutdownHandler() {
        super();
    }
            ...
            context.addStep(new OperationStepHandler() {
                public void execute(final OperationContext context, ModelNode operation) throws OperationFailedException {
                    ...
                    if (raService != null) {
                        ...
                        returnValue = raService.getValue().getDeployment().getConnectionManagers()[positionMatch].isShutdown();
