            ...
            context.addStep(new OperationStepHandler() {
                public void execute(final OperationContext context, ModelNode operation) throws OperationFailedException {
                    ...
                    if (raService != null) {
                        ...
                        if (timeout != null) {
                            raService.getValue().getDeployment().getConnectionManagers()[positionMatch].prepareShutdown(timeout);
                        } else {
                            raService.getValue().getDeployment().getConnectionManagers()[positionMatch].prepareShutdown();
                        }
