...
public class ConnectionDefinitionAdd extends AbstractAddStepHandler {
    ...
    protected void performRuntime(OperationContext context, ModelNode operation, final Resource resource) throws OperationFailedException {
        ...
        if (resourceModel.hasDefined(AUTHENTICATION_CONTEXT.getName()) && !ELYTRON_ENABLED.resolveModelAttribute(context, resourceModel).asBoolean()) {
            throw SUBSYSTEM_RA_LOGGER.attributeRequiresTrueAttribute(AUTHENTICATION_CONTEXT.getName(), ELYTRON_ENABLED.getName());
                ...
                !ELYTRON_ENABLED.resolveModelAttribute(context, resourceModel).asBoolean()) {
        ...
        else if (resourceModel.hasDefined(SECURITY_DOMAIN.getName()) && ELYTRON_ENABLED.resolveModelAttribute(context, resourceModel).asBoolean()) {
        ...
        if (resourceModel.hasDefined(RECOVERY_AUTHENTICATION_CONTEXT.getName()) &&
                !RECOVERY_ELYTRON_ENABLED.resolveModelAttribute(context, resourceModel).asBoolean()) {
