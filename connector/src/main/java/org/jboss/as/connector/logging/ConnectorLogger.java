...
//     */
     ...
     * @return the message.
     */
    @Message(id = 41, value = "Failed to load module for driver [%s]. Location [%s], cause of failure [%s]")
    String failedToLoadModuleDriver(String moduleName, String moduleLocation, String cause);
