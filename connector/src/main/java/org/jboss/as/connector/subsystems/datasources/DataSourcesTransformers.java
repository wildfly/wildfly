...
public class DataSourcesTransformers implements ExtensionTransformerRegistration {
    ...
    private static final ModelVersion WF_8_0 = ModelVersion.create(2, 0, 0);
    ...
    public void registerTransformers(SubsystemTransformerRegistration subsystemRegistration) {
        ...
        get300TransformationDescription(chainedBuilder.createBuilder(WF_10_0, WF_9_0));
        get200TransformationDescription(chainedBuilder.createBuilder(WF_9_0, WF_8_0));
...
//        TransformationDescription.Tools.register(get120TransformationDescription(), subsystemRegistration, EAP_6_2); //EAP 6.2.0
//        TransformationDescription.Tools.register(get130TransformationDescription(), subsystemRegistration, EAP_6_3); //EAP 6.2.0
//        TransformationDescription.Tools.register(get200TransformationDescription(), subsystemRegistration, WF_8_0);
//        TransformationDescription.Tools.register(get300TransformationDescription(), subsystemRegistration, WF_9_0);
//        TransformationDescription.Tools.register(get400TransformationDescription(), subsystemRegistration, EAP_7_0);
    }
    ...
    static TransformationDescription get200TransformationDescription(ResourceTransformationDescriptionBuilder parentBuilder) {
        ResourceTransformationDescriptionBuilder builder = parentBuilder.addChildResource(PATH_DATASOURCE);
        builder.getAttributeBuilder()
                .setDiscard(new DiscardAttributeChecker.DiscardAttributeValueChecker(new ModelNode(false)), CONNECTABLE)
                .setDiscard(new DiscardAttributeChecker.DiscardAttributeValueChecker(false, false, new ModelNode(true)), STATISTICS_ENABLED)
    ...
    static TransformationDescription get300TransformationDescription(ResourceTransformationDescriptionBuilder parentBuilder) {
    ...
    static TransformationDescription get400TransformationDescription(ResourceTransformationDescriptionBuilder parentBuilder) {
        ResourceTransformationDescriptionBuilder builder = parentBuilder.addChildResource(PATH_DATASOURCE);
        builder.getAttributeBuilder()
