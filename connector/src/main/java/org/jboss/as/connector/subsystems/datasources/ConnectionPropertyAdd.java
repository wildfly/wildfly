 ...
 *
 */
public class ConnectionPropertyAdd extends AbstractBoottimeAddStepHandler implements DescriptionProvider {
    ...
    protected void performBoottime(OperationContext context, ModelNode operation, ModelNode recoveryEnvModel,
        ...
        final ConnectionPropertiesService service = new ConnectionPropertiesService(configPropertyName, configPropertyValue);
            ServiceController<?> controller = serviceTarget.addService(serviceName, service).setInitialMode(ServiceController.Mode.ACTIVE)
                    .addDependency(dsServiceName, ModifiableDataSource.class, service.getAOInjector() )
