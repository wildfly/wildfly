...
public class ResourceAdaptersTransformers implements ExtensionTransformerRegistration {
    ...
    public void registerTransformers(SubsystemTransformerRegistration subsystemRegistration) {
        ...
        parentBuilder = chainedBuilder.createBuilder(WF_9_0, WF_8_0);
        parentBuilder.addChildResource(PathElement.pathElement(RESOURCEADAPTER_NAME))
                .addChildResource(ConnectionDefinitionResourceDefinition.PATH).getAttributeBuilder()
                .setDiscard(new DiscardAttributeChecker.DiscardAttributeValueChecker(new ModelNode(false)), Constants.CONNECTABLE)
                .setDiscard(DiscardAttributeChecker.UNDEFINED, TRACKING, VALIDATE_ON_MATCH)
                .addRejectCheck(RejectAttributeChecker.DEFINED, Constants.CONNECTABLE, Constants.TRACKING, VALIDATE_ON_MATCH).end();
