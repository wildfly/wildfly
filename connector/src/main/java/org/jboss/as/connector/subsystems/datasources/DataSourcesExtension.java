...
import org.jboss.as.connector.subsystems.datasources.DsParser.DefaultValues;
                    ...
                    case DATASOURCES_1_0: {
                        ...
                        switch (element) {
                            case SUBSYSTEM: {
                                ...
                                final DsParser parser = new DsParser(DefaultValues.INSTANCE_1_0);
                    ...
                    case DATASOURCES_2_0:{
                        ...
                        switch (element) {
                            case SUBSYSTEM: {
                                ...
                                final DsParser parser = new DsParser(DefaultValues.INSTANCE_2_0);
                                parser.parse(reader, list, address);
                                requireNoContent(reader);
                                break;
                            }
