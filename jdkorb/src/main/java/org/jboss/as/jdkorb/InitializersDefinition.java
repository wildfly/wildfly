...
public class InitializersDefinition extends PersistentResourceDefinition {
    ...
    protected static final AttributeDefinition SECURITY = new SimpleAttributeDefinitionBuilder(
            ...
            .addAccessConstraint(AttributeConstants.JDKORB_SECURITY_DEF).build();
    ...
    private InitializersDefinition() {
        super(JdkORBExtension.PATH_INITIALIZERS, JdkORBExtension.getResourceDescriptionResolver(JdkORBSubsystemConstants.ORB,
                JdkORBSubsystemConstants.ORB_INIT), InitializersAdd.INSTANCE,
