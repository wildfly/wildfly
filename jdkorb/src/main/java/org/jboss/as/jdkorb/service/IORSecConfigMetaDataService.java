...
public class IORSecConfigMetaDataService implements Service<IORSecurityConfigMetaData> {
    ...
    public static final ServiceName SERVICE_NAME = ServiceName.JBOSS.append("jdkorb", "ior-security-config");
    ...
    public void start(final StartContext startContext) throws StartException {
        JdkORBLogger.ROOT_LOGGER.debugServiceStartup(startContext.getController().getName().getCanonicalName());
    }

    @Override
    public void stop(final StopContext stopContext) {
        JdkORBLogger.ROOT_LOGGER.debugServiceStop(stopContext.getController().getName().getCanonicalName());
    }
