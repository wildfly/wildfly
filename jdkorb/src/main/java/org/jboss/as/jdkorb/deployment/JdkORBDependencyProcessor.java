 ...
 */
public class JdkORBDependencyProcessor implements DeploymentUnitProcessor {
    ...
    //public static final ModuleIdentifier JDKORB_ID = ModuleIdentifier.create("org.jdkorb");
    ...
    public void deploy(final DeploymentPhaseContext phaseContext) throws DeploymentUnitProcessingException {
        ...
        //we need to add jdkorb, as the orb is initialized from the context class loader of the deployment
