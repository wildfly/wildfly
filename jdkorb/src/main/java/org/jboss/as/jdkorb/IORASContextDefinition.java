...
public class IORASContextDefinition extends PersistentResourceDefinition {
    ...
    static final AttributeDefinition AUTH_METHOD =
            new SimpleAttributeDefinitionBuilder(JdkORBSubsystemConstants.IOR_AS_CONTEXT_AUTH_METHOD, ModelType.STRING, true)
    ...
    static final AttributeDefinition REALM =
            new SimpleAttributeDefinitionBuilder(JdkORBSubsystemConstants.IOR_AS_CONTEXT_REALM, ModelType.STRING, true)
                    .setFlags(AttributeAccess.Flag.RESTART_ALL_SERVICES)
    ...
    static final AttributeDefinition REQUIRED =
            new SimpleAttributeDefinitionBuilder(JdkORBSubsystemConstants.IOR_AS_CONTEXT_REQUIRED, ModelType.BOOLEAN, true)
                    .setFlags(AttributeAccess.Flag.RESTART_ALL_SERVICES)
