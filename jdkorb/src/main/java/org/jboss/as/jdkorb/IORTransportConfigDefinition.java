...
class IORTransportConfigDefinition extends PersistentResourceDefinition {
    ...
    static final AttributeDefinition INTEGRITY =
            new SimpleAttributeDefinitionBuilder(JdkORBSubsystemConstants.IOR_TRANSPORT_INTEGRITY, ModelType.STRING, true)
    ...
    static final AttributeDefinition CONFIDENTIALITY =
            new SimpleAttributeDefinitionBuilder(JdkORBSubsystemConstants.IOR_TRANSPORT_CONFIDENTIALITY, ModelType.STRING, true)
                    .setFlags(AttributeAccess.Flag.RESTART_ALL_SERVICES)
                    .setDefaultValue(DEFAULT_VALUE)
                    .setValidator(VALIDATOR)
                    .setAllowExpression(true)
    ...
    static final AttributeDefinition TRUST_IN_TARGET =
            new SimpleAttributeDefinitionBuilder(JdkORBSubsystemConstants.IOR_TRANSPORT_TRUST_IN_TARGET, ModelType.STRING, true)
                    .setFlags(AttributeAccess.Flag.RESTART_ALL_SERVICES)
                    .setDefaultValue(DEFAULT_VALUE)
    ...
    static final AttributeDefinition TRUST_IN_CLIENT =
            new SimpleAttributeDefinitionBuilder(JdkORBSubsystemConstants.IOR_TRANSPORT_TRUST_IN_CLIENT, ModelType.STRING, true)
                    .setFlags(AttributeAccess.Flag.RESTART_ALL_SERVICES)
                    .setDefaultValue(DEFAULT_VALUE)
                    .setValidator(VALIDATOR)
                    .setAllowExpression(true)
    ...
    static final AttributeDefinition DETECT_REPLAY =
            new SimpleAttributeDefinitionBuilder(JdkORBSubsystemConstants.IOR_TRANSPORT_DETECT_REPLAY, ModelType.STRING, true)
                    .setFlags(AttributeAccess.Flag.RESTART_ALL_SERVICES)
                    .setDefaultValue(DEFAULT_VALUE)
                    .setValidator(VALIDATOR)
                    .setAllowExpression(true)
