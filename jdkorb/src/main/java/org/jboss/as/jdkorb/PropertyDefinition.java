...
public class PropertyDefinition extends PersistentResourceDefinition {
    protected static final AttributeDefinition VALUE = new SimpleAttributeDefinitionBuilder(
            JdkORBSubsystemConstants.PROPERTY_VALUE, ModelType.STRING, true).setAllowExpression(true)
    ...
    private PropertyDefinition() {
        super(JdkORBExtension.PATH_PROPERTY, JdkORBExtension.getResourceDescriptionResolver(
                JdkORBSubsystemConstants.PROPERTIES, JdkORBSubsystemConstants.PROPERTY),
