...
import org.jboss.as.jdkorb.PropertiesMap;
...
public class DomainServerSocketFactory implements ServerSocketFactory, Configurable {
    ...
    public DomainServerSocketFactory(ORB orb) {
        ORBLogger.ROOT_LOGGER.traceServerSocketFactoryCreation(this.getClass().getName());
    }
    ...
    public void configure(Configuration configuration) throws ConfigurationException {
        ...
        if (securityDomain == null)
            throw ORBMessages.MESSAGES.errorConfiguringDomainSF();
        ...
        if (this.jsseSecurityDomain == null)
            throw ORBMessages.MESSAGES.failedToLookupJSSEDomain();
