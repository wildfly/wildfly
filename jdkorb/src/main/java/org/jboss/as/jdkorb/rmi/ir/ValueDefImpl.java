    ...
    public void allDone()
        ...
        if (baseValueTypeCode != null && baseValueTypeCode.kind() != TCKind.tk_null) {
            try {
                ...
                throw ORBMessages.MESSAGES.badKindForSuperValueType(id());
            }
        ...
        for (int i = 0; i < supported_interfaces.length; ++i) {
            ...
            if (iDef == null)
                throw ORBMessages.MESSAGES.errorResolvingRefToImplementedInterface(id(), supported_interfaces[i]);
        ...
        for (int i = 0; i < abstract_base_valuetypes.length; ++i) {
            ...
            if (vDef == null)
                throw ORBMessages.MESSAGES.errorResolvingRefToAbstractValuetype(id(), abstract_base_valuetypes[i]);
