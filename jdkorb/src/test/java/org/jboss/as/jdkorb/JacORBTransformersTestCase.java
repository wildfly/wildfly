...
import static org.jboss.as.jdkorb.JacORBSubsystemDefinitions.INTEROP_CHUNK_RMI_VALUETYPES;
import static org.jboss.as.jdkorb.JacORBSubsystemDefinitions.INTEROP_COMET;
import static org.jboss.as.jdkorb.JacORBSubsystemDefinitions.INTEROP_INDIRECT_ENCODING_DISABLE;
import static org.jboss.as.jdkorb.JacORBSubsystemDefinitions.INTEROP_IONA;
import static org.jboss.as.jdkorb.JacORBSubsystemDefinitions.INTEROP_LAX_BOOLEAN_ENCODING;
import static org.jboss.as.jdkorb.JacORBSubsystemDefinitions.INTEROP_STRICT_CHECK_ON_TC_CREATION;
import static org.jboss.as.jdkorb.JacORBSubsystemDefinitions.INTEROP_SUN;
import static org.jboss.as.jdkorb.JacORBSubsystemDefinitions.NAMING_EXPORT_CORBALOC;
import static org.jboss.as.jdkorb.JacORBSubsystemDefinitions.NAMING_ROOT_CONTEXT;
import static org.jboss.as.jdkorb.JacORBSubsystemDefinitions.ORB_CACHE_POA_NAMES;
import static org.jboss.as.jdkorb.JacORBSubsystemDefinitions.ORB_CACHE_TYPECODES;
import static org.jboss.as.jdkorb.JacORBSubsystemDefinitions.ORB_CONN_CLIENT_TIMEOUT;
import static org.jboss.as.jdkorb.JacORBSubsystemDefinitions.ORB_CONN_MAX_MANAGED_BUF_SIZE;
import static org.jboss.as.jdkorb.JacORBSubsystemDefinitions.ORB_CONN_MAX_SERVER_CONNECTIONS;
import static org.jboss.as.jdkorb.JacORBSubsystemDefinitions.ORB_CONN_OUTBUF_CACHE_TIMEOUT;
import static org.jboss.as.jdkorb.JacORBSubsystemDefinitions.ORB_CONN_OUTBUF_SIZE;
import static org.jboss.as.jdkorb.JacORBSubsystemDefinitions.ORB_CONN_RETRIES;
import static org.jboss.as.jdkorb.JacORBSubsystemDefinitions.ORB_CONN_RETRY_INTERVAL;
import static org.jboss.as.jdkorb.JacORBSubsystemDefinitions.ORB_CONN_SERVER_TIMEOUT;
import static org.jboss.as.jdkorb.JacORBSubsystemDefinitions.ORB_GIOP_MINOR_VERSION;
import static org.jboss.as.jdkorb.JacORBSubsystemDefinitions.ORB_INIT_SECURITY;
import static org.jboss.as.jdkorb.JacORBSubsystemDefinitions.ORB_INIT_TX;
import static org.jboss.as.jdkorb.JacORBSubsystemDefinitions.ORB_NAME;
import static org.jboss.as.jdkorb.JacORBSubsystemDefinitions.ORB_PRINT_VERSION;
import static org.jboss.as.jdkorb.JacORBSubsystemDefinitions.ORB_USE_BOM;
import static org.jboss.as.jdkorb.JacORBSubsystemDefinitions.ORB_USE_IMR;
import static org.jboss.as.jdkorb.JacORBSubsystemDefinitions.POA_MONITORING;
import static org.jboss.as.jdkorb.JacORBSubsystemDefinitions.POA_QUEUE_MAX;
import static org.jboss.as.jdkorb.JacORBSubsystemDefinitions.POA_QUEUE_MIN;
import static org.jboss.as.jdkorb.JacORBSubsystemDefinitions.POA_QUEUE_WAIT;
import static org.jboss.as.jdkorb.JacORBSubsystemDefinitions.POA_REQUEST_PROC_MAX_THREADS;
import static org.jboss.as.jdkorb.JacORBSubsystemDefinitions.POA_REQUEST_PROC_POOL_SIZE;
import static org.jboss.as.jdkorb.JacORBSubsystemDefinitions.PROPERTIES;
import static org.jboss.as.jdkorb.JacORBSubsystemDefinitions.SECURITY_ADD_COMPONENT_INTERCEPTOR;
import static org.jboss.as.jdkorb.JacORBSubsystemDefinitions.SECURITY_CLIENT_REQUIRES;
import static org.jboss.as.jdkorb.JacORBSubsystemDefinitions.SECURITY_CLIENT_SUPPORTS;
import static org.jboss.as.jdkorb.JacORBSubsystemDefinitions.SECURITY_SECURITY_DOMAIN;
import static org.jboss.as.jdkorb.JacORBSubsystemDefinitions.SECURITY_SERVER_REQUIRES;
import static org.jboss.as.jdkorb.JacORBSubsystemDefinitions.SECURITY_SERVER_SUPPORTS;
import static org.jboss.as.jdkorb.JacORBSubsystemDefinitions.SECURITY_SUPPORT_SSL;
...
import org.jboss.as.jdkorb.JacORBExtension;
import org.jboss.as.jdkorb.JacORBSubsystemConstants;
