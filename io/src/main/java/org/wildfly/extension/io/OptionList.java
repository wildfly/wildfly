...
public class OptionList {
    ...
    public static OptionMap resolveOptions(final OperationContext context, final ModelNode model, Collection<OptionAttributeDefinition> attributes) throws OperationFailedException {
