...
@ServerSetup({OpenTelemetryWithCollectorSetupTask.class, ServiceNameSetupTask.class, LoggingServerSetupTask.class})
@RunAsClient
@DockerRequired
public class OpenTelemetryIntegrationWithoutVertxTestCase extends AbstractOpenTelemetryIntegrationTest {
    ...
    public static WebArchive getDeployment() {
        return createDeployment("otelinteg-without-vertx");
    }
