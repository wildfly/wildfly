...
@ServerSetup({OpenTelemetryWithCollectorSetupTask.class, ServiceNameSetupTask.class, OpenTelemetryIntegrationWithVertxTestCase.LoggingWithVertxServerSetupTask.class, VertxSubsystemSetupTask.class})
@RunAsClient
@DockerRequired
public class OpenTelemetryIntegrationWithVertxTestCase extends AbstractOpenTelemetryIntegrationTest {
    ...
    public static WebArchive getDeployment() {
        return createDeployment("otelinteg-with-vertx");
    }

    @Test
    public void testVertxUsageInLog() throws Exception {
        requestOpenTelemetryTrace();
