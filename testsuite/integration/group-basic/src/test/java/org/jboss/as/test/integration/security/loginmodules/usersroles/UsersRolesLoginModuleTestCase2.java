...
/**
 * @author Jan Lanik
 * this class contains UsersRolesLoginModule tests with hashAlgorithm=MD5
 */
@RunWith(Arquillian.class)
@RunAsClient
public class UsersRolesLoginModuleTestCase2 extends AbstractSecuredOnlyUsersRolesLoginModuleTest {
