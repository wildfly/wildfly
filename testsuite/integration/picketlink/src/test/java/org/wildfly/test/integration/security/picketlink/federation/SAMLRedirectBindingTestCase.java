...
@ServerSetup({SAMLRedirectBindingTestCase.BasicSecurityDomainServerSetupTask.class})
@RunAsClient
public class SAMLRedirectBindingTestCase extends AbstractBasicFederationTestCase {
    ...
    public static WebArchive deploymentSP1() {
        return serviceProvider("sp-redirect1.war");
    }

    @Deployment(name = "service-provider-2")
    public static WebArchive deploymentSP2() {
        return serviceProvider("sp-redirect2.war");
    }
}
