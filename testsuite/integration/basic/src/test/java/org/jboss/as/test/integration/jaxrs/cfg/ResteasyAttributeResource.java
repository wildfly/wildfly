...
public class ResteasyAttributeResource {
   ...
   @GET
   @Produces("text/plain")
   public String getParameter(@PathParam("param") String param, @Context UriInfo info) {
   ...
   @POST
   @Produces("text/plain")
   public String testBar(Bar5 bar) {
      return bar.getS();
   }
   ...
   @POST
   @Produces("text/plain")
   public String testBar(Bar6 bar) {
      return bar.getS();
   }

   @Path("accept")
   @GET
   @Produces("text/unusual")
   public String testUnusual() {
      return "unusual";
   }
}
