...
public class ExtensionTestCase extends AbstractModuleTest {
    ...
    protected static String modulePath = "org/jboss/test/extensionModule";
    ...
    public static Archive<?> deploy() throws Exception {
        ...
        JavaArchive jar = ShrinkWrap
                ...
                .addAsManifestResource(new StringAsset("Dependencies: org.jboss.test.extensionModule services\n"),
                        "MANIFEST.MF");
