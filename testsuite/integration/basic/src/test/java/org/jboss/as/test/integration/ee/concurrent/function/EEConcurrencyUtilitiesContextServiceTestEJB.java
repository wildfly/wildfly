...
@LocalBean
@RolesAllowed("guest")
public class EEConcurrencyUtilitiesContextServiceTestEJB {

    private static final Logger logger = Logger.getLogger(EEConcurrencyUtilitiesContextServiceTestEJB.class);
    ...
    public Future<?> submit(String jndiName, TestEJBRunnable task) throws NamingException {
        final ContextService contextService = (ContextService) new InitialContext().lookup(jndiName);
        ...
        return singleThreadExecutor.submit(contextualTask);
    }
