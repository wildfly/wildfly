...
public class OperationWarningTestsCase {
    ...
    protected static final String NAME_DEPLOYMENT = "echo-ejb-candy"; // module
    protected static final String NAME_WORKER = "puppet-master";
    protected static final String WORKER = "worker";
    protected static final PathAddress ADDRESS_WORKER = PathAddress.pathAddress(PathElement.pathElement(SUBSYSTEM, "io"),
            PathElement.pathElement(WORKER, NAME_WORKER));
    protected static final PathAddress ADDRESS_REMOTING = PathAddress.pathAddress(PathElement.pathElement(SUBSYSTEM, "remoting"),PathElement.pathElement("configuration", "endpoint"));
    ...
    public static JavaArchive create() {
        //fake deployment, to trigger arq
