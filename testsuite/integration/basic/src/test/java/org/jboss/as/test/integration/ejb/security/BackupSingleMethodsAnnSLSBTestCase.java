...
/**
 * This test case check whether basic EJB authorization works from EJB client to stateless remote EJB.
 *
 * @author <a href="mailto:pskopek@redhat.com">Peter Skopek</a>
 */
@RunWith(Arquillian.class)
@RunAsClient
public class BackupSingleMethodsAnnSLSBTestCase extends SecurityTest {

   private static final Logger log = Logger.getLogger(SingleMethodsAnnSLSBTestCase.class);
   ...
   public static Archive<JavaArchive> testAppDeployment() {
      ...
      final JavaArchive jar = ShrinkWrap.create(JavaArchive.class, MODULE + ".jar")
         .addClass(SingleMethodsAnnOnlyCheckSLSB.class)
    ...
    *   The target EJB is remote stateless bean.
    * Expected results:
   ...
   public void testSingleMethodAnnotationsNoUser() throws Exception {
      ...
      String myContext = Util.createRemoteEjbJndiContext(
         ...
         MODULE,
         "",
         SingleMethodsAnnOnlyCheckSLSB.class.getSimpleName(),
