...
public class ServiceOverlayTestCaseBase {
    ...
    public static Archive<?> createEARWithOverlayedArchive(final boolean initialInterceptor){
        EnterpriseArchive ear = ShrinkWrap.create(EnterpriseArchive.class, Constants.DEPLOYMENT_EAR_NAME_TESTER_WRAPPER);
