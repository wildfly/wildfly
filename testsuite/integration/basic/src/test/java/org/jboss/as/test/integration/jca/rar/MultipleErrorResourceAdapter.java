...
public class MultipleErrorResourceAdapter implements ResourceAdapter, Serializable {
     ...
     * @Override public int hashCode() { int result = 17; if (name != null) result += 31 * result + 7 * name.hashCode(); else
     *           result += 31 * result + 7; return result; }
     */
    /**
    ...
    public boolean equals(Object other) {
        ...
        if (other == this)
            return true;
        if (!(other instanceof MultipleErrorResourceAdapter))
            return false;
