...
public interface Constants {
    ...
    String DEPLOYMENT_EAR_NAME_TESTER_WRAPPER = DEPLOYMENT_NAME_TESTER_WRAPPER + ".war";
    ...
    String OVERLAY_RESOURCE="/WEB-INF/lib/"+DEPLOYMENT_JAR_NAME_OVERLAYED+"//META-INF/services/org.jboss.ejb.client.EJBClientInterceptor";
    String OVERLAYED_CONTENT="org.jboss.as.test.integration.deployment.deploymentoverlay.service.war.OverlayedInterceptor";
