...
@ServerSetup({ RemotingLoginModuleUseNewClientCertTestCase.FilesSetup.class,
        RemotingLoginModuleUseNewClientCertTestCase.SecurityRealmsSetup.class,
        RemotingLoginModuleUseNewClientCertTestCase.RemotingSetup.class,
...
public class RemotingLoginModuleUseNewClientCertTestCase {
    static final Logger LOGGER = Logger.getLogger(RemotingLoginModuleUseNewClientCertTestCase.class);
    ...
    static class SecurityDomainsSetup extends AbstractSecurityDomainsServerSetupTask {
        ...
        protected SecurityDomain[] getSecurityDomains() {
            ...
            final SecurityDomain sd = new SecurityDomain.Builder()
                    .name(TEST_NAME)
                    .loginModules(
                            new SecurityModule.Builder().name("Remoting").flag("optional")
                                    .putOption("password-stacking", "useFirstPass")
                                    .putOption("useNewClientCert", "true").build(),
                            new SecurityModule.Builder().name("CertificateRoles").flag("required")  // it would be even better with our own CertificationLoginModule that would take roles from the client certificate
                                    .putOption("password-stacking", "useFirstPass")
                                    .putOption("securityDomain", TEST_NAME)
