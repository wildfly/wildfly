...
public class SecurityTestCase {
    ...
    public void testFailedAuthentication() throws Exception {
        ...
        try {
            session = sf.createSession("fail", "fail", false, true, true, false, 1);
        } catch (Exception e) {
    ...
    @Test
    public void testSuccessfulUnauthentication() throws Exception {
        final ClientSessionFactory sf = createClientSessionFactory("localhost", 5445);
        ClientSession session = null;
        boolean success = false;
        try {
            // this exercises the "unauthenticatedIdentity" of the "message" security-domain
    ...
    static boolean destinationExists(final String destinationName, final ClientSessionFactory sf) throws HornetQException {
        final ClientSession session = sf.createSession(false, false, false);
        try {
            final QueueQuery query = session.queueQuery(new SimpleString(destinationName));
