...
public class DeployedXmlDataSourceTestCase {
    ...
    public static void deployDatasource() throws Throwable {
        try {
            ...
            final DeploymentPlan plan = manager.newDeploymentPlan().add(DeployedXmlDataSourceTestCase.class.getResource("/" + packageName + "/test-ds.xml")).andDeploy().build();
    ...
    public static void undeployDatasource() throws IOException {
        if (client != null) {
            final DeploymentPlan undeployPlan = manager.newDeploymentPlan().undeploy("test-ds.xml").andRemoveUndeployed().build();
    ...
    public void testDeployedDataSource() throws Throwable {
        //now it is deployed lets look it up
