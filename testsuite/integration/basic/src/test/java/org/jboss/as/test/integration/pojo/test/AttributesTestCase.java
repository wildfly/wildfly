...
public class AttributesTestCase {
    ...
    public static JavaArchive getSimpleBeansJar() {
        ...
        archive.addAsManifestResource( AttributesTestCase.class.getPackage(), "attributes-jboss-beans.xml", "attributes-jboss-beans.xml");
        return archive;
    }
    ...
    public void testSimpleBeans() throws Exception {
        //NOTE: deployment WILL fail if PojoExtension magic cant parse values
        //TODO: fetch bean and check values? 
    }
}