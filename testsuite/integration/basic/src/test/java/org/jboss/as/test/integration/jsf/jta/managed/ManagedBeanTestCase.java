 ...
 */
package org.jboss.as.test.integration.jsf.jta.managed;

import junit.framework.Assert;
import org.jboss.arquillian.container.test.api.Deployment;
import org.jboss.arquillian.container.test.api.OverProtocol;
import org.jboss.arquillian.junit.Arquillian;
import org.jboss.as.test.integration.jsf.jta.CheckLogin;
...
public class ManagedBeanTestCase extends JTATestsBase {
    ...
    public static Archive<WebArchive> createDeployment() {
        return ShrinkWrap.create(WebArchive.class, DEPLOYMENT_NAME)
                .addPackage(ManagedBeanTestCase.class.getPackage())
                .addClasses(CheckLogin.class, JTATestsBase.class)
                .addAsWebInfResources(ManagedBeanTestCase.class.getPackage(), "web.xml", "web.xml")
                .addAsWebInfResource(ManagedBeanTestCase.class.getPackage(), "faces-config.xml", "faces-config.xml")
                .addAsWebResource(ManagedBeanTestCase.class.getPackage(), "index.xhtml", "index.xhtml");
    }
