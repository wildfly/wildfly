...
/**
 * Test if JMX beans can parse attributes like AtomicBoolean etc.
 * 
 * @author baranowb
 * 
 */
...
public class JMXPropertyEditorsTestCase {
    ...
    public void testPropertiesValues() throws Exception {
        ...
        String[] attributeNames = { "Boolean", "Char", "Byte", "Short", "Integer", "Long", "Float", "Double", "AtomicBoolean",
                "AtomicInteger", "AtomicLong", "BigDecimal", "File", "InetAddress", "Locale", "Properties", "URI",
                "URL" };
