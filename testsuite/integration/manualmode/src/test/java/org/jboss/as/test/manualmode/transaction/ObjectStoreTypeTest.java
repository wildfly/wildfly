...
/**
 * This tests an operation to change the transaction object store type.
 *
...
public class ObjectStoreTypeTest extends AbstractCliTestBase {
    ...
    @Test
    public void testHornetQObjectStore() throws Exception {
        try {
    ...
    @Test
    public void testJdbcObjectStore() throws Exception {
    ...
    private void startUpContainer() throws Exception {
        container.start(CONTAINER);
        initCLI();
    }

    private void shutDownContainer() throws Exception {
        closeCLI();
    ...
    private void setDefaultObjectStore() throws Exception {
        setDefaultObjectStore(false);
    }

    private void setDefaultObjectStore(boolean reload) throws Exception {
