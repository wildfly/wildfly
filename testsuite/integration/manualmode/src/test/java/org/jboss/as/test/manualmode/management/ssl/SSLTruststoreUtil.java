...
public class SSLTruststoreUtil {
	...
	public static DefaultHttpClient getHttpClientWithTrustStore(File trustStoreFile){
		
	    try {
	        KeyStore trustStore = KeyStore.getInstance("jks");
	        trustStore.load(new FileInputStream(trustStoreFile), "secret".toCharArray());
	...
	static class AdditionalKeyStoresSSLSocketFactory extends SSLSocketFactory {
	    ...
	    public AdditionalKeyStoresSSLSocketFactory(KeyStore trustStore) throws NoSuchAlgorithmException, KeyManagementException, KeyStoreException, UnrecoverableKeyException {
