...
public class ConnectionListenerTestCase extends AbstractTestsuite{
    ...
    @Test
    public void testConnListener() throws Exception {
    	testConnListenerTest(DEP_1, false);
    }
    
    @Test
    public void testConnListenerXa() throws Exception {
     ...
     */
    @Test
    public void testConnListener2() throws Exception {
    	testConnListener2Test(DEP_2, false);
    }
    
    @Test
    public void testConnListener2Xa() throws Exception {
    	testConnListener2Test(DEP_2_XA, true);
    }
    
    @Test
    public void testConnListener3() throws Exception {
    	testConnListener3Test(DEP_3, false);
    }
    
    @Test
    public void testConnListener3Xa() throws Exception {
    ...
    private void testConnListenerTest(String deployment, boolean useXaDatasource) throws NamingException, SQLException{
    	try{
    		 ...
    		 */
    		bean.assertExactCountOfRecords(6, 11, 12);//TODO Hynek passivate?? why 6?
    ...
    private void testConnListener2Test(String deployment, boolean useXaDatasource) throws SQLException, NamingException{
    	try{
    		 ...
    		 * 					- 1 extra activated record is inserted for select statement in assertExactCountOfRecords...
    		 */
    		bean.assertExactCountOfRecords(2, 3, 3);//TODO Hynek passivate?? why 1?
    ...
    private void testConnListener3Test(String deployment, boolean useXaDatasource) throws Exception {
    	...
    	try{
    		 ...
    		 */
    		bean.assertExactCountOfRecords(5, 6, 5);//TODO Hynek passivate?? why 0?
