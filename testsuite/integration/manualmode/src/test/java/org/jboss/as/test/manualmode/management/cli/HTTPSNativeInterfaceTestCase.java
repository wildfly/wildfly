...
@ServerSetup({ HTTPSNativeInterfaceTestCase.ManagementNativeRealmSetup.class, HTTPSNativeInterfaceTestCase.KeystoreFilesSetup.class })
@RunAsClient
public class HTTPSNativeInterfaceTestCase {

    private static Logger LOGGER = Logger.getLogger(HTTPSNativeInterfaceTestCase.class);
    ...
    private static final File TRUSTED_JBOSS_CLI_FILE = new File(new File(System.getProperty("java.io.tmpdir")), "trusted-jboss-cli.xml");
    private static final File UNTRUSTED_JBOSS_CLI_FILE = new File(new File(System.getProperty("java.io.tmpdir")), "untrusted-jboss-cli.xml");
    ...
    public void testUntrustedCertificateOverNative() throws InterruptedException, IOException {
        ...
        assertTrue("Authentication should fail", cliOutput.contains("Authentication failed"));
        assertTrue("Untrusted client should not be authenticated.", !cliOutput.contains("\"outcome\" => \"success\""));
    ...
    public void testTrustedCertificateOverNative() throws InterruptedException, IOException {
        ...
        assertTrue("Trusted client should be authenticated.", cliOutput.contains("\"outcome\" => \"success\""));
