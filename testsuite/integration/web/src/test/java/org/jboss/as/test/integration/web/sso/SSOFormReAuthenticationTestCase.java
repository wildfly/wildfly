...
public class SSOFormReAuthenticationTestCase {
    ...
    public static EnterpriseArchive deployment() {
        ...
        JavaArchive appClasses = ShrinkWrap.create(JavaArchive.class, SSOFormReAuthenticationTestCase.class.getSimpleName() + ".jar")
                .addClass(SecureServlet.class)
                .addClass(SecuredPostServlet.class)
                .addClass(LogoutServlet.class);

        EnterpriseArchive ear = ShrinkWrap.create(EnterpriseArchive.class, SSOFormReAuthenticationTestCase.class.getSimpleName() + ".ear")
                .addAsModule(createFormAuthWar("login-app.war", appClasses))
                .addAsModule(createFormAuthWar("form-app.war", appClasses))
    ...
    public void testFormAuthBypassAndReAuthentication() throws Exception {
        ...
        URL loginAppUrl = new URL(baseURL, "login-app/");
        URL formAppUrl = new URL(baseURL, "form-app/");

        // We need the direct URLs to the secured servlets for our checks
        String loginAppSecuredUrl = new URL(loginAppUrl, "restricted/SecuredServlet").toExternalForm();
        String formAppSecuredUrl = new URL(formAppUrl, "restricted/SecuredServlet").toExternalForm();
