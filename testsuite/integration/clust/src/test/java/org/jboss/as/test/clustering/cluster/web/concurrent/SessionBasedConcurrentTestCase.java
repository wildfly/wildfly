 ...
 * @version April 2012
 */
public class SessionBasedConcurrentTestCase extends ConcurrentAbstractCase {
    ...
    private static Archive<?> getDeployment() {
        ...
        war.addAsWebInfResource(ConcurrentAbstractCase.class.getPackage(), "jboss-web_concurrent.xml", "jboss-web.xml");
        // Bundle the JSPs
