 ...
 */
package org.jboss.as.test.clustering.clusteringdiagnostics;
...
import org.wildfly.clustering.diagnostics.extension.ClusteringDiagnosticsExtension;

/**
 * Tests basic functionality of the clustering-diagnostics subsystem.
 *
...
@RunAsClient
public class ClusteringDiagnosticsTestCase {

    private static final Logger log = Logger.getLogger(ClusteringDiagnosticsTestCase.class);
     ...
     *
     *   subsystem=clustering-diagnostics/cluster=web/deployment=web-deployment.war/web=WEB
     *
     */
    @Test
     ...
     *
     *   subsystem=clustering-diagnostics/cluster=ejb/deployment=ejb-deployment.jar/bean=StatefulBean
     *
     */
    @Test
    ...
    private static PathAddress getClusterAddress(String cluster) {
        PathAddress address = PathAddress.pathAddress(
                PathElement.pathElement(SUBSYSTEM, ClusteringDiagnosticsExtension.SUBSYSTEM_NAME),
