 ...
 */
public class MultiTenantResolverAuthServerUrl implements OidcClientConfigurationResolver {
    ...
    public OidcClientConfiguration resolve(OidcHttpFacade.Request request) {
        ...
        int multitenantIndex = path.indexOf(OidcWithMultiTenancyTest.MULTI_TENANCY_AUTH_SERVER_URL_APP + "/");
        ...
        if (clientConfiguration == null) {
            ...
            InputStream is = getClass().getResourceAsStream(OidcWithMultiTenancyTest.MULTI_TENANCY_AUTH_SERVER_URL_APP + "-" + tenant + ".json");
            if (is == null) {
