 ...
 */
package org.jboss.as.test.integration.jaxrs.core.basic;
...
import org.jboss.as.test.integration.jaxrs.core.basic.resource.DemoAppResourceTwo;
import org.jboss.as.test.integration.jaxrs.core.basic.resource.DemoAppTwo;
import org.jboss.as.test.integration.jaxrs.core.basic.resource.DemoAppResource;
...
public class DemoAppTwoTest {
    ...
    public static Archive<?> deploySimpleResource() {
        WebArchive war = ShrinkWrap.create(WebArchive.class, DemoAppTwoTest.class.getSimpleName() + ".war");
        war.addAsWebInfResource(DemoAppTwoTest.class.getPackage(), "DemoAppTwoWeb.xml", "web.xml");
        war.addClasses(DemoAppResource.class, DemoAppResourceTwo.class,
            DemoAppTwo.class);
        return war;
    }
    ...
    public void testDemo() throws Exception {
        ...
        url = baseUrl.toString() + "resources";
