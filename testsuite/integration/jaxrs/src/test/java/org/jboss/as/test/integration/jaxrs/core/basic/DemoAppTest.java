...
public class DemoAppTest {
    ...
    public static Archive<?> deploySimpleResource() {
        WebArchive war = ShrinkWrap.create(WebArchive.class, DemoAppTest.class.getSimpleName() + ".war");
        war.addAsWebInfResource(DemoAppTest.class.getPackage(), "DemoAppWeb.xml", "web.xml");
        war.addClasses(DemoAppResource.class,
            DemoApp.class);
        return war;
    }
