...
import org.jboss.as.test.clustering.cluster.ejb.stateful.AbstractStatefulFailoverTestCase;
...
/**
 * Validates failover of a remotely stored SFSB
 * @author Paul Ferraro
 */
@RunWith(Arquillian.class)
@ServerSetup({ InfinispanServerSetupTask.class, HotRodBeanManagementServerSetupTask.class })
public class RemoteStatefulFailoverTestCase extends AbstractStatefulFailoverTestCase {

    @ClassRule
    public static final TestRule INFINISPAN_SERVER_RULE = InfinispanServerUtil.infinispanServerTestRule();

    private static final String MODULE_NAME = RemoteStatefulFailoverTestCase.class.getSimpleName();
    ...
    public RemoteStatefulFailoverTestCase() {
        super(MODULE_NAME);
    }
}
