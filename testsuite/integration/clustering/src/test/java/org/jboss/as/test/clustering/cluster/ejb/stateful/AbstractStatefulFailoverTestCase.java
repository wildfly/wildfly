 ...
 * @author Paul Ferraro
 */
public abstract class AbstractStatefulFailoverTestCase extends AbstractClusteringTestCase {
    ...
    public void noFailover(
        ...
        URI uri1 = StatefulServlet.createURI(baseURL1, this.moduleName, PassivationIncapableIncrementorBean.class.getSimpleName());
        URI uri2 = StatefulServlet.createURI(baseURL2, this.moduleName, PassivationIncapableIncrementorBean.class.getSimpleName());
    ...
    private void failover(Class<?> beanClass, URL baseURL1, URL baseURL2) throws Exception {
        URI uri1 = StatefulServlet.createURI(baseURL1, this.moduleName, beanClass.getSimpleName());
        URI uri2 = StatefulServlet.createURI(baseURL2, this.moduleName, beanClass.getSimpleName());
        this.failover(uri1, uri2);
    }

    @Test
    public void sessionScopedFailover(
            @ArquillianResource() @OperateOnDeployment(DEPLOYMENT_1) URL baseURL1,
            @ArquillianResource() @OperateOnDeployment(DEPLOYMENT_2) URL baseURL2) throws Exception {
        URI uri1 = SessionScopedStatefulServlet.createURI(baseURL1);
        URI uri2 = SessionScopedStatefulServlet.createURI(baseURL2);
        this.failover(uri1, uri2);
    }

    private void failover(URI uri1, URI uri2) throws Exception {
    ...
    public void failoverOnStop(
        ...
        URI uri1 = StatefulServlet.createURI(baseURL1, this.moduleName, SimpleIncrementorBean.class.getSimpleName());
        URI uri2 = StatefulServlet.createURI(baseURL2, this.moduleName, SimpleIncrementorBean.class.getSimpleName());
    ...
    public void nestedBeanFailover(
        ...
        URI uri1 = StatefulServlet.createURI(baseURL1, this.moduleName, NestedIncrementorBean.class.getSimpleName());
        URI uri2 = StatefulServlet.createURI(baseURL2, this.moduleName, NestedIncrementorBean.class.getSimpleName());
