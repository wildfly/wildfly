...
//    private static final String REMOTE_HOST_PROPERTY_NAME = "remote.connection.default.host";
    ...
    public static void init() throws NamingException {
        ...
        started.put(ClusteringTestConstants.NODE_1, false);
        started.put(ClusteringTestConstants.NODE_2, false);

        List<String> deployments1 = new ArrayList<>();
        deployments1.add(DEPLOYMENT_1);
        deployments1.add(DEPLOYMENT_1_DD);
        container2deployment.put(ClusteringTestConstants.NODE_1, deployments1);
        List<String> deployments2 = new ArrayList<>();
        deployments2.add(DEPLOYMENT_2);
        deployments2.add(DEPLOYMENT_2_DD);
        container2deployment.put(ClusteringTestConstants.NODE_2, deployments2);
    }
    ...
    private void doFailover(boolean isStop, EJBDirectory directory, String deployment1, String deployment2) throws Exception {
        this.start(ClusteringTestConstants.NODE_1);
        this.deploy(ClusteringTestConstants.NODE_1, deployment1);
        ...
        try {
            ...
            this.start(ClusteringTestConstants.NODE_2);
            this.deploy(ClusteringTestConstants.NODE_2, deployment2);

            if (isStop) {
                this.stop(ClusteringTestConstants.NODE_1);
            } else {
                this.undeploy(ClusteringTestConstants.NODE_1, deployment1);
            }
