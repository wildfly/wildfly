...
@ServerSetup(RemoteSingleSignOnTestCase.ServerSetupTask.class)
    ...
    public static class ServerSetupTask extends CLIServerSetupTask {
        public ServerSetupTask() {
            this.builder.node(TWO_NODES)
                    ...
                    .setup("/subsystem=distributable-web/hotrod-single-sign-on-management=remote:add(remote-cache-container=web)")
                    .setup("/subsystem=distributable-web:write-attribute(name=default-single-sign-on-management, value=remote)")
                    ...
                    .teardown("/subsystem=distributable-web:write-attribute(name=default-single-sign-on-management, value=default)")
                    .teardown("/subsystem=distributable-web/hotrod-single-sign-on-management=remote:remove")
