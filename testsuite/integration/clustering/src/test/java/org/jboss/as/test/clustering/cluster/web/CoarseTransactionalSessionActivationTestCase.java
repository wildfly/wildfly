 ...
 * @author Paul Ferraro
 */
public class CoarseTransactionalSessionActivationTestCase extends AbstractSessionActivationTestCase {

    private static final String MODULE_NAME = CoarseTransactionalSessionActivationTestCase.class.getSimpleName();
    ...
    public CoarseTransactionalSessionActivationTestCase() {
        super(true);
    }
}
