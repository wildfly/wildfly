...
/**
 * Validates timeout of a remotely stored SFSB
 * @author Paul Ferraro
 */
@RunWith(Arquillian.class)
@ServerSetup({ InfinispanServerSetupTask.class, HotRodBeanManagementServerSetupTask.class })
public class RemoteStatefulTimeoutTestCase extends AbstractClusteringTestCase {

    @ClassRule
    public static final TestRule INFINISPAN_SERVER_RULE = InfinispanServerUtil.infinispanServerTestRule();

    private static final String MODULE_NAME = RemoteStatefulTimeoutTestCase.class.getSimpleName();
