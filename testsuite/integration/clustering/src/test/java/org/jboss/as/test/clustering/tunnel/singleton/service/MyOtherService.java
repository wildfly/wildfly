...
/**
 * Simple singleton service
 *
 * @author Tomas Hofman
 */
public class MyOtherService implements Service<Environment> {

    public static final ServiceName SERVICE_NAME = ServiceName.JBOSS.append("test", "myotherservice");
