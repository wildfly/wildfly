...
public class CurrentTopologyBean implements CurrentTopology {
    ...
    public Set<String> getClusterMembers(String cluster) {
        ...
        if (cacheManager == null) {
            Object[] availableServices = registry.getServiceNames().toArray();
            throw new IllegalStateException(String.format("Failed to locate %s. Available names: %s",
                    serviceName, Arrays.toString(availableServices)));
        }
