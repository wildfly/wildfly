...
public class CustomRealmImpl implements SecurityRealm, Configurable {
    ...
    private class RealmIdentityImpl implements RealmIdentity {
        ...
        public SupportLevel getCredentialAcquireSupport(Class<? extends Credential> credentialType, String algorithmName)
            throws RealmUnavailableException {
            return CustomRealmImpl.this.getCredentialAcquireSupport(credentialType, algorithmName);
        }
        ...
        public SupportLevel getEvidenceVerifySupport(Class<? extends Evidence> evidenceType, String algorithmName)
            throws RealmUnavailableException {
            return CustomRealmImpl.this.getEvidenceVerifySupport(evidenceType, algorithmName);
        }
