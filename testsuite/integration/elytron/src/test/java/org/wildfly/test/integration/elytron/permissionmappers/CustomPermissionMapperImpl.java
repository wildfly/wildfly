...
public class CustomPermissionMapperImpl implements PermissionMapper, Configurable {

    boolean allPermissions;

    @Override
    public PermissionVerifier mapPermissions(PermissionMappable permissionMappable, Roles roles) {
        return allPermissions ? PermissionVerifier.ALL : PermissionVerifier.NONE;
    }
    ...
    public void initialize(Map<String, String> configuration) {
        ...
        allPermissions = Boolean.parseBoolean(configuration.get("allPermissions"));
    }
