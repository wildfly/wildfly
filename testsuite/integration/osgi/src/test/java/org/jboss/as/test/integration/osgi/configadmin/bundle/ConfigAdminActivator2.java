...
public class ConfigAdminActivator2 implements BundleActivator {
    @Override
    public void start(BundleContext context) throws Exception {
        ...
        try {
            ...
            Configuration configuration = cadmin.getConfiguration(ConfigAdminActivator2.class.getName(), null);
