...
public class LocalEJBPropertyDenyPermissionReadTestCase extends AbstractLocalEJBPropertyPermissionReadTestCase {

    @EJB(lookup="java:module/ReadSystemPropertyBean!org.jboss.as.testsuite.integration.secman.ejbs.ReadSystemPropertyLocal")
    ReadSystemPropertyLocal beanDenied;
    ...
    public void testJavaHomePropertyDeny() throws Exception {
        checkJavaHomeProperty(beanDenied, true);
    }
