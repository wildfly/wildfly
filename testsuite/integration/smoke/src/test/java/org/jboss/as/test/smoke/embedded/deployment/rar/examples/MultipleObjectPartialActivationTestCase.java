...
public class MultipleObjectPartialActivationTestCase extends AbstractMgmtTestBase {
	...
	public static void setUp() throws Exception{
	    ...
	    String xml=readResource("../test-classes/config/multiple_part.xml");
   ...
   @Deployment
    public static ResourceAdapterArchive createDeployment()  throws Exception{
        ...
        addClasses(MultipleObjectPartialActivationTestCase.class,AbstractMgmtTestBase.class,MgmtOperationException.class);
        raa.addAsLibrary(ja);
