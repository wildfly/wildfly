...
import org.jboss.as.test.smoke.jms.aux.QueueMessageDrivenBean;
import org.jboss.as.test.smoke.jms.aux.TransactedQueueMessageSender;
...
public class SendToQueueFromWithinTransactionTest {
    ...
    public static void deployQueue() throws Exception {
        ...
        adminOperations.createJmsQueue("myAwesomeQueue12", "queue/myAwesomeQueue12");
    }

    @AfterClass
    public static void removeQueue() throws Exception {
        if (adminOperations != null) {
            adminOperations.removeJmsQueue("myAwesomeQueue12");
