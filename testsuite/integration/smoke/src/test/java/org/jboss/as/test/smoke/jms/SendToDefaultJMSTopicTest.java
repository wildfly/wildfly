...
/**
 * Basic JMS test using default JMS topic
 *
 * @author <a href="jmartisk@redhat.com">Jan Martiska</a>
 */
@RunWith(Arquillian.class)
public class SendToDefaultJMSTopicTest {

    private static final Logger logger = Logger.getLogger(SendToDefaultJMSTopicTest.class);

    @Resource(mappedName = "/topic/test")
    private Topic topic;
