...
public class XaDataSourceCfgMetricUnitTestCase  extends DsMgmtTestBase{
    ...
    public void testDefaultXaDsProperties()throws Exception {
    	...
    	assertFalse(readAttribute(baseAddress,"no-recovery").asBoolean());
        assertFalse(readAttribute(baseAddress,"wrap-xa-resource").asBoolean());
        assertFalse(readAttribute(baseAddress,"pad-xid").asBoolean());
        removeDs();
    }
