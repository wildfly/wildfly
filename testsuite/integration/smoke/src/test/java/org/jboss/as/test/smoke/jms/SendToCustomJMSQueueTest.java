...
public class SendToCustomJMSQueueTest {

    private static final Logger logger = Logger.getLogger(SendToCustomJMSQueueTest.class);
    ...
    public static void deployQueue() throws Exception {
        ...
        adminOperations.createJmsQueue("myAwesomeQueue", "queue/myAwesomeQueue");
        adminOperations.createJmsQueue("myAwesomeQueue2", "queue/myAwesomeQueue2");
        adminOperations.createJmsQueue("myAwesomeQueue3", "queue/myAwesomeQueue3");
    }

    @AfterClass
    public static void removeQueue() throws Exception {
        if (adminOperations != null) {
            adminOperations.removeJmsQueue("myAwesomeQueue");
            adminOperations.removeJmsQueue("myAwesomeQueue2");
            adminOperations.removeJmsQueue("myAwesomeQueue3");
