...
@ServerSetup(CustomBootstrapDeploymentTestCase.BasicDeploymentTestCaseSetup.class)
@Ignore("AS7-3941")
public class CustomBootstrapDeploymentTestCase extends ArquillianResourceMgmtTestBase {
    ...
    public void testConfiguration() throws Throwable {
        ...
        MultipleConnection1Impl impl = (MultipleConnection1Impl) connectionFactory1.getConnection();
