...
public class DsMgmtTestBase  extends AbstractMgmtTestBase{
    ...
    protected void setModel(String filename)throws Exception{
	    String xml=readXmlResource(System.getProperty("jbossas.ts.submodule.dir")+"/src/test/resources/config/metrics/data-sources/"+filename);
    ...
    private static void testCon(final String dsName, final ModelControllerClient client,String type) throws Exception {
    ...
    protected static void testConnection(final String dsName, final ModelControllerClient client) throws Exception {
    	testCon(dsName,client,"data-source");
   }

    protected static void testConnectionXA(final String dsName, final ModelControllerClient client) throws Exception {
    	testCon(dsName,client,"xa-data-source");
    }
}
