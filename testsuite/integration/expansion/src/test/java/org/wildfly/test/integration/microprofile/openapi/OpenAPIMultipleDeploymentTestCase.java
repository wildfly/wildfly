        ...
        public ConfigServerSetupTask() {
            super(createContainerConfigurationBuilder()
                    .setupScript(createScriptBuilder()
                            .add("/system-property=mp.openapi.extensions.default-server.default-host.externalDocs.url:add(value=wildfly.org)")
                            .build())
                    .tearDownScript(createScriptBuilder()
                            .add("/system-property=mp.openapi.extensions.default-server.default-host.externalDocs.url:remove")
                            .build())
                    .build());
        }
    }
