package org.jboss.as.test.servlet30.jsf.jta;
...
import org.jboss.as.test.servlet30.jsf.jta.login.SimpleLogin;
import org.jboss.as.test.servlet30.jsf.jta.login.validator.LoginValidator;
...
public class ValidatorTestCase extends JTATestsBase {
    ...
    private static final String RESOURCES_LOCATION = "org/jboss/as/test/servlet30/jsf/jta/validator";
