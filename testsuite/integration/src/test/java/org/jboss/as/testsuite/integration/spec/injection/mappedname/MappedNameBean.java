...
package org.jboss.as.testsuite.integration.spec.injection.mappedname;
...
public class MappedNameBean {
    ...
    @EJB(lookup = "java:module/MappedNameBean!org.jboss.as.test.spec.injection.mappedname.MappedNameBean")
    private MappedNameBean selfByLookupName;

    @EJB(mappedName = "java:module/MappedNameBean!org.jboss.as.test.spec.injection.mappedname.MappedNameBean")
