 ...
 */
package org.jboss.as.testsuite.integration.ejb.entity.cmp.cascadedelete.test;
...
import org.jboss.as.testsuite.integration.ejb.entity.cmp.cascadedelete.ejb.AccountBean;
import org.jboss.as.testsuite.integration.ejb.entity.cmp.cascadedelete.ejb.AccountLocal;
import org.jboss.as.testsuite.integration.ejb.entity.cmp.cascadedelete.ejb.AccountLocalHome;
import org.jboss.as.testsuite.integration.ejb.entity.cmp.cascadedelete.ejb.CustomerLocal;
import org.jboss.as.testsuite.integration.ejb.entity.cmp.cascadedelete.ejb.CustomerLocalHome;
...
public class CascadeDeleteUnitTestCase extends AbstractCmpTest {
    ...
    private AccountLocalHome getAccountHome() throws NamingException {
        return (AccountLocalHome) iniCtx.lookup("java:module/Account!org.jboss.as.testsuite.integration.ejb.entity.cmp.cascadedelete.ejb.AccountLocalHome");
    }

    private CustomerLocalHome getCustomerHome() throws NamingException {
        return (CustomerLocalHome) iniCtx.lookup("java:module/Customer!org.jboss.as.testsuite.integration.ejb.entity.cmp.cascadedelete.ejb.CustomerLocalHome");
    }
}
