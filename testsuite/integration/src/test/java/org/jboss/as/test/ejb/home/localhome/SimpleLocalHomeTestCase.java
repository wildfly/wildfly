...
package org.jboss.as.test.ejb.home.localhome;
...
public class SimpleLocalHomeTestCase {
    ...
    private static final String EJB_JAR_XML = "<ejb-jar xmlns=\"http://java.sun.com/xml/ns/javaee\"\n" +
            ...
            "            <local-home>org.jboss.as.test.ejb.home.localhome.SimpleLocalHome</local-home>\n" +
            "            <local>org.jboss.as.test.ejb.home.localhome.SimpleLocalInterface</local>\n" +
            "            <ejb-class>org.jboss.as.test.ejb.home.localhome.SimpleStatelessLocalBean</ejb-class>\n" +
            "            <session-type>Stateless</session-type>\n" +
            "        </session>\n" +
            "        <session>\n" +
            "            <ejb-name>SimpleStatefulLocalHomeBean</ejb-name>\n" +
            "            <local-home>org.jboss.as.test.ejb.home.localhome.SimpleStatefulLocalHome</local-home>\n" +
            "            <local>org.jboss.as.test.ejb.home.localhome.SimpleLocalInterface</local>\n" +
            "            <ejb-class>org.jboss.as.test.ejb.home.localhome.SimpleStatefulLocalBean</ejb-class>\n" +
