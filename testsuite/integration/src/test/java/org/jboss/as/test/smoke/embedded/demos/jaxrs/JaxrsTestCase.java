...
import org.jboss.as.test.smoke.modular.utils.PollingUtils.UrlConnectionTask;
...
public class JaxrsTestCase {
    ...
    public static Archive<?> getDeployment(){
        return ShrinkWrapUtils.createWebArchive("smoke/demos/jaxrs-example.war", HelloWorldResource.class.getPackage());
    }
