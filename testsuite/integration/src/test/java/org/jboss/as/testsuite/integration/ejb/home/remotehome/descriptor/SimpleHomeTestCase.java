...
package org.jboss.as.testsuite.integration.ejb.home.remotehome.descriptor;
...
import org.jboss.as.testsuite.integration.ejb.home.remotehome.SimpleHome;
...
public class SimpleHomeTestCase {
    ...
    private static final String EJB_JAR_XML = "<ejb-jar xmlns=\"http://java.sun.com/xml/ns/javaee\"\n" +
            ...
            "            <home>org.jboss.as.testsuite.integration.ejb.home.remotehome.SimpleHome</home>\n" +
            "            <remote>org.jboss.as.testsuite.integration.ejb.home.remotehome.SimpleInterface</remote>\n" +
            "            <ejb-class>org.jboss.as.testsuite.integration.ejb.home.remotehome.descriptor.SimpleStatelessBean</ejb-class>\n" +
            "            <session-type>Stateless</session-type>\n" +
            "        </session>\n" +
            "        <session>\n" +
            "            <ejb-name>SimpleStatefulHomeBean</ejb-name>\n" +
            "            <home>org.jboss.as.testsuite.integration.ejb.home.remotehome.SimpleStatefulHome</home>\n" +
            "            <remote>org.jboss.as.testsuite.integration.ejb.home.remotehome.SimpleInterface</remote>\n" +
            "            <ejb-class>org.jboss.as.testsuite.integration.ejb.home.remotehome.descriptor.SimpleStatefulBean</ejb-class>\n" +
