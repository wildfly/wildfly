...
package org.jboss.as.test.smoke.embedded.demos.ejb3.dd;
...
public class DDBasedEJBTestCase {
    ...
    public static JavaArchive getDeployment() throws Exception {
        ...
        jar.addAsManifestResource("smoke/demos/ejb3/ejb-jar.xml", "ejb-jar.xml");
        jar.addAsManifestResource("smoke/demos/ejb3/MANIFEST.MF", "MANIFEST.MF");
        return jar;
    }
