...
public class WarJbossStructureClassFileTransformer {

    public static final String CLASS_NAME = "org.jboss.as.testsuite.integration.deployment.classloading.ear.TestAA";
    ...
    public static Archive<?> deploy() {
        ...
        war.addClasses(TestAA.class, DummyClassFileTransformer1.class, DummyClassFileTransformer2.class, WarJbossStructureClassFileTransformer.class);
