 ...
 */
package org.jboss.as.testsuite.integration.weld.alternative;
...
public class WeldAlternativeTestCase {
    ...
    public static Archive<?> deploy() {
        ...
        jar.addManifestResource(new StringAsset("<beans><alternatives><class>" + AlternativeBean.class.getName() + "</class></alternatives></beans>"), "beans.xml");
        return jar;
    }
