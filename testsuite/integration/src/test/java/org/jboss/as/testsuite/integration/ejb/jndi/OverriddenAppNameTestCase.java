...
package org.jboss.as.testsuite.integration.ejb.jndi;
...
public class OverriddenAppNameTestCase {
    ...
    public static EnterpriseArchive createEar() {
        ...
        // add application.xml
        ear.addAsManifestResource("ejb/jndi/application.xml", "application.xml");

        // create the jar containing the EJBs
        JavaArchive jar = ShrinkWrap.create(JavaArchive.class, JAR_NAME);
        // add ejb-jar.xml
        jar.addAsManifestResource("ejb/jndi/ejb-jar.xml", "ejb-jar.xml");
