...
public class CascadeDeleteTestCase extends AbstractCmpTest {
    ...
    private OrderHome getOrderHome() {
        try {
            return (OrderHome) iniCtx.lookup("java:module/OrderEJB!org.jboss.as.testsuite.integration.ejb.entity.cmp.commerce.OrderHome");
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private ProductCategoryHome getProductCategoryHome() {
        try {
            return (ProductCategoryHome) iniCtx.lookup("java:module/ProductCategoryEJB!org.jboss.as.testsuite.integration.ejb.entity.cmp.commerce.ProductCategoryHome");
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private ProductCategoryHome getProductCategoryBatchDeleteHome() {
        try {
            return (ProductCategoryHome) iniCtx.lookup("java:module/ProductCategoryBatchDeleteEJB!org.jboss.as.testsuite.integration.ejb.entity.cmp.commerce.ProductCategoryHome");
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private ProductCategoryTypeHome getProductCategoryTypeHome() {
        try {
            return (ProductCategoryTypeHome) iniCtx.lookup("java:module/ProductCategoryTypeEJB!org.jboss.as.testsuite.integration.ejb.entity.cmp.commerce.ProductCategoryTypeHome");
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private ProductCategoryTypeHome getProductCategoryTypeBatchDeleteHome() {
        try {
            return (ProductCategoryTypeHome) iniCtx.lookup("java:module/ProductCategoryTypeBatchDeleteEJB!org.jboss.as.testsuite.integration.ejb.entity.cmp.commerce.ProductCategoryTypeHome");
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private LineItemHome getLineItemHome() {
        try {
            return (LineItemHome) iniCtx.lookup("java:module/LineItemEJB!org.jboss.as.testsuite.integration.ejb.entity.cmp.commerce.LineItemHome");
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private AddressHome getAddressHome() {
        try {
            return (AddressHome) iniCtx.lookup("java:module/AddressEJB!org.jboss.as.testsuite.integration.ejb.entity.cmp.commerce.AddressHome");
        } catch (Exception e) {
            e.printStackTrace();
