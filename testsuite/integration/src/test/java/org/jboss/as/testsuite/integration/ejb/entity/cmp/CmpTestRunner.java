...
public class CmpTestRunner extends Arquillian {
    ...
    private TransactionWrappingSessionBean getTransactionWrapper(final AbstractCmpTest target) {
        try {
            return (TransactionWrappingSessionBean) target.getInitialContext().lookup("java:module/TransactionWrappingSessionBean!org.jboss.as.testsuite.integration.ejb.entity.cmp.TransactionWrappingSessionBean");
        } catch (Exception e) {
            e.printStackTrace();
