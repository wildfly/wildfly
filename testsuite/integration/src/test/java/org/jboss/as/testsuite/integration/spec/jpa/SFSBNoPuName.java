...
package org.jboss.as.testsuite.integration.spec.jpa;
...
/**
 * ensure that referencing the default persistence unit (leaving the name blank) works.
 *
 * @author Scott Marlow
 */
@Stateful
public class SFSBNoPuName {
