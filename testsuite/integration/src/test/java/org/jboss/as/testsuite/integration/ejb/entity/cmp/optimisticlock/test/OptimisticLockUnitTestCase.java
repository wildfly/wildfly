 ...
 */
package org.jboss.as.testsuite.integration.ejb.entity.cmp.optimisticlock.test;

import javax.naming.NamingException;

import org.jboss.arquillian.container.test.api.Deployment;
import org.jboss.as.testsuite.integration.ejb.entity.cmp.AbstractCmpTest;
import org.jboss.as.testsuite.integration.ejb.entity.cmp.CmpTestRunner;
import org.jboss.as.testsuite.integration.ejb.entity.cmp.optimisticlock.bug1006723.testentity.EntityABean;
import org.jboss.as.testsuite.integration.ejb.entity.cmp.optimisticlock.bug1006723.testsession.TestSession;
import org.jboss.as.testsuite.integration.ejb.entity.cmp.optimisticlock.bug1006723.testsession.TestSessionHome;
import org.jboss.as.testsuite.integration.ejb.entity.cmp.optimisticlock.ejb.CmpEntityBean;
import org.jboss.as.testsuite.integration.ejb.entity.cmp.optimisticlock.ejb.FacadeBean;
import org.jboss.as.testsuite.integration.ejb.entity.cmp.optimisticlock.interfaces.CmpEntityLocal;
...
public class OptimisticLockUnitTestCase extends AbstractCmpTest {
    // Constants -------------------------------------
    private static final String ENTITY_GROUP_LOCKING = "java:module/EntityGroupLocking!org.jboss.as.testsuite.integration.ejb.entity.cmp.optimisticlock.interfaces.CmpEntityLocalHome";
    private static final String ENTITY_MODIFIED_LOCKING = "java:module/EntityModifiedLocking!org.jboss.as.testsuite.integration.ejb.entity.cmp.optimisticlock.interfaces.CmpEntityLocalHome";
    private static final String ENTITY_READ_LOCKING = "java:module/EntityReadLocking!org.jboss.as.testsuite.integration.ejb.entity.cmp.optimisticlock.interfaces.CmpEntityLocalHome";
    private static final String ENTITY_VERSION_LOCKING = "java:module//EntityVersionLocking!org.jboss.as.testsuite.integration.ejb.entity.cmp.optimisticlock.interfaces.CmpEntityLocalHome";
    private static final String ENTITY_EXPLICIT_VERSION_LOCKING = "java:module//EntityExplicitVersionLocking!org.jboss.as.testsuite.integration.ejb.entity.cmp.optimisticlock.interfaces.CmpEntityLocalHome";
    private static final String ENTITY_TIMESTAMP_LOCKING = "java:module//EntityTimestampLocking!org.jboss.as.testsuite.integration.ejb.entity.cmp.optimisticlock.interfaces.CmpEntityLocalHome";
    private static final String ENTITY_KEYGEN_LOCKING = "java:module//EntityKeyGeneratorLocking!org.jboss.as.testsuite.integration.ejb.entity.cmp.optimisticlock.interfaces.CmpEntityLocalHome";
    ...
    public void testBug1006723() throws Exception {
        TestSessionHome testSessionRemoteHome = (TestSessionHome)iniCtx.lookup("java:global/cmp-optimisticlock/TestSession!org.jboss.as.testsuite.integration.ejb.entity.cmp.optimisticlock.bug1006723.testsession.TestSessionHome");
    ...
    private FacadeBean getFacade() throws NamingException {
        if (facade == null) {
            facade = (FacadeBean) iniCtx.lookup("java:module/FacadeBean!org.jboss.as.testsuite.integration.ejb.entity.cmp.optimisticlock.ejb.FacadeBean");
        }
        return facade;
    }
}
