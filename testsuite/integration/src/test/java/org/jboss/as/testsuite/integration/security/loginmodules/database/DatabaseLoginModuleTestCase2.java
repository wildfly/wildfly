 ...
 */
package org.jboss.as.testsuite.integration.security.loginmodules.database;
...
import static org.jboss.as.testsuite.integration.security.loginmodules.common.Coding.BASE_64;
...
@RunAsClient
public class DatabaseLoginModuleTestCase2 extends AbstractDatabaseLoginModuleTest {
   ...
   static {
      ...
      optionsMap.put("hashEncoding", "base64");
      classModuleOptionsMap.put(DatabaseLoginModuleTestCase2.class, optionsMap);

      Map<String, String> usersMap = new HashMap<String, String>();
      usersMap.put("anil", Utils.hash("anil", "MD5", BASE_64));
      usersMap.put("marcus", Utils.hash("anil","MD5", BASE_64));
      classUserMap.put(DatabaseLoginModuleTestCase2.class, usersMap);
   }

   @Deployment
   public static WebArchive deployment() {
      return deployment(DatabaseLoginModuleTestCase2.class);
   }
