...
public class WebAppTestCase {
    ...
    public static Archive<?> getDeployment(){
        ...
        Archive<?> fakeJndi = ShrinkWrapUtils.createJavaArchive("smoke/demos/fakejndi.sar", FakeJndi.class.getPackage());

        return ShrinkWrapUtils.createWebArchive("smoke/demos/webapp-example.war", SimpleServlet.class.getPackage());
    }
