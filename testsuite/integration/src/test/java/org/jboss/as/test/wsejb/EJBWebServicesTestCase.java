 ...
 */
package org.jboss.as.test.wsejb;

import static java.util.concurrent.TimeUnit.SECONDS;

import org.jboss.arquillian.container.test.api.Deployment;
import org.jboss.arquillian.junit.Arquillian;
import org.jboss.as.test.common.HttpRequest;
...
public class EJBWebServicesTestCase {
    ...
    public void testSingleton() throws Exception {
        final String message = "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:test=\"http://wsejb.integration.test.as.jboss.org/\">"
                + "  <soapenv:Header/>"
                + "  <soapenv:Body>"
                + "    <test:setState>"
                + "      <arg0>Foo</arg0>"
