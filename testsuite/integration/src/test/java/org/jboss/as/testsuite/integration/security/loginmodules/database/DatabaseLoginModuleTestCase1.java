...
@RunAsClient
public class DatabaseLoginModuleTestCase1 extends AbstractDatabaseLoginModuleTest {
   ...
   static {
      ...
      classModuleOptionsMap.put(DatabaseLoginModuleTestCase1.class, optionsMap);

      Map<String, String> usersMap = new HashMap<String, String>();
      usersMap.put("anil", Utils.hash("anil", "MD5", BASE_64));
      usersMap.put("marcus", Utils.hash("anil","MD5", BASE_64));
      classUserMap.put(DatabaseLoginModuleTestCase1.class, usersMap);
   }

   @Deployment
   public static WebArchive deployment() {
      return deployment(DatabaseLoginModuleTestCase1.class);
   }
