 ...
 */
package org.jboss.as.testsuite.integration.ejb.entity.cmp.optimisticlock.bug1006723.testsession;
...
import org.jboss.as.testsuite.integration.ejb.entity.cmp.optimisticlock.bug1006723.testentity.EntityALocal;
import org.jboss.as.testsuite.integration.ejb.entity.cmp.optimisticlock.bug1006723.testentity.EntityALocalHome;
import org.jboss.as.testsuite.integration.ejb.entity.cmp.optimisticlock.bug1006723.testentity.EntityBLocal;
import org.jboss.as.testsuite.integration.ejb.entity.cmp.optimisticlock.bug1006723.testentity.EntityBLocalHome;
        ...
        if (entityALocalHome == null) {
            try {
                entityALocalHome = (EntityALocalHome) getContext().lookup
                        ("java:module/EntityA!org.jboss.as.testsuite.integration.ejb.entity.cmp.optimisticlock.bug1006723.testentity.EntityALocalHome");
            } catch (NamingException e) {
                throw new EJBException(e.getMessage());
            }
        }
        ...
        if (entityBLocalHome == null) {
            try {
                entityBLocalHome = (EntityBLocalHome) getContext().lookup
                        ("java:module/EntityB!org.jboss.as.testsuite.integration.ejb.entity.cmp.optimisticlock.bug1006723.testentity.EntityBLocalHome");
            } catch (NamingException e) {
                throw new EJBException(e.getMessage());
            }
        }
