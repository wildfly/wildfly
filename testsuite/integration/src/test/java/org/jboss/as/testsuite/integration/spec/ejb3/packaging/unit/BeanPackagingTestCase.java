...
package org.jboss.as.testsuite.integration.spec.ejb3.packaging.unit;

import org.jboss.arquillian.container.test.api.Deployment;
import org.jboss.arquillian.junit.Arquillian;
import org.jboss.as.testsuite.integration.spec.ejb3.packaging.LocalBeanInterfaceInEarLib;
import org.jboss.as.testsuite.integration.spec.ejb3.packaging.LocalBeanInterfaceInEjbJar;
import org.jboss.as.testsuite.integration.spec.ejb3.packaging.MrBean;
import org.jboss.as.testsuite.integration.spec.ejb3.packaging.RemoteBeanInterfaceInEarLib;
import org.jboss.as.testsuite.integration.spec.ejb3.packaging.RemoteBeanInterfaceInEjbJar;
...
public class BeanPackagingTestCase {
    ...
    private static final Logger logger = Logger.getLogger(BeanPackagingTestCase.class);

    @Deployment
    public static EnterpriseArchive createDeployment() {
        final JavaArchive ejbJar = ShrinkWrap.create(JavaArchive.class, MODULE_NAME + ".jar");
        ejbJar.addClasses(MrBean.class, LocalBeanInterfaceInEjbJar.class, RemoteBeanInterfaceInEjbJar.class, BeanPackagingTestCase.class);
