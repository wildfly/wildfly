 ...
 */
package org.jboss.as.testsuite.integration.ejb.entity.cmp.optimisticlock.ejb;
...
import org.jboss.as.testsuite.integration.ejb.entity.cmp.optimisticlock.interfaces.CmpEntityLocalHome;
...
public class FacadeBean {
    ...
    private FacadeBean getFacade() throws NamingException {
        return (FacadeBean) new InitialContext().lookup("java:module/FacadeBean!org.jboss.as.testsuite.integration.ejb.entity.cmp.optimisticlock.ejb.FacadeBean");
    }
}
