...
package org.jboss.as.testsuite.integration.ejb.singleton.concurrency;
...
public class SingletonBeanTestCase {
    ...
    @EJB(mappedName = "java:global/ejb3-singleton-bean-example/ReadOnlySingletonBean!org.jboss.as.testsuite.integration.ejb.singleton.concurrency.ReadOnlySingletonBean")
    private ReadOnlySingletonBean readOnlySingletonBean;

    @EJB(mappedName = "java:global/ejb3-singleton-bean-example/LongWritesSingletonBean!org.jboss.as.testsuite.integration.ejb.singleton.concurrency.LongWritesSingletonBean")
