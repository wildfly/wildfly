...
public class ServiceLoaderTestCase {
    ...
    public static Archive<?> getDeployment() {
        return ShrinkWrapUtils.createJavaArchive("smoke/demos/serviceloader-example.jar", ServiceLoaderTestCase.class.getPackage(), TestService.class.getPackage(), ShrinkWrapUtils.class.getPackage());
    }
