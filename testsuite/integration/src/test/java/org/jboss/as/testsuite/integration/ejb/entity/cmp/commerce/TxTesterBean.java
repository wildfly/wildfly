...
//
//            orderHome = (OrderHome) jndiContext.lookup("java:module/OrderEJB!org.jboss.as.testsuite.integration.ejb.entity.cmp.commerce.OrderHome");
//            lineItemHome = (LineItemHome) jndiContext.lookup("java:module/LineItemEJB!org.jboss.as.testsuite.integration.ejb.entity.cmp.commerce.LineItemHome");
//        } catch (Exception e) {
