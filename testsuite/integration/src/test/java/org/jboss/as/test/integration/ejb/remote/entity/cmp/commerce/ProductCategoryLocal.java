...
public interface ProductCategoryLocal extends EJBLocalObject {
    ...
    ProductCategoryLocal getParent();

    void setParent(ProductCategoryLocal parent);

    Collection getSubcategories();

    void setSubcategories(Collection subcategories);

    ProductCategoryTypeLocal getType();

    void setType(ProductCategoryTypeLocal type);
