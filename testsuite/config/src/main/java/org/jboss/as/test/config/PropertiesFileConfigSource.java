 ...
 * <ul>
 *   <li>System property: {@code -Dconfig.properties=/path/to/config.properties}</li>
 *   <li>Environment variable: {@code CONFIG_PROPERTIES=/path/to/config.properties}</li>
 * </ul>
 */
public class PropertiesFileConfigSource implements ConfigSource {
    ...
    private static final String PROPERTIES_FILE_PROPERTY_NAME = "config.properties";
    ...
    private Properties getPropertiesFromFile() {
        if (properties == null) {
            ...
            // Properties file location can be passed as e.g. -Dconfig.properties=/some-path/config.properties
