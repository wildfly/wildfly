...
public class MixedDomainOverlay740TestSuite extends MixedDomainTestSuite {
    ...
    public static void initializeDomain() {
        MixedDomainTestSuite.getSupport(MixedDomainOverlay740TestSuite.class, "master-config/host.xml", "slave-config/host-secondary-overlay.xml", Profile.DEFAULT, true, false, true);
    }
}
