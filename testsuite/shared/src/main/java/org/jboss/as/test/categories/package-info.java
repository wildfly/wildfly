...
/**
 *  Contains interfaces to be used as test categories for org.junit.experimental.categories.Category(...).
 *
 ...
 *  Example:
    ...
    The categorized tests can be run in groups using Surefire's
