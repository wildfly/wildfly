 ...
 */
package org.jboss.as.test.spec.osgi.http;
...
import org.jboss.as.test.spec.osgi.http.bundle.EndpointServlet;
import org.jboss.as.test.spec.osgi.http.bundle.HttpExampleActivator;
    ...
    public static JavaArchive createdeployment() {
        ...
        archive.setManifest(new Asset() {
            public InputStream openStream() {
                ...
                builder.addImportPackages(StartLevel.class, HttpService.class, LogService.class, BundleActivator.class,
