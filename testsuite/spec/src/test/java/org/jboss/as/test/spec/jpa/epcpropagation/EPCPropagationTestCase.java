...
public class EPCPropagationTestCase {
    ...
    public static Archive<?> deploy() {
        ...
        jar.addClasses(CMTEPCStatefulBean.class, CMTStatefulBean.class, EPCStatefulBean.class, InitEPCStatefulBean.class,
                IntermediateStatefulBean.class, IntermediateStatefulInterface.class, MyEntity.class, NoTxEPCStatefulBean.class,
                NoTxStatefulBean.class, StatefulBean.class, StatefulInterface.class, StatelessBean.class,
                StatelessInterface.class, AbstractStatefulInterface.class, EPCPropagationTestCase.class, LookupUtil.class)
