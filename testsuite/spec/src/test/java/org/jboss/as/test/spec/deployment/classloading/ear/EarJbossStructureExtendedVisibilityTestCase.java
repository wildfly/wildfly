 ...
 */
package org.jboss.as.test.spec.deployment.classloading.ear;
...
public class EarJbossStructureExtendedVisibilityTestCase {
    ...
    public void testWarModuleStillNotAccessible() throws ClassNotFoundException {
        loadClass("org.jboss.as.test.spec.deployment.classloading.ear.TestAA",getClass().getClassLoader());
    }

    @Test
    public void testOtherEjbJarAcessible() throws ClassNotFoundException {
        loadClass("org.jboss.as.test.spec.deployment.classloading.ear.MyEjb2",getClass().getClassLoader());
    }
