 ...
 */
package org.jboss.as.test.spec.deployment.classloading.transientdependencies;
...
public class RarTransientDependenciesTestCase {
    ...
    public static JavaArchive jar() {
        final JavaArchive jar = ShrinkWrap.create(JavaArchive.class, "transient.jar").addClass(JarClass.class);
        return jar;
    }
