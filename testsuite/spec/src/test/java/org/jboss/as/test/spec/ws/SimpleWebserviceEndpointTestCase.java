...
package org.jboss.as.test.spec.ws;
...
public class SimpleWebserviceEndpointTestCase {
    ...
    public static WebArchive createDeployment() {
        ...
        war.addClasses(SimpleWebserviceEndpointImpl.class, SimpleWebserviceEndpointIface.class);
        war.addAsWebInfResource(WebXml.get("<servlet>" +
            "    <servlet-name>TestService</servlet-name>" +
            "    <servlet-class>" + SimpleWebserviceEndpointImpl.class.getName() + "</servlet-class>" +
            "  </servlet>" +
            "  <servlet-mapping>" +
            "    <servlet-name>TestService</servlet-name>" +
    ...
    public void testSimpleStatelessWebserviceEndpoint() throws Exception {
        final QName serviceName = new QName(this.getClass().getPackage().getName(), "SimpleService");
