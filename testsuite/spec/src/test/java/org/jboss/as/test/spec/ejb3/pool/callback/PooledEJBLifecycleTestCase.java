 ...
 */
package org.jboss.as.test.spec.ejb3.pool.callback;
...
import org.jboss.as.test.spec.ejb3.pool.callback.mdb.LifecycleCounterMDB;
import org.jboss.as.test.spec.ejb3.pool.callback.slsb.LifecycleCounterSLSB;
import org.jboss.as.test.spec.ejb3.pool.callback.slsb.PointlesMathInterface;
...
/**
 * Tests if pooled EJBs have proper lifecycle. Requires tests to be run with:
 *  <ul>
 *     <li>-Djboss.server.config.file.name=standalone-xts.xml  - to load hornetQ</li>
 *     <li>Pools configured.<br>
 *     <pre>
 *      &lt;subsystem xmlns="urn:jboss:domain:ejb3:1.1"&gt;
                ...
                &lt;pools&gt;
                    &lt;bean-instance-pools&gt;
                        &lt;strict-max-pool name="MDBPool" max-pool-size="5" instance-acquisition-timeout="1" instance-acquisition-timeout-unit="HOURS"/&gt;
...
public class PooledEJBLifecycleTestCase {
    ...
    private static final String SLSB_JNDI_NAME = "java:global/"+SLSB_DEPLOYMENT_NAME+"/LifecycleCounterSLSB!org.jboss.as.test.spec.ejb3.pool.callback.slsb.PointlesMathInterface";
    ...
    @EJB(mappedName = "java:global/pool-ejb-callbacks-singleton/LifecycleCounterBean!org.jboss.as.test.spec.ejb3.pool.callback.LifecycleCounter")
    ...
    public static JavaArchive createDeployment() {
        ...
        archive.addPackage(LifecycleCounter.class.getPackage());
    ...
    public static JavaArchive getMDBTestArchive() {
        ...
        archive.addPackage(LifecycleCounterMDB.class.getPackage());
        // archive.addPackage(LifecycleCounter.class.getPackage());
    ...
    public static JavaArchive getSLSBTestArchive() {
        ...
        //archive.addPackage(LifecycleCounterSLSB.class.getPackage());
