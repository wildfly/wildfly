 ...
 */
package org.jboss.as.test.spec.osgi.as858;
...
public class AS858TestCase {
    ...
    public void testModuleLoader() throws NamingException, Exception {
        ...
        try {
            ...
            ServiceController<?> controller = serviceContainer.getService(ServiceName.JBOSS.append("module", "spec", "service",
                    identifier.getName(), identifier.getSlot()));
            if (controller != null) {
                controller.setMode(ServiceController.Mode.REMOVE);
            }
            controller = serviceContainer.getService(ServiceName.JBOSS.append("module", "information", "service",
                    identifier.getName(), identifier.getSlot()));
            if (controller != null) {
                controller.setMode(ServiceController.Mode.REMOVE);
            }
