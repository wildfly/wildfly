 ...
 */
package org.jboss.as.test.spec.osgi;
...
public abstract class OSGiTestSupport {
    ...
    /**
     * Changes the framework start level and waits for the STARTLEVEL_CHANGED event Note, changing the framework start level is
     * an asynchronous operation.
     */
    protected void changeStartLevel(final BundleContext context, final int level, final long timeout, final TimeUnit units)
    ...
    /**
     * Use {@link PackageAdmin#getBundles(String, String)} to find a deployed bundle by symbolic name and version range
     */
