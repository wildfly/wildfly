 ...
 */
package org.jboss.as.test.spec.osgi.http.bundle;
...
public class HttpExampleActivator implements BundleActivator {
    ...
    private static final Logger log = Logger.getLogger(HttpExampleActivator.class.getName());
    ...
    private void registerService(BundleContext context, HttpService httpService) {
        log.info("registerService: " + context.getBundle());
    ...
    private void unregisterService(BundleContext context, HttpService httpService) {
        log.info("unregisterService: " + context.getBundle());
        ClassLoader ctxLoader = Thread.currentThread().getContextClassLoader();
        try {
