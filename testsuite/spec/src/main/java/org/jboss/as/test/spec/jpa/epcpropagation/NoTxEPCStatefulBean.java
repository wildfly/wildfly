...
public class NoTxEPCStatefulBean extends AbstractStatefulInterface {
    ...
    public boolean createEntity(Integer id, String name) throws Exception {
        ...
        StatefulInterface stateful_2ndSFSBInvocation = LookupUtil.lookup("NoTxEPCStatefulBean", StatefulInterface.class);
        ...
        StatefulInterface stateful_3rdSFSBInvocation = LookupUtil.lookup("NoTxEPCStatefulBean", StatefulInterface.class);
    ...
    public StatefulInterface createSFSBOnInvocation() throws Exception {
        return LookupUtil.lookup("NoTxEPCStatefulBean", StatefulInterface.class);
    }

    public StatelessInterface createSLSBOnInvocation() throws Exception {
        return LookupUtil.lookup("StatelessBean", StatelessInterface.class);
    }
