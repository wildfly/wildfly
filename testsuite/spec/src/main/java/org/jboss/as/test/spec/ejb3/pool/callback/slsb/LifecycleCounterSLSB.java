 ...
 */
package org.jboss.as.test.spec.ejb3.pool.callback.slsb;
...
import org.jboss.as.test.spec.ejb3.pool.callback.LifecycleCounter;
    ...
    protected void postConstruct() throws JMSException, NamingException {
        ...
        try {
            this.lifeCycleCounter = (LifecycleCounter) new InitialContext()
                    .lookup("java:global/pool-ejb-callbacks-singleton/LifecycleCounterBean!org.jboss.as.test.spec.ejb3.pool.callback.LifecycleCounter");
