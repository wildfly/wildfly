...
import org.jboss.as.test.internals.osgi.xservice.module.ClientModuleOneActivator;
import org.jboss.as.test.internals.osgi.xservice.module.EchoService;
import org.jboss.as.test.internals.osgi.xservice.module.TargetModuleActivator;
import org.jboss.as.test.spec.osgi.xservice.api.Echo;
        ...
        archive.setManifest(new Asset() {
            public InputStream openStream() {
                ...
                builder.addManifestHeader("Dependencies",
                        "org.jboss.modules,org.jboss.logging,deployment.example-xservice-mam-target-module");
                return builder.openStream();
            }
        });
        return archive;
