 ...
 */
package org.jboss.as.test.internals.osgi.interceptor;
...
import org.jboss.as.test.internals.osgi.interceptor.bundle.EndpointServlet;
import org.jboss.as.test.internals.osgi.interceptor.bundle.HttpMetadata;
import org.jboss.as.test.internals.osgi.interceptor.bundle.InterceptorActivator;
import org.jboss.as.test.internals.osgi.interceptor.bundle.ParserInterceptor;
import org.jboss.as.test.internals.osgi.interceptor.bundle.PublisherInterceptor;
import org.jboss.as.test.spec.osgi.OSGiTestSupport;
 ...
 * registeres an http endpoint from it. The idea is that the bundle does not process its own metadata. Instead this work is
 * delegated to some specialized metadata processor (i.e. the interceptor)
 *
