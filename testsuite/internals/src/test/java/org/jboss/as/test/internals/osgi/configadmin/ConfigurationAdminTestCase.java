...
package org.jboss.as.test.internals.osgi.configadmin;
...
import org.jboss.as.test.internals.osgi.xservice.bundle.ConfiguredService;
...
public class ConfigurationAdminTestCase extends OSGiTestSupport {
    ...
    public void testManagedService() throws Exception {
        ...
        try {
            ...
            context.registerService(new String[] { ConfiguredService.class.getName(), ManagedService.class.getName() },
                    new ConfiguredService(), serviceProps);
