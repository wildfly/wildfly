...
import org.jboss.as.test.internals.osgi.xservice.bundle.TargetBundleActivator;
import org.jboss.as.test.internals.osgi.xservice.module.ClientModuleTwoActivator;
        ...
        archive.setManifest(new Asset() {
            public InputStream openStream() {
                ...
                builder.addManifestHeader(
                        "Dependencies",
                        "org.osgi.core,org.jboss.modules,org.jboss.logging,org.jboss.osgi.framework,deployment.example-xservice-mab-target-bundle:0.0.0");
                return builder.openStream();
            }
        });
        return archive;
