...
import org.jboss.as.test.api.ejb3.security.Entry;
import org.jboss.as.test.api.ejb3.security.Util;
import org.jboss.as.test.api.ejb3.security.WhoAmI;
import org.jboss.as.test.api.ejb3.security.base.WhoAmIBean;
import org.jboss.as.test.api.ejb3.security.runas.EntryBean;
...
public class RunAsTestCase extends SecurityTest {
    ...
    @EJB(mappedName = "java:global/ejb3security/WhoAmIBean!org.jboss.as.test.api.ejb3.security.WhoAmI")
    private WhoAmI whoAmIBean;

    @EJB(mappedName = "java:global/ejb3security/EntryBean!org.jboss.as.test.api.ejb3.security.runas.EntryBean")
