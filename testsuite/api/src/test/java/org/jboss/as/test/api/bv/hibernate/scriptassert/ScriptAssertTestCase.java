 ...
 */
package org.jboss.as.test.api.bv.hibernate.scriptassert;
...
public class ScriptAssertTestCase {
    ...
    public static Archive<?> deploy() {
        final WebArchive war = ShrinkWrap.create(WebArchive.class, "testscriptassert.war").addClass(ScriptAssertBean.class);
        return war;
    }
