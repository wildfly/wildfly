...
import org.jboss.as.test.api.ejb3.security.authorization.DenyAllOverrideBean;
import org.jboss.as.test.api.ejb3.security.authorization.PermitAllOverrideBean;
import org.jboss.as.test.api.ejb3.security.authorization.RolesAllowedOverrideBean;
...
public class AnnotationAuthorizationTestCase extends SecurityTest {
    ...
    public void testRolesAllowedOverriden_User2() throws Exception {
        LoginContext lc = getCLMLoginContext("user2", "password2");
        lc.login();
