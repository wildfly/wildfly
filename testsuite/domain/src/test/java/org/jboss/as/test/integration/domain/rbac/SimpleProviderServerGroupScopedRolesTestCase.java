...
/**
 * Tests of server group scoped roles using the "simple" access control provider.
 *
 * @author Brian Stansberry (c) 2013 Red Hat Inc.
 */
public class SimpleProviderServerGroupScopedRolesTestCase extends AbstractServerGroupScopedRolesTestCase {
