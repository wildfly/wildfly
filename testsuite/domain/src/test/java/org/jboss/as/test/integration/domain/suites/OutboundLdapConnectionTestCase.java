...
public class OutboundLdapConnectionTestCase {
    ...
    @Test
    public void testLoginWithOutboundLdapConnection() throws Exception {
        testLoginToHttpManagementInterface(true);
    }

    @Test
    public void testLoginFailWithBadOutboundLdapConnection() throws Exception {
    ...
    private void testLoginToHttpManagementInterface(boolean expectToPass) throws IOException, URISyntaxException {
        final int expectedStatus = expectToPass ? HttpServletResponse.SC_OK : HttpServletResponse.SC_UNAUTHORIZED;
